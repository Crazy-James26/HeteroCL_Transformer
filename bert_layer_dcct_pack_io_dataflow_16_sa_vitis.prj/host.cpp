...
int main(int argc, char** argv) {
    ...
    // CL_MEM_USE_HOST_PTR
    size_t size_bytes_in0 = sizeof(float) * 12288;
    std::vector<float, aligned_allocator<float> > source_in0(12288);
    size_t size_bytes_out0 = sizeof(float) * 12288;
    std::vector<float, aligned_allocator<float> > source_out0(12288);

...
set C_modelArgList {
	...
	{ v5 float 32 regular {array 9216 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "v0","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 11,"step" : 1},{"low" : 0,"up" : 767,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "v5", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "v5","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 11,"step" : 1},{"low" : 0,"up" : 767,"step" : 1}]}]}]} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v5", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "198273098", "EstimateLatencyMax" : "198273098",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "v5", "Type" : "Memory", "Direction" : "IO"}]},
...
set ArgLastReadFirstWriteLatency {
	top {
		v0 {Type I LastRead 3 FirstWrite -1}
		v1 {Type I LastRead 5 FirstWrite -1}
		v2 {Type I LastRead 6 FirstWrite -1}
		v3 {Type I LastRead 2 FirstWrite -1}
		v4 {Type I LastRead 3 FirstWrite -1}
		v5 {Type IO LastRead 12 FirstWrite 4}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "198273098", "Max" : "198273098"}
	, {"Name" : "Interval", "Min" : "198273099", "Max" : "198273099"}
]}
...
set Spec2ImplPortList { 
	...
	v5 { ap_memory {  { v5_address0 mem_address 1 14 }  { v5_ce0 mem_ce 1 1 }  { v5_we0 mem_we 1 1 }  { v5_d0 mem_din 1 32 }  { v5_q0 mem_dout 0 32 } } }
}

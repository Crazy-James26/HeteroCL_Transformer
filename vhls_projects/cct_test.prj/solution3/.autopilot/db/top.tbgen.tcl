...
set C_modelArgList {
	...
	{ v1_0 float 32 regular {array 294912 { 1 3 } 1 1 }  }
	{ v1_1 float 32 regular {array 294912 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v0_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "v0","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 11,"step" : 1},{"low" : 0,"up" : 766,"step" : 2}]}]}]} , 
 	...
 	{ "Name" : "v1_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "v1","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 767,"step" : 1},{"low" : 0,"up" : 766,"step" : 2}]}]}]} , 
 	{ "Name" : "v1_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "v1","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 767,"step" : 1},{"low" : 1,"up" : 767,"step" : 2}]}]}]} , 
...
set portList { 
	...
	{ v1_0_address0 sc_out sc_lv 19 signal 2 } 
	{ v1_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ v1_0_q0 sc_in sc_lv 32 signal 2 } 
	{ v1_1_address0 sc_out sc_lv 19 signal 3 } 
	{ v1_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ v1_1_q0 sc_in sc_lv 32 signal 3 } 
	{ v2_address0 sc_out sc_lv 14 signal 4 } 
	{ v2_ce0 sc_out sc_logic 1 signal 4 } 
	{ v2_we0 sc_out sc_logic 1 signal 4 } 
	{ v2_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v1_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "v1_0", "role": "address0" }} , 
 	...
 	{ "name": "v1_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "v1_1", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "56641561", "EstimateLatencyMax" : "56641561",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "56641561", "Max" : "56641561"}
	, {"Name" : "Interval", "Min" : "56641562", "Max" : "56641562"}
]}
...
set Spec2ImplPortList { 
	...
	v1_0 { ap_memory {  { v1_0_address0 mem_address 1 19 }  { v1_0_ce0 mem_ce 1 1 }  { v1_0_q0 mem_dout 0 32 } } }
	v1_1 { ap_memory {  { v1_1_address0 mem_address 1 19 }  { v1_1_ce0 mem_ce 1 1 }  { v1_1_q0 mem_dout 0 32 } } }

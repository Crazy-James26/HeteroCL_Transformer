...
// ==============================================================
#ifndef __top_mac_muladd_16xdS__HH__
#define __top_mac_muladd_16xdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mac_muladd_16xdS) {
    ...
    SC_CTOR(top_mac_muladd_16xdS):  simcore_mac_1_U ("simcore_mac_1_U") {

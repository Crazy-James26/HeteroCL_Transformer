...
// ==============================================================
#ifndef __top_mul_36ns_43nsudo__HH__
#define __top_mul_36ns_43nsudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_36ns_43nsudo) {
    ...
    SC_CTOR(top_mul_36ns_43nsudo):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

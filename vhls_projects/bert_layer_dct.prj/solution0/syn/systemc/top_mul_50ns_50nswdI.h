...
// ==============================================================
#ifndef __top_mul_50ns_50nswdI__HH__
#define __top_mul_50ns_50nswdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_50ns_50nswdI) {
    ...
    SC_CTOR(top_mul_50ns_50nswdI):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

...
// ==============================================================
#ifndef __top_mul_44ns_6ns_jbC__HH__
#define __top_mul_44ns_6ns_jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_44ns_6ns_jbC) {
    ...
    SC_CTOR(top_mul_44ns_6ns_jbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

...
// ==============================================================
#ifndef __top_faddfsub_32nsIfE__HH__
#define __top_faddfsub_32nsIfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_faddfsub_32nsIfE) {
    ...
    SC_CTOR(top_faddfsub_32nsIfE):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

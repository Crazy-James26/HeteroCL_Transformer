...
// ==============================================================
#ifndef __top_mul_72ns_13s_tde__HH__
#define __top_mul_72ns_13s_tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_72ns_13s_tde) {
    ...
    SC_CTOR(top_mul_72ns_13s_tde):  ACMP_mul_us_U ("ACMP_mul_us_U") {

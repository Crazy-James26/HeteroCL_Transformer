...
// ==============================================================
#ifndef __top_mul_41ns_6ns_ibs__HH__
#define __top_mul_41ns_6ns_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_41ns_6ns_ibs) {
    ...
    SC_CTOR(top_mul_41ns_6ns_ibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

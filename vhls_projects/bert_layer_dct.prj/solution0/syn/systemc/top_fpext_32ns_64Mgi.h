...
// ==============================================================
#ifndef __top_fpext_32ns_64Mgi__HH__
#define __top_fpext_32ns_64Mgi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fpext_32ns_64Mgi) {
    ...
    SC_CTOR(top_fpext_32ns_64Mgi):  ACMP_fpext_U ("ACMP_fpext_U") {

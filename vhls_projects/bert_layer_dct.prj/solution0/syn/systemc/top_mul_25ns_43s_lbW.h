...
// ==============================================================
#ifndef __top_mul_25ns_43s_lbW__HH__
#define __top_mul_25ns_43s_lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_25ns_43s_lbW) {
    ...
    SC_CTOR(top_mul_25ns_43s_lbW):  ACMP_mul_us_U ("ACMP_mul_us_U") {

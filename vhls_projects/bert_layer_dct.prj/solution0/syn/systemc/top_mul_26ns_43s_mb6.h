...
// ==============================================================
#ifndef __top_mul_26ns_43s_mb6__HH__
#define __top_mul_26ns_43s_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_26ns_43s_mb6) {
    ...
    SC_CTOR(top_mul_26ns_43s_mb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {

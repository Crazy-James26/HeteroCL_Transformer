...
// ==============================================================
#ifndef __top_mul_mul_25s_6ncg__HH__
#define __top_mul_mul_25s_6ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_25s_6ncg) {
    ...
    SC_CTOR(top_mul_mul_25s_6ncg):  ACMP_smul_su_U ("ACMP_smul_su_U") {

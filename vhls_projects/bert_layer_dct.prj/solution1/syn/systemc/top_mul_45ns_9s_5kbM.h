...
// ==============================================================
#ifndef __top_mul_45ns_9s_5kbM__HH__
#define __top_mul_45ns_9s_5kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_45ns_9s_5kbM) {
    ...
    SC_CTOR(top_mul_45ns_9s_5kbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {

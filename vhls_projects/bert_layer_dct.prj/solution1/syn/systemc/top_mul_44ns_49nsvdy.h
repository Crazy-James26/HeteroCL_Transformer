...
// ==============================================================
#ifndef __top_mul_44ns_49nsvdy__HH__
#define __top_mul_44ns_49nsvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_44ns_49nsvdy) {
    ...
    SC_CTOR(top_mul_44ns_49nsvdy):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

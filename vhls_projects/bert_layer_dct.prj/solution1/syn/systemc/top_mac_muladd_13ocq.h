...
// ==============================================================
#ifndef __top_mac_muladd_13ocq__HH__
#define __top_mac_muladd_13ocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mac_muladd_13ocq) {
    ...
    SC_CTOR(top_mac_muladd_13ocq):  simcore_mac_0_U ("simcore_mac_0_U") {

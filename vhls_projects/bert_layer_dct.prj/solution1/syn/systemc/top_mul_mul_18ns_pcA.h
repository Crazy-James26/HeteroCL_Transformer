...
// ==============================================================
#ifndef __top_mul_mul_18ns_pcA__HH__
#define __top_mul_mul_18ns_pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_18ns_pcA) {
    ...
    SC_CTOR(top_mul_mul_18ns_pcA):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
// ==============================================================
#ifndef __top_fptrunc_64ns_Lf8__HH__
#define __top_fptrunc_64ns_Lf8__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fptrunc_64ns_Lf8) {
    ...
    SC_CTOR(top_fptrunc_64ns_Lf8):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

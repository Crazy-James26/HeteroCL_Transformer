...
entity pow_generic_floatcud_rom is 
    generic(
             DWIDTH     : integer := 56; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_floatcud_rom is 
...
entity pow_generic_floatcud is
    generic (
...
architecture arch of pow_generic_floatcud is
    component pow_generic_floatcud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_floatcud_rom_U :  component pow_generic_floatcud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

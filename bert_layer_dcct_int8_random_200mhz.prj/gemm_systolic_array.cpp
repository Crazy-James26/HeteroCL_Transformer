...
extern "C" {
void gemm_systolic_array_qkv(int8_t A[inp_num][inp_len], const ap_int<4> B[inp_len][inp_len], ap_int<24> C[inp_num][inp_len]){
...
void gemm_systolic_array_ds0(int8_t A[inp_num][inp_len], const ap_int<4> B[inp_len][inp_len], ap_int<24> C[inp_num][inp_len]){
...
void gemm_systolic_array_ds1(int8_t A[inp_num][inp_len], const ap_int<4> B[gelu_len][inp_len], ap_int<24> C[inp_num][gelu_len]){
...
void gemm_systolic_array_ds2(int8_t A[inp_num][gelu_len], const ap_int<4> B[inp_len][gelu_len], ap_int<24> C[inp_num][inp_len]){

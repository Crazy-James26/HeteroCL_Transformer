...
architecture behav of generic_tanh_float_s is 
    ...
    signal tmp_i_77_reg_411 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component Bert_layer_fsub_3eaO IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_fcmp_3ebO IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Bert_layer_fadd_3g8j_U1307 : component Bert_layer_fadd_3g8j
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3eaO_U1308 : component Bert_layer_fsub_3eaO
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fadd_3g8j_U1309 : component Bert_layer_fadd_3g8j
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fadd_3g8j_U1310 : component Bert_layer_fadd_3g8j
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3eaO_U1311 : component Bert_layer_fsub_3eaO
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3eOg_U1312 : component Bert_layer_fmul_3eOg
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    Bert_layer_fdiv_3hbi_U1313 : component Bert_layer_fdiv_3hbi
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    Bert_layer_fptrunbck_U1314 : component Bert_layer_fptrunbck
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    Bert_layer_fpext_ibs_U1315 : component Bert_layer_fpext_ibs
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_fcmp_3ebO_U1316 : component Bert_layer_fcmp_3ebO
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_dadd_6bek_U1317 : component Bert_layer_dadd_6bek
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,

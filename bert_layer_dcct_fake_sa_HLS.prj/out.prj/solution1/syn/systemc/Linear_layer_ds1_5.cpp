...
void Linear_layer_ds1::thread_zext_ln399_2_fu_7593_p1() {
    zext_ln399_2_fu_7593_p1 = esl_zext<19,10>(select_ln399_reg_12142.read());
}

void Linear_layer_ds1::thread_zext_ln399_fu_7623_p1() {
    zext_ln399_fu_7623_p1 = esl_zext<64,9>(select_ln399_1_reg_12148_pp1_iter1_reg.read());
}

void Linear_layer_ds1::thread_zext_ln414_1_fu_11074_p1() {
    zext_ln414_1_fu_11074_p1 = esl_zext<8,6>(shl_ln414_1_fu_11066_p3.read());
}

void Linear_layer_ds1::thread_zext_ln414_2_fu_11162_p1() {
    zext_ln414_2_fu_11162_p1 = esl_zext<8,6>(shl_ln414_1_mid1_fu_11155_p3.read());
}

void Linear_layer_ds1::thread_zext_ln414_fu_11185_p1() {
    zext_ln414_fu_11185_p1 = esl_zext<64,12>(sext_ln414_fu_11182_p1.read());
}

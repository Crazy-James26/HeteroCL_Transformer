...
// ==============================================================
#ifndef __pow_generic_doubldEI_H__
#define __pow_generic_doubldEI_H__
...
struct pow_generic_doubldEI_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doubldEI_ram) {
...
SC_MODULE(pow_generic_doubldEI) {
...
pow_generic_doubldEI_ram* meminst;


SC_CTOR(pow_generic_doubldEI) {
meminst = new pow_generic_doubldEI_ram("pow_generic_doubldEI_ram");

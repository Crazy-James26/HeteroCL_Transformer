...
// ==============================================================
#ifndef __Bert_layer_mul_72d7N__HH__
#define __Bert_layer_mul_72d7N__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_72d7N) {
    ...
    SC_CTOR(Bert_layer_mul_72d7N):  ACMP_mul_us_U ("ACMP_mul_us_U") {

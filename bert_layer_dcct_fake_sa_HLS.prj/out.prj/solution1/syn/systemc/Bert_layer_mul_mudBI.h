...
// ==============================================================
#ifndef __Bert_layer_mul_mudBI__HH__
#define __Bert_layer_mul_mudBI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_mudBI) {
    ...
    SC_CTOR(Bert_layer_mul_mudBI):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

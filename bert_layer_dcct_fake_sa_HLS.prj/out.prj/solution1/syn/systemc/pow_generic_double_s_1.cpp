...
pow_generic_double_s::pow_generic_double_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    pow_reduce_anonymo_20_U = new pow_generic_doubldCI("pow_reduce_anonymo_20_U");
    ...
    pow_reduce_anonymo_19_U = new pow_generic_doubldDI("pow_reduce_anonymo_19_U");
    ...
    pow_reduce_anonymo_16_U = new pow_generic_doubldEI("pow_reduce_anonymo_16_U");
    ...
    pow_reduce_anonymo_17_U = new pow_generic_doubldFJ("pow_reduce_anonymo_17_U");
    ...
    pow_reduce_anonymo_9_U = new pow_generic_doubldGJ("pow_reduce_anonymo_9_U");
    ...
    pow_reduce_anonymo_12_U = new pow_generic_doubldHJ("pow_reduce_anonymo_12_U");
    ...
    pow_reduce_anonymo_13_U = new pow_generic_doubldIJ("pow_reduce_anonymo_13_U");
    ...
    pow_reduce_anonymo_14_U = new pow_generic_doubldJJ("pow_reduce_anonymo_14_U");
    ...
    pow_reduce_anonymo_15_U = new pow_generic_doubldKJ("pow_reduce_anonymo_15_U");
    ...
    pow_reduce_anonymo_18_U = new pow_generic_doubldLJ("pow_reduce_anonymo_18_U");
    ...
    pow_reduce_anonymo_U = new pow_generic_doubldMK("pow_reduce_anonymo_U");
    ...
    pow_reduce_anonymo_21_U = new pow_generic_doubldNK("pow_reduce_anonymo_21_U");
    ...
    Bert_layer_mul_54dOK_U1253 = new Bert_layer_mul_54dOK<1,2,54,6,54>("Bert_layer_mul_54dOK_U1253");
    Bert_layer_mul_54dOK_U1253->clk(ap_clk);
    Bert_layer_mul_54dOK_U1253->reset(ap_rst);
    Bert_layer_mul_54dOK_U1253->din0(b_frac_V_1_reg_2402);
    Bert_layer_mul_54dOK_U1253->din1(grp_fu_844_p1);
    Bert_layer_mul_54dOK_U1253->ce(ap_var_for_const0);
    Bert_layer_mul_54dOK_U1253->dout(grp_fu_844_p2);
    Bert_layer_mul_71dPK_U1254 = new Bert_layer_mul_71dPK<1,5,71,4,75>("Bert_layer_mul_71dPK_U1254");
    Bert_layer_mul_71dPK_U1254->clk(ap_clk);
    Bert_layer_mul_71dPK_U1254->reset(ap_rst);
    Bert_layer_mul_71dPK_U1254->din0(grp_fu_873_p0);
    Bert_layer_mul_71dPK_U1254->din1(grp_fu_873_p1);
    Bert_layer_mul_71dPK_U1254->ce(ap_var_for_const0);
    Bert_layer_mul_71dPK_U1254->dout(grp_fu_873_p2);
    Bert_layer_mul_73dQK_U1255 = new Bert_layer_mul_73dQK<1,5,73,6,79>("Bert_layer_mul_73dQK_U1255");
    Bert_layer_mul_73dQK_U1255->clk(ap_clk);
    Bert_layer_mul_73dQK_U1255->reset(ap_rst);
    Bert_layer_mul_73dQK_U1255->din0(grp_fu_990_p0);
    Bert_layer_mul_73dQK_U1255->din1(grp_fu_990_p1);
    Bert_layer_mul_73dQK_U1255->ce(ap_var_for_const0);
    Bert_layer_mul_73dQK_U1255->dout(grp_fu_990_p2);
    Bert_layer_mul_83dRK_U1256 = new Bert_layer_mul_83dRK<1,5,83,6,89>("Bert_layer_mul_83dRK_U1256");
    Bert_layer_mul_83dRK_U1256->clk(ap_clk);
    Bert_layer_mul_83dRK_U1256->reset(ap_rst);
    Bert_layer_mul_83dRK_U1256->din0(grp_fu_1099_p0);
    Bert_layer_mul_83dRK_U1256->din1(grp_fu_1099_p1);
    Bert_layer_mul_83dRK_U1256->ce(ap_var_for_const0);
    Bert_layer_mul_83dRK_U1256->dout(grp_fu_1099_p2);
    Bert_layer_mul_92dSL_U1257 = new Bert_layer_mul_92dSL<1,5,92,6,98>("Bert_layer_mul_92dSL_U1257");
    Bert_layer_mul_92dSL_U1257->clk(ap_clk);
    Bert_layer_mul_92dSL_U1257->reset(ap_rst);
    Bert_layer_mul_92dSL_U1257->din0(grp_fu_1189_p0);
    Bert_layer_mul_92dSL_U1257->din1(grp_fu_1189_p1);
    Bert_layer_mul_92dSL_U1257->ce(ap_var_for_const0);
    Bert_layer_mul_92dSL_U1257->dout(grp_fu_1189_p2);
    Bert_layer_mul_87dTL_U1258 = new Bert_layer_mul_87dTL<1,5,87,6,93>("Bert_layer_mul_87dTL_U1258");
    Bert_layer_mul_87dTL_U1258->clk(ap_clk);
    Bert_layer_mul_87dTL_U1258->reset(ap_rst);
    Bert_layer_mul_87dTL_U1258->din0(grp_fu_1279_p0);
    Bert_layer_mul_87dTL_U1258->din1(grp_fu_1279_p1);
    Bert_layer_mul_87dTL_U1258->ce(ap_var_for_const0);
    Bert_layer_mul_87dTL_U1258->dout(grp_fu_1279_p2);
    Bert_layer_mul_82dUL_U1259 = new Bert_layer_mul_82dUL<1,5,82,6,88>("Bert_layer_mul_82dUL_U1259");
    Bert_layer_mul_82dUL_U1259->clk(ap_clk);
    Bert_layer_mul_82dUL_U1259->reset(ap_rst);
    Bert_layer_mul_82dUL_U1259->din0(grp_fu_1369_p0);
    Bert_layer_mul_82dUL_U1259->din1(grp_fu_1369_p1);
    Bert_layer_mul_82dUL_U1259->ce(ap_var_for_const0);
    Bert_layer_mul_82dUL_U1259->dout(grp_fu_1369_p2);
    Bert_layer_mul_77dVL_U1260 = new Bert_layer_mul_77dVL<1,5,77,6,83>("Bert_layer_mul_77dVL_U1260");
    Bert_layer_mul_77dVL_U1260->clk(ap_clk);
    Bert_layer_mul_77dVL_U1260->reset(ap_rst);
    Bert_layer_mul_77dVL_U1260->din0(grp_fu_1431_p0);
    Bert_layer_mul_77dVL_U1260->din1(grp_fu_1431_p1);
    Bert_layer_mul_77dVL_U1260->ce(ap_var_for_const0);
    Bert_layer_mul_77dVL_U1260->dout(grp_fu_1431_p2);
    Bert_layer_mul_80dWL_U1261 = new Bert_layer_mul_80dWL<1,5,80,12,90>("Bert_layer_mul_80dWL_U1261");
    Bert_layer_mul_80dWL_U1261->clk(ap_clk);
    Bert_layer_mul_80dWL_U1261->reset(ap_rst);
    Bert_layer_mul_80dWL_U1261->din0(grp_fu_1440_p0);
    Bert_layer_mul_80dWL_U1261->din1(b_exp_3_reg_2387_pp0_iter42_reg);
    Bert_layer_mul_80dWL_U1261->ce(ap_var_for_const0);
    Bert_layer_mul_80dWL_U1261->dout(grp_fu_1440_p2);
    Bert_layer_mul_54dXL_U1262 = new Bert_layer_mul_54dXL<1,5,54,78,131>("Bert_layer_mul_54dXL_U1262");
    Bert_layer_mul_54dXL_U1262->clk(ap_clk);
    Bert_layer_mul_54dXL_U1262->reset(ap_rst);
    Bert_layer_mul_54dXL_U1262->din0(grp_fu_1706_p0);
    Bert_layer_mul_54dXL_U1262->din1(log_base_V_reg_2764);
    Bert_layer_mul_54dXL_U1262->ce(ap_var_for_const0);
    Bert_layer_mul_54dXL_U1262->dout(grp_fu_1706_p2);
    Bert_layer_mul_55dYM_U1263 = new Bert_layer_mul_55dYM<1,5,55,78,130>("Bert_layer_mul_55dYM_U1263");
    Bert_layer_mul_55dYM_U1263->clk(ap_clk);
    Bert_layer_mul_55dYM_U1263->reset(ap_rst);
    Bert_layer_mul_55dYM_U1263->din0(grp_fu_1715_p0);
    Bert_layer_mul_55dYM_U1263->din1(log_base_V_reg_2764);
    Bert_layer_mul_55dYM_U1263->ce(ap_var_for_const0);
    Bert_layer_mul_55dYM_U1263->dout(grp_fu_1715_p2);
    Bert_layer_mul_72dZM_U1264 = new Bert_layer_mul_72dZM<1,5,72,13,83>("Bert_layer_mul_72dZM_U1264");
    Bert_layer_mul_72dZM_U1264->clk(ap_clk);
    Bert_layer_mul_72dZM_U1264->reset(ap_rst);
    Bert_layer_mul_72dZM_U1264->din0(grp_fu_1831_p0);
    Bert_layer_mul_72dZM_U1264->din1(r_exp_V_3_reg_2806);
    Bert_layer_mul_72dZM_U1264->ce(ap_var_for_const0);
    Bert_layer_mul_72dZM_U1264->dout(grp_fu_1831_p2);
    Bert_layer_mul_43d0M_U1265 = new Bert_layer_mul_43d0M<1,2,43,36,79>("Bert_layer_mul_43d0M_U1265");
    Bert_layer_mul_43d0M_U1265->clk(ap_clk);
    Bert_layer_mul_43d0M_U1265->reset(ap_rst);
    Bert_layer_mul_43d0M_U1265->din0(grp_fu_1951_p0);
    Bert_layer_mul_43d0M_U1265->din1(grp_fu_1951_p1);
    Bert_layer_mul_43d0M_U1265->ce(ap_var_for_const0);
    Bert_layer_mul_43d0M_U1265->dout(grp_fu_1951_p2);
    Bert_layer_mul_49d1M_U1266 = new Bert_layer_mul_49d1M<1,2,49,44,93>("Bert_layer_mul_49d1M_U1266");
    Bert_layer_mul_49d1M_U1266->clk(ap_clk);
    Bert_layer_mul_49d1M_U1266->reset(ap_rst);
    Bert_layer_mul_49d1M_U1266->din0(grp_fu_2017_p0);
    Bert_layer_mul_49d1M_U1266->din1(grp_fu_2017_p1);
    Bert_layer_mul_49d1M_U1266->ce(ap_var_for_const0);
    Bert_layer_mul_49d1M_U1266->dout(grp_fu_2017_p2);
    Bert_layer_mul_50d2M_U1267 = new Bert_layer_mul_50d2M<1,2,50,50,100>("Bert_layer_mul_50d2M_U1267");
    Bert_layer_mul_50d2M_U1267->clk(ap_clk);
    Bert_layer_mul_50d2M_U1267->reset(ap_rst);
    Bert_layer_mul_50d2M_U1267->din0(grp_fu_2095_p0);
    Bert_layer_mul_50d2M_U1267->din1(grp_fu_2095_p1);
    Bert_layer_mul_50d2M_U1267->ce(ap_var_for_const0);
    Bert_layer_mul_50d2M_U1267->dout(grp_fu_2095_p2);
    Bert_layer_mac_mud3M_U1268 = new Bert_layer_mac_mud3M<1,1,16,16,19,31>("Bert_layer_mac_mud3M_U1268");
    Bert_layer_mac_mud3M_U1268->din0(grp_fu_2334_p0);
    Bert_layer_mac_mud3M_U1268->din1(m_fix_hi_V_reg_2796);
    Bert_layer_mac_mud3M_U1268->din2(rhs_V_13_fu_1762_p3);
    Bert_layer_mac_mud3M_U1268->dout(grp_fu_2334_p3);
...
pow_generic_double_s::~pow_generic_double_s() {
    ...
    delete Bert_layer_mul_54dOK_U1253;
    delete Bert_layer_mul_71dPK_U1254;
    delete Bert_layer_mul_73dQK_U1255;
    delete Bert_layer_mul_83dRK_U1256;
    delete Bert_layer_mul_92dSL_U1257;
    delete Bert_layer_mul_87dTL_U1258;
    delete Bert_layer_mul_82dUL_U1259;
    delete Bert_layer_mul_77dVL_U1260;
    delete Bert_layer_mul_80dWL_U1261;
    delete Bert_layer_mul_54dXL_U1262;
    delete Bert_layer_mul_55dYM_U1263;
    delete Bert_layer_mul_72dZM_U1264;
    delete Bert_layer_mul_43d0M_U1265;
    delete Bert_layer_mul_49d1M_U1266;
    delete Bert_layer_mul_50d2M_U1267;
    delete Bert_layer_mac_mud3M_U1268;
}

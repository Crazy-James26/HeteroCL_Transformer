...
// ==============================================================
#ifndef __Bert_layer_mul_54dOK__HH__
#define __Bert_layer_mul_54dOK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_54dOK) {
    ...
    SC_CTOR(Bert_layer_mul_54dOK):  ACMP_mul_su_U ("ACMP_mul_su_U") {

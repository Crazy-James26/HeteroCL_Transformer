...
// ==============================================================
#ifndef __Bert_layer_mul_54DeQ__HH__
#define __Bert_layer_mul_54DeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_54DeQ) {
    ...
    SC_CTOR(Bert_layer_mul_54DeQ):  ACMP_mul_su_U ("ACMP_mul_su_U") {

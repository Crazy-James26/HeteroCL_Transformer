...
// ==============================================================
#ifndef __Bert_layer_mac_muShg__HH__
#define __Bert_layer_mac_muShg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mac_muShg) {
    ...
    SC_CTOR(Bert_layer_mac_muShg):  simcore_mac_0_U ("simcore_mac_0_U") {

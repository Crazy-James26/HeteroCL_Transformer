...
// ==============================================================
#ifndef __Bert_layer_faddfskbM__HH__
#define __Bert_layer_faddfskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfskbM) {
    ...
    SC_CTOR(Bert_layer_faddfskbM):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

...
// ==============================================================
#ifndef __Bert_layer_mul_muqcK__HH__
#define __Bert_layer_mul_muqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_muqcK) {
    ...
    SC_CTOR(Bert_layer_mul_muqcK):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
// ==============================================================
#ifndef __Bert_layer_mul_54Mgi__HH__
#define __Bert_layer_mul_54Mgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_54Mgi) {
    ...
    SC_CTOR(Bert_layer_mul_54Mgi):  ACMP_mul_us_U ("ACMP_mul_us_U") {

...
// ==============================================================
#ifndef __Bert_layer_mul_mueOg__HH__
#define __Bert_layer_mul_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_mueOg) {
    ...
    SC_CTOR(Bert_layer_mul_mueOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
// ==============================================================
#ifndef __Bert_layer_fpext_mb6__HH__
#define __Bert_layer_fpext_mb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fpext_mb6) {
    ...
    SC_CTOR(Bert_layer_fpext_mb6):  ACMP_fpext_U ("ACMP_fpext_U") {

...
architecture behav of generic_tanh_float_s is 
    ...
    signal tmp_i_67_reg_411 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component Bert_layer_fsub_3Zio IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_fcmp_30iy IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Bert_layer_fadd_3bkb_U1223 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3Zio_U1224 : component Bert_layer_fsub_3Zio
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fadd_3bkb_U1225 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fadd_3bkb_U1226 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3Zio_U1227 : component Bert_layer_fsub_3Zio
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U1228 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    Bert_layer_fdiv_3g8j_U1229 : component Bert_layer_fdiv_3g8j
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    Bert_layer_fptrunlbW_U1230 : component Bert_layer_fptrunlbW
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    Bert_layer_fpext_mb6_U1231 : component Bert_layer_fpext_mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_fcmp_30iy_U1232 : component Bert_layer_fcmp_30iy
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_dadd_6ocq_U1233 : component Bert_layer_dadd_6ocq
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,

...
architecture behav of exp_generic_double_s is 
    ...
    component Bert_layer_mul_72WhU IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_36Xh4 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_44Yie IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_50Rg6 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mac_muShg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component pow_generic_doublAem IS
    generic (
        DataWidth : INTEGER;
    ...
    component pow_generic_doublBew IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component pow_generic_doublCeG IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    table_exp_Z1_array_s_U : component pow_generic_doublAem
    generic map (
        DataWidth => 58,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z3_array_V_U : component pow_generic_doublBew
    generic map (
        DataWidth => 26,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z2_array_V_U : component pow_generic_doublCeG
    generic map (
        DataWidth => 42,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    Bert_layer_mul_72WhU_U1214 : component Bert_layer_mul_72WhU
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 72,
    ...
    Bert_layer_mul_36Xh4_U1215 : component Bert_layer_mul_36Xh4
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 36,
    ...
    Bert_layer_mul_44Yie_U1216 : component Bert_layer_mul_44Yie
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 44,
    ...
    Bert_layer_mul_50Rg6_U1217 : component Bert_layer_mul_50Rg6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    Bert_layer_mac_muShg_U1218 : component Bert_layer_mac_muShg
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,

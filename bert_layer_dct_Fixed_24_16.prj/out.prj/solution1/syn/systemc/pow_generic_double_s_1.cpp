...
pow_generic_double_s::pow_generic_double_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    Bert_layer_mul_54DeQ_U58 = new Bert_layer_mul_54DeQ<1,2,54,6,54>("Bert_layer_mul_54DeQ_U58");
    Bert_layer_mul_54DeQ_U58->clk(ap_clk);
    Bert_layer_mul_54DeQ_U58->reset(ap_rst);
    Bert_layer_mul_54DeQ_U58->din0(b_frac_V_1_reg_2402);
    Bert_layer_mul_54DeQ_U58->din1(grp_fu_844_p1);
    Bert_layer_mul_54DeQ_U58->ce(ap_var_for_const0);
    Bert_layer_mul_54DeQ_U58->dout(grp_fu_844_p2);
    Bert_layer_mul_71Ee0_U59 = new Bert_layer_mul_71Ee0<1,5,71,4,75>("Bert_layer_mul_71Ee0_U59");
    Bert_layer_mul_71Ee0_U59->clk(ap_clk);
    Bert_layer_mul_71Ee0_U59->reset(ap_rst);
    Bert_layer_mul_71Ee0_U59->din0(grp_fu_873_p0);
    Bert_layer_mul_71Ee0_U59->din1(grp_fu_873_p1);
    Bert_layer_mul_71Ee0_U59->ce(ap_var_for_const0);
    Bert_layer_mul_71Ee0_U59->dout(grp_fu_873_p2);
    Bert_layer_mul_73Ffa_U60 = new Bert_layer_mul_73Ffa<1,5,73,6,79>("Bert_layer_mul_73Ffa_U60");
    Bert_layer_mul_73Ffa_U60->clk(ap_clk);
    Bert_layer_mul_73Ffa_U60->reset(ap_rst);
    Bert_layer_mul_73Ffa_U60->din0(grp_fu_990_p0);
    Bert_layer_mul_73Ffa_U60->din1(grp_fu_990_p1);
    Bert_layer_mul_73Ffa_U60->ce(ap_var_for_const0);
    Bert_layer_mul_73Ffa_U60->dout(grp_fu_990_p2);
    Bert_layer_mul_83Gfk_U61 = new Bert_layer_mul_83Gfk<1,5,83,6,89>("Bert_layer_mul_83Gfk_U61");
    Bert_layer_mul_83Gfk_U61->clk(ap_clk);
    Bert_layer_mul_83Gfk_U61->reset(ap_rst);
    Bert_layer_mul_83Gfk_U61->din0(grp_fu_1099_p0);
    Bert_layer_mul_83Gfk_U61->din1(grp_fu_1099_p1);
    Bert_layer_mul_83Gfk_U61->ce(ap_var_for_const0);
    Bert_layer_mul_83Gfk_U61->dout(grp_fu_1099_p2);
    Bert_layer_mul_92Hfu_U62 = new Bert_layer_mul_92Hfu<1,5,92,6,98>("Bert_layer_mul_92Hfu_U62");
    Bert_layer_mul_92Hfu_U62->clk(ap_clk);
    Bert_layer_mul_92Hfu_U62->reset(ap_rst);
    Bert_layer_mul_92Hfu_U62->din0(grp_fu_1189_p0);
    Bert_layer_mul_92Hfu_U62->din1(grp_fu_1189_p1);
    Bert_layer_mul_92Hfu_U62->ce(ap_var_for_const0);
    Bert_layer_mul_92Hfu_U62->dout(grp_fu_1189_p2);
    Bert_layer_mul_87IfE_U63 = new Bert_layer_mul_87IfE<1,5,87,6,93>("Bert_layer_mul_87IfE_U63");
    Bert_layer_mul_87IfE_U63->clk(ap_clk);
    Bert_layer_mul_87IfE_U63->reset(ap_rst);
    Bert_layer_mul_87IfE_U63->din0(grp_fu_1279_p0);
    Bert_layer_mul_87IfE_U63->din1(grp_fu_1279_p1);
    Bert_layer_mul_87IfE_U63->ce(ap_var_for_const0);
    Bert_layer_mul_87IfE_U63->dout(grp_fu_1279_p2);
    Bert_layer_mul_82JfO_U64 = new Bert_layer_mul_82JfO<1,5,82,6,88>("Bert_layer_mul_82JfO_U64");
    Bert_layer_mul_82JfO_U64->clk(ap_clk);
    Bert_layer_mul_82JfO_U64->reset(ap_rst);
    Bert_layer_mul_82JfO_U64->din0(grp_fu_1369_p0);
    Bert_layer_mul_82JfO_U64->din1(grp_fu_1369_p1);
    Bert_layer_mul_82JfO_U64->ce(ap_var_for_const0);
    Bert_layer_mul_82JfO_U64->dout(grp_fu_1369_p2);
    Bert_layer_mul_77KfY_U65 = new Bert_layer_mul_77KfY<1,5,77,6,83>("Bert_layer_mul_77KfY_U65");
    Bert_layer_mul_77KfY_U65->clk(ap_clk);
    Bert_layer_mul_77KfY_U65->reset(ap_rst);
    Bert_layer_mul_77KfY_U65->din0(grp_fu_1431_p0);
    Bert_layer_mul_77KfY_U65->din1(grp_fu_1431_p1);
    Bert_layer_mul_77KfY_U65->ce(ap_var_for_const0);
    Bert_layer_mul_77KfY_U65->dout(grp_fu_1431_p2);
    Bert_layer_mul_80Lf8_U66 = new Bert_layer_mul_80Lf8<1,5,80,12,90>("Bert_layer_mul_80Lf8_U66");
    Bert_layer_mul_80Lf8_U66->clk(ap_clk);
    Bert_layer_mul_80Lf8_U66->reset(ap_rst);
    Bert_layer_mul_80Lf8_U66->din0(grp_fu_1440_p0);
    Bert_layer_mul_80Lf8_U66->din1(b_exp_3_reg_2387_pp0_iter42_reg);
    Bert_layer_mul_80Lf8_U66->ce(ap_var_for_const0);
    Bert_layer_mul_80Lf8_U66->dout(grp_fu_1440_p2);
    Bert_layer_mul_54Mgi_U67 = new Bert_layer_mul_54Mgi<1,5,54,78,131>("Bert_layer_mul_54Mgi_U67");
    Bert_layer_mul_54Mgi_U67->clk(ap_clk);
    Bert_layer_mul_54Mgi_U67->reset(ap_rst);
    Bert_layer_mul_54Mgi_U67->din0(grp_fu_1706_p0);
    Bert_layer_mul_54Mgi_U67->din1(log_base_V_reg_2764);
    Bert_layer_mul_54Mgi_U67->ce(ap_var_for_const0);
    Bert_layer_mul_54Mgi_U67->dout(grp_fu_1706_p2);
    Bert_layer_mul_55Ngs_U68 = new Bert_layer_mul_55Ngs<1,5,55,78,130>("Bert_layer_mul_55Ngs_U68");
    Bert_layer_mul_55Ngs_U68->clk(ap_clk);
    Bert_layer_mul_55Ngs_U68->reset(ap_rst);
    Bert_layer_mul_55Ngs_U68->din0(grp_fu_1715_p0);
    Bert_layer_mul_55Ngs_U68->din1(log_base_V_reg_2764);
    Bert_layer_mul_55Ngs_U68->ce(ap_var_for_const0);
    Bert_layer_mul_55Ngs_U68->dout(grp_fu_1715_p2);
    Bert_layer_mul_72OgC_U69 = new Bert_layer_mul_72OgC<1,5,72,13,83>("Bert_layer_mul_72OgC_U69");
    Bert_layer_mul_72OgC_U69->clk(ap_clk);
    Bert_layer_mul_72OgC_U69->reset(ap_rst);
    Bert_layer_mul_72OgC_U69->din0(grp_fu_1831_p0);
    Bert_layer_mul_72OgC_U69->din1(r_exp_V_3_reg_2806);
    Bert_layer_mul_72OgC_U69->ce(ap_var_for_const0);
    Bert_layer_mul_72OgC_U69->dout(grp_fu_1831_p2);
    Bert_layer_mul_43PgM_U70 = new Bert_layer_mul_43PgM<1,2,43,36,79>("Bert_layer_mul_43PgM_U70");
    Bert_layer_mul_43PgM_U70->clk(ap_clk);
    Bert_layer_mul_43PgM_U70->reset(ap_rst);
    Bert_layer_mul_43PgM_U70->din0(grp_fu_1951_p0);
    Bert_layer_mul_43PgM_U70->din1(grp_fu_1951_p1);
    Bert_layer_mul_43PgM_U70->ce(ap_var_for_const0);
    Bert_layer_mul_43PgM_U70->dout(grp_fu_1951_p2);
    Bert_layer_mul_49QgW_U71 = new Bert_layer_mul_49QgW<1,2,49,44,93>("Bert_layer_mul_49QgW_U71");
    Bert_layer_mul_49QgW_U71->clk(ap_clk);
    Bert_layer_mul_49QgW_U71->reset(ap_rst);
    Bert_layer_mul_49QgW_U71->din0(grp_fu_2017_p0);
    Bert_layer_mul_49QgW_U71->din1(grp_fu_2017_p1);
    Bert_layer_mul_49QgW_U71->ce(ap_var_for_const0);
    Bert_layer_mul_49QgW_U71->dout(grp_fu_2017_p2);
    Bert_layer_mul_50Rg6_U72 = new Bert_layer_mul_50Rg6<1,2,50,50,100>("Bert_layer_mul_50Rg6_U72");
    Bert_layer_mul_50Rg6_U72->clk(ap_clk);
    Bert_layer_mul_50Rg6_U72->reset(ap_rst);
    Bert_layer_mul_50Rg6_U72->din0(grp_fu_2095_p0);
    Bert_layer_mul_50Rg6_U72->din1(grp_fu_2095_p1);
    Bert_layer_mul_50Rg6_U72->ce(ap_var_for_const0);
    Bert_layer_mul_50Rg6_U72->dout(grp_fu_2095_p2);
    Bert_layer_mac_muShg_U73 = new Bert_layer_mac_muShg<1,1,16,16,19,31>("Bert_layer_mac_muShg_U73");
    Bert_layer_mac_muShg_U73->din0(grp_fu_2334_p0);
    Bert_layer_mac_muShg_U73->din1(m_fix_hi_V_reg_2796);
    Bert_layer_mac_muShg_U73->din2(rhs_V_13_fu_1762_p3);
    Bert_layer_mac_muShg_U73->dout(grp_fu_2334_p3);
...
pow_generic_double_s::~pow_generic_double_s() {
    ...
    delete Bert_layer_mul_54DeQ_U58;
    delete Bert_layer_mul_71Ee0_U59;
    delete Bert_layer_mul_73Ffa_U60;
    delete Bert_layer_mul_83Gfk_U61;
    delete Bert_layer_mul_92Hfu_U62;
    delete Bert_layer_mul_87IfE_U63;
    delete Bert_layer_mul_82JfO_U64;
    delete Bert_layer_mul_77KfY_U65;
    delete Bert_layer_mul_80Lf8_U66;
    delete Bert_layer_mul_54Mgi_U67;
    delete Bert_layer_mul_55Ngs_U68;
    delete Bert_layer_mul_72OgC_U69;
    delete Bert_layer_mul_43PgM_U70;
    delete Bert_layer_mul_49QgW_U71;
    delete Bert_layer_mul_50Rg6_U72;
    delete Bert_layer_mac_muShg_U73;
}

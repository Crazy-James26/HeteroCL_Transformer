...
// ==============================================================
#ifndef __Bert_layer_fpext_g8j__HH__
#define __Bert_layer_fpext_g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fpext_g8j) {
    ...
    SC_CTOR(Bert_layer_fpext_g8j):  ACMP_fpext_U ("ACMP_fpext_U") {

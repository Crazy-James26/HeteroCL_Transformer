...
struct exp_generic_double_s : public sc_module {
    ...
    Bert_layer_mul_72WhU<1,5,72,13,84>* Bert_layer_mul_72WhU_U103;
    Bert_layer_mul_36Xh4<1,2,36,43,79>* Bert_layer_mul_36Xh4_U104;
    Bert_layer_mul_44Yie<1,2,44,49,93>* Bert_layer_mul_44Yie_U105;
    Bert_layer_mul_50Rg6<1,2,50,50,100>* Bert_layer_mul_50Rg6_U106;
    Bert_layer_mac_muShg<1,1,16,16,19,31>* Bert_layer_mac_muShg_U107;

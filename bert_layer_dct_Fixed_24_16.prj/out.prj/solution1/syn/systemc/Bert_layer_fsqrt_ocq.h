...
// ==============================================================
#ifndef __Bert_layer_fsqrt_ocq__HH__
#define __Bert_layer_fsqrt_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fsqrt_ocq) {
    ...
    SC_CTOR(Bert_layer_fsqrt_ocq):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {

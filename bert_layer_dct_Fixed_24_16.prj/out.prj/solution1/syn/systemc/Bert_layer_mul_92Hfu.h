...
// ==============================================================
#ifndef __Bert_layer_mul_92Hfu__HH__
#define __Bert_layer_mul_92Hfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_92Hfu) {
    ...
    SC_CTOR(Bert_layer_mul_92Hfu):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

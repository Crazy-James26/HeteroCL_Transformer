...
// ==============================================================
#ifndef __Bert_layer_fcmp_3Zio__HH__
#define __Bert_layer_fcmp_3Zio__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fcmp_3Zio) {
    ...
    SC_CTOR(Bert_layer_fcmp_3Zio):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

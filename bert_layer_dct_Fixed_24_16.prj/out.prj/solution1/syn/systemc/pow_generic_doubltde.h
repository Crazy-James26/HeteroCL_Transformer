...
// ==============================================================
#ifndef __pow_generic_doubltde_H__
#define __pow_generic_doubltde_H__
...
struct pow_generic_doubltde_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doubltde_ram) {
...
SC_MODULE(pow_generic_doubltde) {
...
pow_generic_doubltde_ram* meminst;


SC_CTOR(pow_generic_doubltde) {
meminst = new pow_generic_doubltde_ram("pow_generic_doubltde_ram");

...
// ==============================================================
#ifndef __Bert_layer_mul_55Ngs__HH__
#define __Bert_layer_mul_55Ngs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_55Ngs) {
    ...
    SC_CTOR(Bert_layer_mul_55Ngs):  ACMP_mul_us_U ("ACMP_mul_us_U") {

...
// ==============================================================
#ifndef __Bert_layer_faddfsmb6__HH__
#define __Bert_layer_faddfsmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfsmb6) {
    ...
    SC_CTOR(Bert_layer_faddfsmb6):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

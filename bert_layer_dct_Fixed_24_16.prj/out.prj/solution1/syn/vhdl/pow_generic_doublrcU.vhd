...
entity pow_generic_doublrcU_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_doublrcU_rom is 
...
entity pow_generic_doublrcU is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of pow_generic_doublrcU is
    component pow_generic_doublrcU_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_doublrcU_rom_U :  component pow_generic_doublrcU_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Q_h_V \
    op interface \
    ports { Q_h_V_address0 { O 10 vector } Q_h_V_ce0 { O 1 bit } Q_h_V_we0 { O 1 bit } Q_h_V_d0 { O 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename K_h_V \
    op interface \
    ports { K_h_V_address0 { O 10 vector } K_h_V_ce0 { O 1 bit } K_h_V_we0 { O 1 bit } K_h_V_d0 { O 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename V_h_V \
    op interface \
    ports { V_h_V_address0 { O 10 vector } V_h_V_ce0 { O 1 bit } V_h_V_we0 { O 1 bit } V_h_V_d0 { O 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v82 \
    op interface \
    ports { v82_address0 { O 14 vector } v82_ce0 { O 1 bit } v82_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v83 \
    op interface \
    ports { v83_address0 { O 14 vector } v83_ce0 { O 1 bit } v83_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v84 \
    op interface \
    ports { v84_address0 { O 14 vector } v84_ce0 { O 1 bit } v84_q0 { I 24 vector } } \
} "
} else {

...
set C_modelArgList {
	...
	{ v264_V int 24 regular {array 9216 { 1 3 } 1 1 }  }
	{ v265 float 32 regular {array 9216 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v242", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "v264_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v264_V_q0 sc_in sc_lv 24 signal 1 } 
	{ v265_address0 sc_out sc_lv 14 signal 2 } 
	{ v265_ce0 sc_out sc_logic 1 signal 2 } 
	{ v265_we0 sc_out sc_logic 1 signal 2 } 
	{ v265_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v264_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v264_V", "role": "q0" }} , 
 	{ "name": "v265_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v265", "role": "address0" }} , 
 	{ "name": "v265_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v265", "role": "ce0" }} , 
 	{ "name": "v265_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v265", "role": "we0" }} , 
 	{ "name": "v265_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v265", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	v242 { ap_memory {  { v242_address0 mem_address 1 14 }  { v242_ce0 mem_ce 1 1 }  { v242_q0 in_data 0 24 } } }
	v264_V { ap_memory {  { v264_V_address0 mem_address 1 14 }  { v264_V_ce0 mem_ce 1 1 }  { v264_V_q0 in_data 0 24 } } }
	v265 { ap_memory {  { v265_address0 mem_address 1 14 }  { v265_ce0 mem_ce 1 1 }  { v265_we0 mem_we 1 1 }  { v265_d0 mem_din 1 32 } } }
}

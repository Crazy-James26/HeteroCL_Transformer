set moduleName Layer_norm_1_Pipeline_l_j12
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mean2_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln258", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln258 sc_in sc_lv 4 signal 3 } 
	...
	{ sub_ln260 sc_in sc_lv 14 signal 5 } 
	{ v135_address0 sc_out sc_lv 14 signal 6 } 
	{ v135_ce0 sc_out sc_logic 1 signal 6 } 
	{ v135_q0 sc_in sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln258", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln258", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln258 { ap_none {  { zext_ln258 in_data 0 4 } } }

set moduleName Attention_layer_Pipeline_l_norm_i3_l_j3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Attention_layer_Pipeline_l_norm_i3_l_j3}
set C_modelType { void 0 }
set C_modelArgList {
	{ v25 float 32 regular {array 144 { 0 3 } 0 1 }  }
	{ outp_V int 24 regular {array 144 { 1 3 } 1 1 }  }
}
...
set portList { 
	...
	{ v25_address0 sc_out sc_lv 8 signal 0 } 
	{ v25_ce0 sc_out sc_logic 1 signal 0 } 
	{ v25_we0 sc_out sc_logic 1 signal 0 } 
	{ v25_d0 sc_out sc_lv 32 signal 0 } 
	{ outp_V_address0 sc_out sc_lv 8 signal 1 } 
...
set Spec2ImplPortList { 
	...
	outp_V { ap_memory {  { outp_V_address0 mem_address 1 8 }  { outp_V_ce0 mem_ce 1 1 }  { outp_V_q0 in_data 0 24 } } }
}

...
set C_modelArgList {
	{ v3 int 24 regular {array 9216 { 0 1 } 1 1 }  }
...
set portList { 
	...
	{ v3_q1 sc_in sc_lv 24 signal 0 } 
	{ v244_address0 sc_out sc_lv 10 signal 1 } 
	{ v244_ce0 sc_out sc_logic 1 signal 1 } 
	{ v244_q0 sc_in sc_lv 24 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	v3 { ap_memory {  { v3_address0 mem_address 1 14 }  { v3_ce0 mem_ce 1 1 }  { v3_we0 mem_we 1 1 }  { v3_d0 mem_din 1 24 }  { v3_address1 MemPortADDR2 1 14 }  { v3_ce1 MemPortCE2 1 1 }  { v3_q1 in_data 0 24 } } }
	v244 { ap_memory {  { v244_address0 mem_address 1 10 }  { v244_ce0 mem_ce 1 1 }  { v244_q0 in_data 0 24 } } }
}

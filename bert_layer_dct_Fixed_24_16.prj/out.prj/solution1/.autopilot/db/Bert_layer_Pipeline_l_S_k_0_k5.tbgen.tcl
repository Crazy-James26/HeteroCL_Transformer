...
set C_modelArgList {
	{ v269_V_load int 24 regular  }
	{ v269_V int 24 regular {array 9216 { 0 3 } 0 1 }  }
	{ empty int 14 regular  }
	{ sub_ln386 int 22 regular  }
	{ v253 int 24 regular {array 2359296 { 1 3 } 1 1 }  }
	{ sub_ln385 int 16 regular  }
	{ v268_V int 24 regular {array 36864 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v269_V_load", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "v269_V", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln386", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
 	{ "Name" : "v253", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln385", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "v268_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ v269_V_load sc_in sc_lv 24 signal 0 } 
	{ v269_V_address0 sc_out sc_lv 14 signal 1 } 
	...
	{ sub_ln386 sc_in sc_lv 22 signal 3 } 
	{ v253_address0 sc_out sc_lv 22 signal 4 } 
	{ v253_ce0 sc_out sc_logic 1 signal 4 } 
	{ v253_q0 sc_in sc_lv 24 signal 4 } 
	{ sub_ln385 sc_in sc_lv 16 signal 5 } 
	{ v268_V_address0 sc_out sc_lv 16 signal 6 } 
	{ v268_V_ce0 sc_out sc_logic 1 signal 6 } 
	{ v268_V_q0 sc_in sc_lv 24 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v269_V_load", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v269_V_load", "role": "default" }} , 
 	{ "name": "v269_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v269_V", "role": "address0" }} , 
 	...
 	{ "name": "sub_ln386", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "sub_ln386", "role": "default" }} , 
 	...
 	{ "name": "sub_ln385", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sub_ln385", "role": "default" }} , 
 	...
 	{ "name": "v268_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v268_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	v269_V_load { ap_none {  { v269_V_load in_data 0 24 } } }
	v269_V { ap_memory {  { v269_V_address0 mem_address 1 14 }  { v269_V_ce0 mem_ce 1 1 }  { v269_V_we0 mem_we 1 1 }  { v269_V_d0 mem_din 1 24 } } }
	empty { ap_none {  { empty in_data 0 14 } } }
	sub_ln386 { ap_none {  { sub_ln386 in_data 0 22 } } }
	v253 { ap_memory {  { v253_address0 mem_address 1 22 }  { v253_ce0 mem_ce 1 1 }  { v253_q0 mem_dout 0 24 } } }
	sub_ln385 { ap_none {  { sub_ln385 in_data 0 16 } } }
	v268_V { ap_memory {  { v268_V_address0 mem_address 1 16 }  { v268_V_ce0 mem_ce 1 1 }  { v268_V_q0 mem_dout 0 24 } } }
}

set moduleName Bert_layer_Pipeline_l_S_i_j_0_i11_l_j119
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_S_i_j_0_i11_l_j119}
set C_modelType { void 0 }
set C_modelArgList {
	{ v266_V int 24 regular {array 9216 { 1 3 } 1 1 }  }
	{ v269_V int 24 regular {array 9216 { 1 3 } 1 1 }  }
	{ v270 float 32 regular {array 9216 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v266_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v266_V_address0 sc_out sc_lv 14 signal 0 } 
	{ v266_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ v266_V_q0 sc_in sc_lv 24 signal 0 } 
	{ v269_V_address0 sc_out sc_lv 14 signal 1 } 
	{ v269_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ v269_V_q0 sc_in sc_lv 24 signal 1 } 
	{ v270_address0 sc_out sc_lv 14 signal 2 } 
	{ v270_ce0 sc_out sc_logic 1 signal 2 } 
	{ v270_we0 sc_out sc_logic 1 signal 2 } 
	{ v270_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v266_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v266_V", "role": "address0" }} , 
 	{ "name": "v266_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v266_V", "role": "ce0" }} , 
 	{ "name": "v266_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v266_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	v266_V { ap_memory {  { v266_V_address0 mem_address 1 14 }  { v266_V_ce0 mem_ce 1 1 }  { v266_V_q0 in_data 0 24 } } }
	v269_V { ap_memory {  { v269_V_address0 mem_address 1 14 }  { v269_V_ce0 mem_ce 1 1 }  { v269_V_q0 in_data 0 24 } } }

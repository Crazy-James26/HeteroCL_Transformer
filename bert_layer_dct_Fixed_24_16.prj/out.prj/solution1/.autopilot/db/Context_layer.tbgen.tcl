...
set C_modelArgList {
	{ v65_V int 24 regular {array 144 { 1 3 } 1 1 }  }
	{ v66_V int 24 regular {array 768 { 1 3 } 1 1 }  }
	{ v67_V int 24 regular {array 768 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v65_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "v66_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "v67_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ v65_V_address0 sc_out sc_lv 8 signal 0 } 
	{ v65_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ v65_V_q0 sc_in sc_lv 24 signal 0 } 
	{ v66_V_address0 sc_out sc_lv 10 signal 1 } 
	{ v66_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ v66_V_q0 sc_in sc_lv 24 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v65_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "v65_V", "role": "address0" }} , 
 	{ "name": "v65_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v65_V", "role": "ce0" }} , 
 	{ "name": "v65_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v65_V", "role": "q0" }} , 
 	{ "name": "v66_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "v66_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "39218", "Max" : "39218"}
	, {"Name" : "Interval", "Min" : "39218", "Max" : "39218"}
]}
...
set Spec2ImplPortList { 
	v65_V { ap_memory {  { v65_V_address0 mem_address 1 8 }  { v65_V_ce0 mem_ce 1 1 }  { v65_V_q0 mem_dout 0 24 } } }
	v66_V { ap_memory {  { v66_V_address0 mem_address 1 10 }  { v66_V_ce0 mem_ce 1 1 }  { v66_V_q0 mem_dout 0 24 } } }
	v67_V { ap_memory {  { v67_V_address0 mem_address 1 10 }  { v67_V_ce0 mem_ce 1 1 }  { v67_V_we0 mem_we 1 1 }  { v67_V_d0 mem_din 1 24 }  { v67_V_q0 mem_dout 0 24 } } }
}

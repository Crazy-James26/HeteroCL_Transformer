set moduleName Attention_layer_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_61_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Attention_layer_Pipeline_VITIS_LOOP_60_1_VITIS_LOOP_61_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ outp_V int 24 regular {array 144 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ outp_V_address0 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	outp_V { ap_memory {  { outp_V_address0 mem_address 1 8 }  { outp_V_ce0 mem_ce 1 1 }  { outp_V_we0 mem_we 1 1 }  { outp_V_d0 mem_din 1 24 } } }
}

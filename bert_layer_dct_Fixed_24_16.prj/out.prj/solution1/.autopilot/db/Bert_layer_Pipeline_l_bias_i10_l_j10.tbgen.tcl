...
set C_modelArgList {
	{ v264_V int 24 regular {array 9216 { 0 1 } 1 1 }  }
	{ v250 int 24 regular {array 768 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v264_V", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ v264_V_address1 sc_out sc_lv 14 signal 0 } 
	{ v264_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ v264_V_q1 sc_in sc_lv 24 signal 0 } 
	{ v250_address0 sc_out sc_lv 10 signal 1 } 
	{ v250_ce0 sc_out sc_logic 1 signal 1 } 
	{ v250_q0 sc_in sc_lv 24 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v264_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v264_V", "role": "address1" }} , 
 	{ "name": "v264_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v264_V", "role": "ce1" }} , 
 	{ "name": "v264_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "v264_V", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	v264_V { ap_memory {  { v264_V_address0 mem_address 1 14 }  { v264_V_ce0 mem_ce 1 1 }  { v264_V_we0 mem_we 1 1 }  { v264_V_d0 mem_din 1 24 }  { v264_V_address1 MemPortADDR2 1 14 }  { v264_V_ce1 MemPortCE2 1 1 }  { v264_V_q1 in_data 0 24 } } }
	v250 { ap_memory {  { v250_address0 mem_address 1 10 }  { v250_ce0 mem_ce 1 1 }  { v250_q0 in_data 0 24 } } }
}

...
// ==============================================================
#ifndef __Bert_layer_fsqrt_bak__HH__
#define __Bert_layer_fsqrt_bak__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fsqrt_bak) {
    ...
    SC_CTOR(Bert_layer_fsqrt_bak):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {

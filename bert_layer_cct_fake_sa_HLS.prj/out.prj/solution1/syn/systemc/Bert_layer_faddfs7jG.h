...
// ==============================================================
#ifndef __Bert_layer_faddfs7jG__HH__
#define __Bert_layer_faddfs7jG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfs7jG) {
    ...
    SC_CTOR(Bert_layer_faddfs7jG):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

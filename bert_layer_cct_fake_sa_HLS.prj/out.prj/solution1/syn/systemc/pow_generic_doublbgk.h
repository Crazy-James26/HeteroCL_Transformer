...
// ==============================================================
#ifndef __pow_generic_doublbgk_H__
#define __pow_generic_doublbgk_H__
...
struct pow_generic_doublbgk_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doublbgk_ram) {
...
SC_MODULE(pow_generic_doublbgk) {
...
pow_generic_doublbgk_ram* meminst;


SC_CTOR(pow_generic_doublbgk) {
meminst = new pow_generic_doublbgk_ram("pow_generic_doublbgk_ram");

...
// ==============================================================
#ifndef __Bert_layer_mul_55bAo__HH__
#define __Bert_layer_mul_55bAo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_55bAo) {
    ...
    SC_CTOR(Bert_layer_mul_55bAo):  ACMP_mul_us_U ("ACMP_mul_us_U") {

...
#include "Bert_layer_mul_54bqm.h"
#include "Bert_layer_mul_71brm.h"
#include "Bert_layer_mul_73bsm.h"
#include "Bert_layer_mul_83btn.h"
#include "Bert_layer_mul_92bun.h"
#include "Bert_layer_mul_87bvn.h"
#include "Bert_layer_mul_82bwn.h"
#include "Bert_layer_mul_77bxn.h"
#include "Bert_layer_mul_80byn.h"
#include "Bert_layer_mul_54bzo.h"
#include "Bert_layer_mul_55bAo.h"
#include "Bert_layer_mul_72bBo.h"
#include "Bert_layer_mul_43bCo.h"
#include "Bert_layer_mul_49bDo.h"
#include "Bert_layer_mul_50bEo.h"
#include "Bert_layer_mac_mubFp.h"
#include "pow_generic_doublbek.h"
#include "pow_generic_doublbfk.h"
#include "pow_generic_doublbgk.h"
#include "pow_generic_doublbhl.h"
#include "pow_generic_doublbil.h"
#include "pow_generic_doublbjl.h"
#include "pow_generic_doublbkl.h"
#include "pow_generic_doublbll.h"
#include "pow_generic_doublbml.h"
...
struct pow_generic_double_s : public sc_module {
    ...
    pow_generic_doublbek* pow_reduce_anonymo_20_U;
    pow_generic_doublbfk* pow_reduce_anonymo_19_U;
    pow_generic_doublbgk* pow_reduce_anonymo_16_U;
    pow_generic_doublbhl* pow_reduce_anonymo_17_U;
    pow_generic_doublbil* pow_reduce_anonymo_9_U;
    pow_generic_doublbjl* pow_reduce_anonymo_12_U;
    pow_generic_doublbkl* pow_reduce_anonymo_13_U;
    pow_generic_doublbll* pow_reduce_anonymo_14_U;
    pow_generic_doublbml* pow_reduce_anonymo_15_U;
    pow_generic_doublbnm* pow_reduce_anonymo_18_U;
    pow_generic_doublbom* pow_reduce_anonymo_U;
    pow_generic_doublbpm* pow_reduce_anonymo_21_U;
    Bert_layer_mul_54bqm<1,2,54,6,54>* Bert_layer_mul_54bqm_U1238;
    Bert_layer_mul_71brm<1,5,71,4,75>* Bert_layer_mul_71brm_U1239;
    Bert_layer_mul_73bsm<1,5,73,6,79>* Bert_layer_mul_73bsm_U1240;
    Bert_layer_mul_83btn<1,5,83,6,89>* Bert_layer_mul_83btn_U1241;
    Bert_layer_mul_92bun<1,5,92,6,98>* Bert_layer_mul_92bun_U1242;
    Bert_layer_mul_87bvn<1,5,87,6,93>* Bert_layer_mul_87bvn_U1243;
    Bert_layer_mul_82bwn<1,5,82,6,88>* Bert_layer_mul_82bwn_U1244;
    Bert_layer_mul_77bxn<1,5,77,6,83>* Bert_layer_mul_77bxn_U1245;
    Bert_layer_mul_80byn<1,5,80,12,90>* Bert_layer_mul_80byn_U1246;
    Bert_layer_mul_54bzo<1,5,54,78,131>* Bert_layer_mul_54bzo_U1247;
    Bert_layer_mul_55bAo<1,5,55,78,130>* Bert_layer_mul_55bAo_U1248;
    Bert_layer_mul_72bBo<1,5,72,13,83>* Bert_layer_mul_72bBo_U1249;
    Bert_layer_mul_43bCo<1,2,43,36,79>* Bert_layer_mul_43bCo_U1250;
    Bert_layer_mul_49bDo<1,2,49,44,93>* Bert_layer_mul_49bDo_U1251;
    Bert_layer_mul_50bEo<1,2,50,50,100>* Bert_layer_mul_50bEo_U1252;
    Bert_layer_mac_mubFp<1,1,16,16,19,31>* Bert_layer_mac_mubFp_U1253;

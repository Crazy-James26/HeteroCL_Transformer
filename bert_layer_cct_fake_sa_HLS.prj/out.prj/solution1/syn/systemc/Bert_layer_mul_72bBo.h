...
// ==============================================================
#ifndef __Bert_layer_mul_72bBo__HH__
#define __Bert_layer_mul_72bBo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_72bBo) {
    ...
    SC_CTOR(Bert_layer_mul_72bBo):  ACMP_mul_us_U ("ACMP_mul_us_U") {

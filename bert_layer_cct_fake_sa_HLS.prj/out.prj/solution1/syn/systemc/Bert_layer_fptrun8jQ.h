...
// ==============================================================
#ifndef __Bert_layer_fptrun8jQ__HH__
#define __Bert_layer_fptrun8jQ__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fptrun8jQ) {
    ...
    SC_CTOR(Bert_layer_fptrun8jQ):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

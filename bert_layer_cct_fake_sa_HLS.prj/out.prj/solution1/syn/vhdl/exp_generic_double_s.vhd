...
architecture behav of exp_generic_double_s is 
    ...
    component Bert_layer_mul_72bJp IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_36bKp IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_44bLp IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    table_exp_Z1_array_s_U : component pow_generic_doublbnm
    generic map (
        DataWidth => 58,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z3_array_V_U : component pow_generic_doublbom
    generic map (
        DataWidth => 26,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z2_array_V_U : component pow_generic_doublbpm
    generic map (
        DataWidth => 42,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    Bert_layer_mul_72bJp_U1283 : component Bert_layer_mul_72bJp
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 72,
    ...
    Bert_layer_mul_36bKp_U1284 : component Bert_layer_mul_36bKp
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 36,
    ...
    Bert_layer_mul_44bLp_U1285 : component Bert_layer_mul_44bLp
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 44,
    ...
    Bert_layer_mul_50bEo_U1286 : component Bert_layer_mul_50bEo
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    Bert_layer_mac_mubFp_U1287 : component Bert_layer_mac_mubFp
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,

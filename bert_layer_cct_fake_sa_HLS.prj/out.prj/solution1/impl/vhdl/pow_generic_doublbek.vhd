...
entity pow_generic_doublbek_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_doublbek_rom is 
...
entity pow_generic_doublbek is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of pow_generic_doublbek is
    component pow_generic_doublbek_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_doublbek_rom_U :  component pow_generic_doublbek_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

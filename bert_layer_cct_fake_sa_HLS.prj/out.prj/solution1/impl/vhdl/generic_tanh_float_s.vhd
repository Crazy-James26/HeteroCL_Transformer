...
architecture behav of generic_tanh_float_s is 
    ...
    component Bert_layer_fsub_3bMq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_fcmp_3bNq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Bert_layer_fadd_3bkb_U1292 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3bMq_U1293 : component Bert_layer_fsub_3bMq
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fadd_3bkb_U1294 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3bMq_U1296 : component Bert_layer_fsub_3bMq
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U1297 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    Bert_layer_fdiv_3hbi_U1298 : component Bert_layer_fdiv_3hbi
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    Bert_layer_fptrun8jQ_U1299 : component Bert_layer_fptrun8jQ
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    Bert_layer_fpext_9j0_U1300 : component Bert_layer_fpext_9j0
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_fcmp_3bNq_U1301 : component Bert_layer_fcmp_3bNq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_dadd_6bbk_U1302 : component Bert_layer_dadd_6bbk
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,

...
entity Bert_layer_mux_1212_24_1_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of Bert_layer_mux_1212_24_1_1 is
    ...
    signal mux_1_4    : std_logic_vector(23 downto 0);
    signal mux_1_5    : std_logic_vector(23 downto 0);
    -- level 2 signals
    ...
    -- level 5 signals
    signal mux_5_0    : std_logic_vector(23 downto 0);
    -- level 6 signals
    signal mux_6_0    : std_logic_vector(23 downto 0);
    -- level 7 signals
    signal mux_7_0    : std_logic_vector(23 downto 0);
    -- level 8 signals
    signal mux_8_0    : std_logic_vector(23 downto 0);
    -- level 9 signals
    signal mux_9_0    : std_logic_vector(23 downto 0);
    -- level 10 signals
    signal mux_10_0    : std_logic_vector(23 downto 0);
    -- level 11 signals
    signal mux_11_0    : std_logic_vector(23 downto 0);
    -- level 12 signals
    signal mux_12_0    : std_logic_vector(23 downto 0);
begin

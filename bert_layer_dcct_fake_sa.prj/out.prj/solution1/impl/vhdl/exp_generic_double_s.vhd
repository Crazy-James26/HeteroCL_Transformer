...
architecture behav of exp_generic_double_s is 
    ...
    component Bert_layer_mul_72dnG IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_36doG IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_44dpG IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_50diF IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mac_mudjF IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component pow_generic_doublc1C IS
    generic (
        DataWidth : INTEGER;
    ...
    component pow_generic_doublc2C IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component pow_generic_doublc3C IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    table_exp_Z1_array_s_U : component pow_generic_doublc1C
    generic map (
        DataWidth => 58,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z3_array_V_U : component pow_generic_doublc2C
    generic map (
        DataWidth => 26,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z2_array_V_U : component pow_generic_doublc3C
    generic map (
        DataWidth => 42,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    Bert_layer_mul_72dnG_U1233 : component Bert_layer_mul_72dnG
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 72,
    ...
    Bert_layer_mul_36doG_U1234 : component Bert_layer_mul_36doG
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 36,
    ...
    Bert_layer_mul_44dpG_U1235 : component Bert_layer_mul_44dpG
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 44,
    ...
    Bert_layer_mul_50diF_U1236 : component Bert_layer_mul_50diF
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    Bert_layer_mac_mudjF_U1237 : component Bert_layer_mac_mudjF
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,

...
// ==============================================================
#ifndef __Bert_layer_faddfsrcU__HH__
#define __Bert_layer_faddfsrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfsrcU) {
    ...
    SC_CTOR(Bert_layer_faddfsrcU):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

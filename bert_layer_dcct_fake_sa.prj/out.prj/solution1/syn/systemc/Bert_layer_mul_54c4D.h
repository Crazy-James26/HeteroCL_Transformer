...
// ==============================================================
#ifndef __Bert_layer_mul_54c4D__HH__
#define __Bert_layer_mul_54c4D__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_54c4D) {
    ...
    SC_CTOR(Bert_layer_mul_54c4D):  ACMP_mul_su_U ("ACMP_mul_su_U") {

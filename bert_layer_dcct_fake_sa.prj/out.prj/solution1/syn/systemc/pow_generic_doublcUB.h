...
// ==============================================================
#ifndef __pow_generic_doublcUB_H__
#define __pow_generic_doublcUB_H__
...
struct pow_generic_doublcUB_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doublcUB_ram) {
...
SC_MODULE(pow_generic_doublcUB) {
...
pow_generic_doublcUB_ram* meminst;


SC_CTOR(pow_generic_doublcUB) {
meminst = new pow_generic_doublcUB_ram("pow_generic_doublcUB_ram");

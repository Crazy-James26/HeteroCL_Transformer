...
// ==============================================================
#ifndef __Bert_layer_fptrunsc4__HH__
#define __Bert_layer_fptrunsc4__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fptrunsc4) {
    ...
    SC_CTOR(Bert_layer_fptrunsc4):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

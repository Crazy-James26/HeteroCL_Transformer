...
// ==============================================================
#ifndef __Bert_layer_mul_mucRA__HH__
#define __Bert_layer_mul_mucRA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_mucRA) {
    ...
    SC_CTOR(Bert_layer_mul_mucRA):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
// ==============================================================
#ifndef __Bert_layer_fsqrt_tde__HH__
#define __Bert_layer_fsqrt_tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fsqrt_tde) {
    ...
    SC_CTOR(Bert_layer_fsqrt_tde):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {

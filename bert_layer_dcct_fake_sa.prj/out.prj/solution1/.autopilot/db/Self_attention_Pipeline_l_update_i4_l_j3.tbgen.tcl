...
set C_modelArgList {
	...
	{ v100 float 32 regular {array 144 { 1 3 } 1 1 }  }
	{ v101_V int 24 regular {array 72 { 0 3 } 0 1 }  }
	{ v101_V_1 int 24 regular {array 72 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ v100_address0 sc_out sc_lv 8 signal 1 } 
	{ v100_ce0 sc_out sc_logic 1 signal 1 } 
	{ v100_q0 sc_in sc_lv 32 signal 1 } 
	{ v101_V_address0 sc_out sc_lv 7 signal 2 } 
	{ v101_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ v101_V_we0 sc_out sc_logic 1 signal 2 } 
	{ v101_V_d0 sc_out sc_lv 24 signal 2 } 
	{ v101_V_1_address0 sc_out sc_lv 7 signal 3 } 
	{ v101_V_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ v101_V_1_we0 sc_out sc_logic 1 signal 3 } 
	{ v101_V_1_d0 sc_out sc_lv 24 signal 3 } 
	...
	{ grp_fu_2239_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v101_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "v101_V", "role": "address0" }} , 
 	...
 	{ "name": "v101_V_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "v101_V_1", "role": "address0" }} , 
 	...
 	{ "name": "grp_fu_2239_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_2239_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	v100 { ap_memory {  { v100_address0 mem_address 1 8 }  { v100_ce0 mem_ce 1 1 }  { v100_q0 mem_dout 0 32 } } }
	v101_V { ap_memory {  { v101_V_address0 mem_address 1 7 }  { v101_V_ce0 mem_ce 1 1 }  { v101_V_we0 mem_we 1 1 }  { v101_V_d0 mem_din 1 24 } } }
	v101_V_1 { ap_memory {  { v101_V_1_address0 mem_address 1 7 }  { v101_V_1_ce0 mem_ce 1 1 }  { v101_V_1_we0 mem_we 1 1 }  { v101_V_1_d0 mem_din 1 24 } } }
}

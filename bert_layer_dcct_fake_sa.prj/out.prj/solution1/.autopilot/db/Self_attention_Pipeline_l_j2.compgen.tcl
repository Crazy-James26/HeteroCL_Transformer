...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v100 \
    op interface \
    ports { v100_address0 { O 8 vector } v100_ce0 { O 1 bit } v100_we0 { O 1 bit } v100_d0 { O 32 vector } v100_address1 { O 8 vector } v100_ce1 { O 1 bit } v100_q1 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_ln113 \
    op interface \
    ports { sub_ln113 { I 8 vector } } \
} "
}

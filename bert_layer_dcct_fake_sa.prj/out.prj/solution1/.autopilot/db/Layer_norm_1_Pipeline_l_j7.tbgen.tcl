...
set C_modelArgMapList {[ 
	{ "Name" : "v264_0", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sub_ln328", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub_ln328 sc_in sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln328", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln328", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sub_ln328 { ap_none {  { sub_ln328 in_data 0 14 } } }

...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_VITIS_LOOP_291_1_fu_145", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "Layer_norm_Pipeline_VITIS_LOOP_291_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_291_1", "PipelineType" : "NotSupport"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_VITIS_LOOP_291_1_fu_145.flow_control_loop_pipe_sequential_init_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_VITIS_LOOP_295_2_fu_151", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "Layer_norm_Pipeline_VITIS_LOOP_295_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_295_2", "PipelineType" : "NotSupport"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_VITIS_LOOP_295_2_fu_151.flow_control_loop_pipe_sequential_init_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_l_j6_fu_157", "Parent" : "0", "Child" : ["9"],
		...
		"Port" : [
			...
			{"Name" : "mean2", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "mean", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "sub_ln302", "Type" : "None", "Direction" : "I"},
			{"Name" : "v137", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
	...
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Layer_norm_Pipeline_l_j7_fu_170", "Parent" : "0", "Child" : ["11"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "sub_ln328", "Type" : "None", "Direction" : "I"},
			{"Name" : "v137", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "v260", "Type" : "Memory", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	...
	Layer_norm_Pipeline_l_j6 {
		...
		sub_ln302 {Type I LastRead 0 FirstWrite -1}
		v137 {Type I LastRead 0 FirstWrite -1}}
	Layer_norm_Pipeline_l_j7 {
		sub_ln328 {Type I LastRead 0 FirstWrite -1}
		v137 {Type I LastRead 0 FirstWrite -1}
		v260 {Type I LastRead 5 FirstWrite -1}

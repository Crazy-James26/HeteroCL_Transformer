...
set C_modelArgList {
	...
	{ zext_ln110 int 4 regular  }
	{ sub_ln113 int 8 regular  }
	{ v100 float 32 regular {array 144 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "inp_sumRow_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln110", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln113", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln110 sc_in sc_lv 4 signal 2 } 
	{ sub_ln113 sc_in sc_lv 8 signal 3 } 
	{ v100_address0 sc_out sc_lv 8 signal 4 } 
	{ v100_ce0 sc_out sc_logic 1 signal 4 } 
	{ v100_we0 sc_out sc_logic 1 signal 4 } 
	{ v100_d0 sc_out sc_lv 32 signal 4 } 
	{ v100_address1 sc_out sc_lv 8 signal 4 } 
	{ v100_ce1 sc_out sc_logic 1 signal 4 } 
	{ v100_q1 sc_in sc_lv 32 signal 4 } 
	{ grp_fu_2231_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_2231_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_2231_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln110", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln110", "role": "default" }} , 
 	{ "name": "sub_ln113", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sub_ln113", "role": "default" }} , 
 	{ "name": "v100_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "v100", "role": "address0" }} , 
 	...
 	{ "name": "v100_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "v100", "role": "address1" }} , 
 	...
 	{ "name": "grp_fu_2231_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_2231_p_opcode", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "sub_ln113", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_10_full_dsp_1_U1362", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	Self_attention_Pipeline_l_j2 {
		...
		sub_ln113 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	zext_ln110 { ap_none {  { zext_ln110 in_data 0 4 } } }
	sub_ln113 { ap_none {  { sub_ln113 in_data 0 8 } } }
	v100 { ap_memory {  { v100_address0 mem_address 1 8 }  { v100_ce0 mem_ce 1 1 }  { v100_we0 mem_we 1 1 }  { v100_d0 mem_din 1 32 }  { v100_address1 MemPortADDR2 1 8 }  { v100_ce1 MemPortCE2 1 1 }  { v100_q1 MemPortDOUT2 0 32 } } }
}

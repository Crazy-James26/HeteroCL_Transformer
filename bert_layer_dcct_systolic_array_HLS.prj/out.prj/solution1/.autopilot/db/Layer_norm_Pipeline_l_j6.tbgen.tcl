...
set C_modelArgMapList {[ 
	{ "Name" : "mean2_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln235", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "mean2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mean", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sub_ln238", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln235 sc_in sc_lv 4 signal 3 } 
	...
	{ sub_ln238 sc_in sc_lv 14 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln235", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln235", "role": "default" }} , 
 	...
 	{ "name": "sub_ln238", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln238", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln235 { ap_none {  { zext_ln235 in_data 0 4 } } }
	...
	sub_ln238 { ap_none {  { sub_ln238 in_data 0 14 } } }

...
set C_modelArgMapList {[ 
	{ "Name" : "C_3", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "sub_ln859", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sub_ln859 sc_in sc_lv 6 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln859", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "sub_ln859", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	C_3 { ap_memory {  { C_3_address0 mem_address 1 6 }  { C_3_ce0 mem_ce 1 1 }  { C_3_we0 mem_we 1 1 }  { C_3_d0 mem_din 1 24 }  { C_3_address1 MemPortADDR2 1 6 }  { C_3_ce1 MemPortCE2 1 1 }  { C_3_q1 in_data 0 24 } } }
	...
	sub_ln859 { ap_none {  { sub_ln859 in_data 0 6 } } }
}

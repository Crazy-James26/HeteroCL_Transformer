...
set C_modelArgList {
	...
	{ zext_ln80 int 4 regular  }
	{ sub_ln83 int 6 regular  }
	{ v100 float 32 regular {array 36 { 0 1 } 1 1 }  }
	{ v100_1 float 32 regular {array 36 { 0 1 } 1 1 }  }
	{ v100_2 float 32 regular {array 36 { 0 1 } 1 1 }  }
	{ v100_3 float 32 regular {array 36 { 0 1 } 1 1 }  }
	{ trunc_ln14 int 2 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "inp_sumRow_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln80", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln83", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "trunc_ln14", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln80 sc_in sc_lv 4 signal 2 } 
	{ sub_ln83 sc_in sc_lv 6 signal 3 } 
	...
	{ v100_address1 sc_out sc_lv 6 signal 4 } 
	...
	{ v100_1_address1 sc_out sc_lv 6 signal 5 } 
	{ v100_1_ce1 sc_out sc_logic 1 signal 5 } 
	{ v100_1_q1 sc_in sc_lv 32 signal 5 } 
	...
	{ v100_2_address1 sc_out sc_lv 6 signal 6 } 
	{ v100_2_ce1 sc_out sc_logic 1 signal 6 } 
	{ v100_2_q1 sc_in sc_lv 32 signal 6 } 
	...
	{ v100_3_address1 sc_out sc_lv 6 signal 7 } 
	{ v100_3_ce1 sc_out sc_logic 1 signal 7 } 
	{ v100_3_q1 sc_in sc_lv 32 signal 7 } 
	{ trunc_ln14 sc_in sc_lv 2 signal 8 } 
	{ grp_fu_657_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_657_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_657_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln80", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln80", "role": "default" }} , 
 	{ "name": "sub_ln83", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "sub_ln83", "role": "default" }} , 
 	...
 	{ "name": "v100_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v100", "role": "address1" }} , 
 	...
 	{ "name": "v100_1_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v100_1", "role": "address1" }} , 
 	...
 	{ "name": "v100_2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v100_2", "role": "address1" }} , 
 	...
 	{ "name": "v100_3_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v100_3", "role": "address1" }} , 
 	...
 	{ "name": "trunc_ln14", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "trunc_ln14", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_657_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_657_p_opcode", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_10_full_dsp_1_U2682", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_32_1_1_U2683", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln80 { ap_none {  { zext_ln80 in_data 0 4 } } }
	sub_ln83 { ap_none {  { sub_ln83 in_data 0 6 } } }
	v100 { ap_memory {  { v100_address0 mem_address 1 6 }  { v100_ce0 mem_ce 1 1 }  { v100_we0 mem_we 1 1 }  { v100_d0 mem_din 1 32 }  { v100_address1 MemPortADDR2 1 6 }  { v100_ce1 MemPortCE2 1 1 }  { v100_q1 in_data 0 32 } } }
	v100_1 { ap_memory {  { v100_1_address0 mem_address 1 6 }  { v100_1_ce0 mem_ce 1 1 }  { v100_1_we0 mem_we 1 1 }  { v100_1_d0 mem_din 1 32 }  { v100_1_address1 MemPortADDR2 1 6 }  { v100_1_ce1 MemPortCE2 1 1 }  { v100_1_q1 in_data 0 32 } } }
	v100_2 { ap_memory {  { v100_2_address0 mem_address 1 6 }  { v100_2_ce0 mem_ce 1 1 }  { v100_2_we0 mem_we 1 1 }  { v100_2_d0 mem_din 1 32 }  { v100_2_address1 MemPortADDR2 1 6 }  { v100_2_ce1 MemPortCE2 1 1 }  { v100_2_q1 in_data 0 32 } } }
	v100_3 { ap_memory {  { v100_3_address0 mem_address 1 6 }  { v100_3_ce0 mem_ce 1 1 }  { v100_3_we0 mem_we 1 1 }  { v100_3_d0 mem_din 1 32 }  { v100_3_address1 MemPortADDR2 1 6 }  { v100_3_ce1 MemPortCE2 1 1 }  { v100_3_q1 in_data 0 32 } } }
	trunc_ln14 { ap_none {  { trunc_ln14 in_data 0 2 } } }
}

set moduleName VITIS_LOOP_132_4_proc31
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {VITIS_LOOP_132_4_proc31}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_1 int 24 regular {array 192 { 0 1 } 1 1 }  }
	{ block_C_drainer_110 int 24 regular {fifo 0 volatile }  }
	{ jj int 4 regular {fifo 0}  }
	{ ii int 2 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_1", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "block_C_drainer_110", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ C_1_address0 sc_out sc_lv 8 signal 0 } 
	{ C_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ C_1_we0 sc_out sc_logic 1 signal 0 } 
	{ C_1_d0 sc_out sc_lv 24 signal 0 } 
	{ C_1_address1 sc_out sc_lv 8 signal 0 } 
	{ C_1_ce1 sc_out sc_logic 1 signal 0 } 
	{ C_1_q1 sc_in sc_lv 24 signal 0 } 
	{ block_C_drainer_110_dout sc_in sc_lv 24 signal 1 } 
	{ block_C_drainer_110_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ block_C_drainer_110_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ block_C_drainer_110_empty_n sc_in sc_logic 1 signal 1 } 
	{ block_C_drainer_110_read sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_drainer_110_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "block_C_drainer_110", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "C_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_132_4_proc31_Pipeline_VITIS_LOOP_132_4_fu_52", "Port" : "C_1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "block_C_drainer_110", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_132_4_proc31_Pipeline_VITIS_LOOP_132_4_fu_52", "Port" : "block_C_drainer_110", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_132_4_proc31_Pipeline_VITIS_LOOP_132_4_fu_52", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_132_4_proc31_Pipeline_VITIS_LOOP_132_4_fu_52.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	C_1 { ap_memory {  { C_1_address0 mem_address 1 8 }  { C_1_ce0 mem_ce 1 1 }  { C_1_we0 mem_we 1 1 }  { C_1_d0 mem_din 1 24 }  { C_1_address1 MemPortADDR2 1 8 }  { C_1_ce1 MemPortCE2 1 1 }  { C_1_q1 MemPortDOUT2 0 24 } } }
	block_C_drainer_110 { ap_fifo {  { block_C_drainer_110_dout fifo_port_we 0 24 }  { block_C_drainer_110_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_110_fifo_cap fifo_update 0 2 }  { block_C_drainer_110_empty_n fifo_status 0 1 }  { block_C_drainer_110_read fifo_data 1 1 } } }

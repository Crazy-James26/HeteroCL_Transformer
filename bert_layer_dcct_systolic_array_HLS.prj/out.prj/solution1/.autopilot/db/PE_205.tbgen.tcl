...
set hasInterrupt 0
set C_modelName {PE.205}
set C_modelType { int 24 }
set C_modelArgList {
	{ A_fifo_4_10 int 24 regular {fifo 0 volatile }  }
	{ A_fifo_4_11 int 24 regular {fifo 1 volatile }  }
	{ B_fifo_10_4 int 24 regular {fifo 0 volatile }  }
	{ B_fifo_10_5 int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_fifo_4_10", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "A_fifo_4_11", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_fifo_10_4", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "B_fifo_10_5", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ A_fifo_4_10_dout sc_in sc_lv 24 signal 0 } 
	...
	{ B_fifo_10_4_dout sc_in sc_lv 24 signal 2 } 
	...
	{ A_fifo_4_11_din sc_out sc_lv 24 signal 1 } 
	...
	{ B_fifo_10_5_din sc_out sc_lv 24 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_fifo_4_10_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "A_fifo_4_10", "role": "dout" }} , 
 	...
 	{ "name": "B_fifo_10_4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "B_fifo_10_4", "role": "dout" }} , 
 	...
 	{ "name": "A_fifo_4_11_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "A_fifo_4_11", "role": "din" }} , 
 	...
 	{ "name": "B_fifo_10_5_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "B_fifo_10_5", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_24s_24s_40_1_1_U3629", "Parent" : "0"},
...
set Spec2ImplPortList { 
	A_fifo_4_10 { ap_fifo {  { A_fifo_4_10_dout fifo_port_we 0 24 }  { A_fifo_4_10_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_4_10_fifo_cap fifo_update 0 2 }  { A_fifo_4_10_empty_n fifo_status 0 1 }  { A_fifo_4_10_read fifo_data 1 1 } } }
	A_fifo_4_11 { ap_fifo {  { A_fifo_4_11_din fifo_port_we 1 24 }  { A_fifo_4_11_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_4_11_fifo_cap fifo_update 0 2 }  { A_fifo_4_11_full_n fifo_status 0 1 }  { A_fifo_4_11_write fifo_data 1 1 } } }
	B_fifo_10_4 { ap_fifo {  { B_fifo_10_4_dout fifo_port_we 0 24 }  { B_fifo_10_4_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_10_4_fifo_cap fifo_update 0 2 }  { B_fifo_10_4_empty_n fifo_status 0 1 }  { B_fifo_10_4_read fifo_data 1 1 } } }
	B_fifo_10_5 { ap_fifo {  { B_fifo_10_5_din fifo_port_we 1 24 }  { B_fifo_10_5_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_10_5_fifo_cap fifo_update 0 2 }  { B_fifo_10_5_full_n fifo_status 0 1 }  { B_fifo_10_5_write fifo_data 1 1 } } }
}

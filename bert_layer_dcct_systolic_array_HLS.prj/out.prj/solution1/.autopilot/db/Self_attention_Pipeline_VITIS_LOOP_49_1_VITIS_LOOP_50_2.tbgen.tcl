set moduleName Self_attention_Pipeline_VITIS_LOOP_49_1_VITIS_LOOP_50_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Self_attention_Pipeline_VITIS_LOOP_49_1_VITIS_LOOP_50_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ outp_V int 24 regular {array 36 { 0 3 } 0 1 }  }
	{ outp_V_1 int 24 regular {array 36 { 0 3 } 0 1 }  }
	{ outp_V_2 int 24 regular {array 36 { 0 3 } 0 1 }  }
	{ outp_V_3 int 24 regular {array 36 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	outp_V { ap_memory {  { outp_V_address0 mem_address 1 6 }  { outp_V_ce0 mem_ce 1 1 }  { outp_V_we0 mem_we 1 1 }  { outp_V_d0 mem_din 1 24 } } }
	outp_V_1 { ap_memory {  { outp_V_1_address0 mem_address 1 6 }  { outp_V_1_ce0 mem_ce 1 1 }  { outp_V_1_we0 mem_we 1 1 }  { outp_V_1_d0 mem_din 1 24 } } }
	outp_V_2 { ap_memory {  { outp_V_2_address0 mem_address 1 6 }  { outp_V_2_ce0 mem_ce 1 1 }  { outp_V_2_we0 mem_we 1 1 }  { outp_V_2_d0 mem_din 1 24 } } }
	outp_V_3 { ap_memory {  { outp_V_3_address0 mem_address 1 6 }  { outp_V_3_ce0 mem_ce 1 1 }  { outp_V_3_we0 mem_we 1 1 }  { outp_V_3_d0 mem_din 1 24 } } }
}

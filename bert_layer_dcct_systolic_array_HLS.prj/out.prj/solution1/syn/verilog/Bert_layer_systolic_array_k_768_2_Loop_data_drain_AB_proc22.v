...
module Bert_layer_systolic_array_k_768_2_Loop_data_drain_AB_proc22 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [9:0] k_fu_78;
wire   [9:0] k_11_fu_240_p2;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_11001;
reg   [9:0] ap_sig_allocacmp_k_10;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_285)) begin
        if ((icmp_ln49_fu_234_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln49_fu_234_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign icmp_ln49_fu_234_p2 = ((ap_sig_allocacmp_k_10 == 10'd768) ? 1'b1 : 1'b0);

assign k_11_fu_240_p2 = (ap_sig_allocacmp_k_10 + 10'd1);

endmodule //Bert_layer_systolic_array_k_768_2_Loop_data_drain_AB_proc22

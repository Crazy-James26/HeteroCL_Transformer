...
set ID 3357
set hasByteEnable 0
set MemName Bert_layer_Linear_layer_ds1_outp1_0_V
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename v180 \
    op interface \
    ports { v180_address0 { O 16 vector } v180_ce0 { O 1 bit } v180_we0 { O 1 bit } v180_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'v180'"
}
}

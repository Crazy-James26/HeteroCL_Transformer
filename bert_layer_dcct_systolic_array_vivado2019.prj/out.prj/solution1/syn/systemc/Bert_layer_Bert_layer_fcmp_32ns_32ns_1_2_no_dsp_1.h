...
// ==============================================================
#ifndef __Bert_layer_Bert_layer_fcmp_32ns_32ns_1_2_no_dsp_1__HH__
#define __Bert_layer_Bert_layer_fcmp_32ns_32ns_1_2_no_dsp_1__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_Bert_layer_fcmp_32ns_32ns_1_2_no_dsp_1) {
    ...
    SC_CTOR(Bert_layer_Bert_layer_fcmp_32ns_32ns_1_2_no_dsp_1):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

...
def generate_random_W(prj_path, inp_num):
...
# generate_random_s("bert_layer_dcct_int8_pack_dataflow_sa_vitis6.prj", 512)
generate_random_W("bert_layer_dcct_int8_pack_dataflow_sa_vitis6_constw.prj", 16)

...
reg   [23:0] ap_sig_allocacmp_C_out_out_0_load_515;
...
Bert_layer_mac_muladd_8s_4s_24s_24_4_1 #(
    ...
    .din2_WIDTH( 24 ),
    .dout_WIDTH( 24 ))
mac_muladd_8s_4s_24s_24_4_1_U5998(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        ap_sig_allocacmp_C_out_out_0_load_515 = grp_fu_123_p3;
    end else begin
        ap_sig_allocacmp_C_out_out_0_load_515 = C_out_out_0_fu_48;
    end
end
...
assign k_544_fu_94_p2 = (ap_sig_allocacmp_k + 10'd1);

assign start_out = real_start;

endmodule //Bert_layer_PE_8_4_183

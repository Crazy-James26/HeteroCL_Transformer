...
attribute shreg_extract : string;
    ...
    signal tmp_45_i_fu_236_p6 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_45_i_reg_298 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_46_i_fu_250_p6 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_46_i_reg_303 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_47_i_fu_264_p6 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_47_i_reg_308 : STD_LOGIC_VECTOR (23 downto 0);
    signal n_fu_74 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln175_fu_216_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    mux_43_24_1_1_U2536 : component Bert_layer_mux_43_24_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 24,
    ...
    mux_43_24_1_1_U2537 : component Bert_layer_mux_43_24_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 24,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_133)) then
                if ((icmp_ln175_fu_210_p2 = ap_const_lv1_0)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln175_fu_210_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln175_fu_216_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n_4) + unsigned(ap_const_lv3_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln175_fu_210_p2, ap_start_int)
    begin
        if (((icmp_ln175_fu_210_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    block_C_drainer_1_din <= tmp_45_i_reg_298;
    ...
    block_C_drainer_2_din <= tmp_46_i_reg_303;
    ...
    block_C_drainer_3_din <= tmp_47_i_reg_308;
    ...
    icmp_ln175_fu_210_p2 <= "1" when (ap_sig_allocacmp_n_4 = ap_const_lv3_4) else "0";
end behav;

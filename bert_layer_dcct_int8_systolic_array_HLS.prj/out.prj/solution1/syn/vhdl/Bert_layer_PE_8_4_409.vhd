...
entity Bert_layer_PE_8_4_409 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_PE_8_4_409 is 
...
attribute shreg_extract : string;
    ...
    signal k_295_fu_94_p2 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal ap_sig_allocacmp_C_out_out_0_load_266 : STD_LOGIC_VECTOR (23 downto 0);
...
begin
    mac_muladd_8s_4s_24s_24_4_1_U8753 : component Bert_layer_mac_muladd_8s_4s_24s_24_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    ap_return_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln7_reg_146_pp0_iter2_reg, ap_sig_allocacmp_C_out_out_0_load_266, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln7_reg_146_pp0_iter2_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_C_out_out_0_load_266_assign_proc : process(ap_enable_reg_pp0_iter4, ap_block_pp0_stage0, C_out_out_0_fu_48, grp_fu_123_p3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter4 = ap_const_logic_1))) then 
    ...
    k_295_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k) + unsigned(ap_const_lv12_1));

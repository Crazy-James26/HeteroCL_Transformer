...
entity Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc24 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc24 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln114_fu_236_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal k_fu_80 : STD_LOGIC_VECTOR (11 downto 0);
    signal k_19_fu_242_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_285)) then
                if ((icmp_ln114_fu_236_p2 = ap_const_lv1_0)) then 
                    k_fu_80 <= k_19_fu_242_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    k_fu_80 <= ap_const_lv12_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln114_fu_236_p2, ap_start_int)
    begin
        if (((icmp_ln114_fu_236_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_k_18_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, k_fu_80, ap_loop_init, ap_start_int)
    begin
    ...
    icmp_ln114_fu_236_p2 <= "1" when (ap_sig_allocacmp_k_18 = ap_const_lv12_C00) else "0";
    k_19_fu_242_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_18) + unsigned(ap_const_lv12_1));
end behav;

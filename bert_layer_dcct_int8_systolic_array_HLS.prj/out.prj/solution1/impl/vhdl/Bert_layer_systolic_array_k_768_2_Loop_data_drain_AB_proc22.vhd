...
attribute shreg_extract : string;
    ...
    signal k_11_fu_242_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    ap_sig_allocacmp_k_10_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, k_fu_80, ap_loop_init, ap_start_int)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ...
            ap_sig_allocacmp_k_10 <= k_fu_80;
        end if; 
    end process;

    icmp_ln63_fu_236_p2 <= "1" when (ap_sig_allocacmp_k_10 = ap_const_lv10_300) else "0";
    k_11_fu_242_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k_10) + unsigned(ap_const_lv10_1));
end behav;

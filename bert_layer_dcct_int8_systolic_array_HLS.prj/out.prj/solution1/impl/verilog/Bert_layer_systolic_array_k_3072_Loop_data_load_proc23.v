...
module Bert_layer_systolic_array_k_3072_Loop_data_load_proc23 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
input  [3:0] block_B_loader_0_dout;
...
input  [3:0] block_B_loader_1_dout;
...
input  [3:0] block_B_loader_2_dout;
...
input  [3:0] block_B_loader_3_dout;
...
input  [3:0] block_B_loader_4_dout;
...
input  [3:0] block_B_loader_5_dout;
...
input  [3:0] block_B_loader_6_dout;
...
input  [3:0] block_B_loader_7_dout;
...
input  [3:0] block_B_loader_8_dout;
...
input  [3:0] block_B_loader_9_dout;
...
input  [3:0] block_B_loader_10_dout;
...
input  [3:0] block_B_loader_11_dout;
...
reg   [7:0] tmp_41_reg_488;
reg   [7:0] tmp_42_reg_493;
reg   [7:0] tmp_43_reg_498;
reg   [7:0] tmp_44_reg_503;
reg   [7:0] tmp_45_reg_508;
reg   [7:0] tmp_46_reg_513;
reg   [7:0] tmp_47_reg_518;
reg   [7:0] tmp_48_reg_523;
reg   [7:0] tmp_49_reg_528;
reg   [7:0] tmp_50_reg_533;
reg   [7:0] tmp_51_reg_538;
reg   [3:0] block_B_loader_0_read_reg_543;
reg   [3:0] block_B_loader_1_read_reg_548;
reg   [3:0] block_B_loader_2_read_reg_553;
reg   [3:0] block_B_loader_3_read_reg_558;
reg   [3:0] block_B_loader_4_read_reg_563;
reg   [3:0] block_B_loader_5_read_reg_568;
reg   [3:0] block_B_loader_6_read_reg_573;
reg   [3:0] block_B_loader_7_read_reg_578;
reg   [3:0] block_B_loader_8_read_reg_583;
reg   [3:0] block_B_loader_9_read_reg_588;
reg   [3:0] block_B_loader_10_read_reg_593;
reg   [3:0] block_B_loader_11_read_reg_598;
reg   [11:0] k_fu_132;
wire   [11:0] k_17_fu_462_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_595)) begin
        if ((icmp_ln96_fu_456_p2 == 1'd0)) begin
            k_fu_132 <= k_17_fu_462_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln96_fu_456_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_41_reg_488 <= block_A_loader_1_dout;
        tmp_42_reg_493 <= block_A_loader_2_dout;
        tmp_43_reg_498 <= block_A_loader_3_dout;
        tmp_44_reg_503 <= block_A_loader_4_dout;
        tmp_45_reg_508 <= block_A_loader_5_dout;
        tmp_46_reg_513 <= block_A_loader_6_dout;
        tmp_47_reg_518 <= block_A_loader_7_dout;
        tmp_48_reg_523 <= block_A_loader_8_dout;
        tmp_49_reg_528 <= block_A_loader_9_dout;
        tmp_50_reg_533 <= block_A_loader_10_dout;
        tmp_51_reg_538 <= block_A_loader_11_dout;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln96_fu_456_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_k_16 = k_fu_132;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln96_fu_456_p2 == 1'd0) & (ap_start_int == 1'b1) & (ap_done_reg == 1'b0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln96_fu_456_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign A_fifo_0_0_din = tmp_reg_483;

assign A_fifo_10_0_din = tmp_50_reg_533;

assign A_fifo_11_0_din = tmp_51_reg_538;

assign A_fifo_1_0_din = tmp_41_reg_488;

assign A_fifo_2_0_din = tmp_42_reg_493;

assign A_fifo_3_0_din = tmp_43_reg_498;

assign A_fifo_4_0_din = tmp_44_reg_503;

assign A_fifo_5_0_din = tmp_45_reg_508;

assign A_fifo_6_0_din = tmp_46_reg_513;

assign A_fifo_7_0_din = tmp_47_reg_518;

assign A_fifo_8_0_din = tmp_48_reg_523;

assign A_fifo_9_0_din = tmp_49_reg_528;

assign B_fifo_0_0_din = block_B_loader_0_read_reg_543;

assign B_fifo_10_0_din = block_B_loader_10_read_reg_593;

assign B_fifo_11_0_din = block_B_loader_11_read_reg_598;

assign B_fifo_1_0_din = block_B_loader_1_read_reg_548;

assign B_fifo_2_0_din = block_B_loader_2_read_reg_553;

assign B_fifo_3_0_din = block_B_loader_3_read_reg_558;

assign B_fifo_4_0_din = block_B_loader_4_read_reg_563;

assign B_fifo_5_0_din = block_B_loader_5_read_reg_568;

assign B_fifo_6_0_din = block_B_loader_6_read_reg_573;

assign B_fifo_7_0_din = block_B_loader_7_read_reg_578;

assign B_fifo_8_0_din = block_B_loader_8_read_reg_583;

assign B_fifo_9_0_din = block_B_loader_9_read_reg_588;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b0 == B_fifo_11_0_full_n) | (1'b0 == B_fifo_10_0_full_n) | (1'b0 == B_fifo_9_0_full_n) | (1'b0 == B_fifo_8_0_full_n) | (1'b0 == B_fifo_7_0_full_n) | (1'b0 == B_fifo_6_0_full_n) | (1'b0 == B_fifo_5_0_full_n) | (1'b0 == B_fifo_4_0_full_n) | (1'b0 == B_fifo_3_0_full_n) | (1'b0 == B_fifo_2_0_full_n) | (1'b0 == B_fifo_1_0_full_n) | (1'b0 == B_fifo_0_0_full_n) | (1'b0 == A_fifo_11_0_full_n) | (1'b0 == A_fifo_10_0_full_n) | (1'b0 == A_fifo_9_0_full_n) | (1'b0 == A_fifo_8_0_full_n) | (1'b0 == A_fifo_7_0_full_n) | (1'b0 == A_fifo_6_0_full_n) | (1'b0 == A_fifo_5_0_full_n) | (1'b0 == A_fifo_4_0_full_n) | (1'b0 == A_fifo_3_0_full_n) | (1'b0 == A_fifo_2_0_full_n) | (1'b0 == A_fifo_1_0_full_n) | (1'b0 == A_fifo_0_0_full_n))) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((block_A_loader_6_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((block_A_loader_5_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((block_A_loader_4_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln96_fu_456_p2 == 1'd0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_11_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_10_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_9_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_8_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_7_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_6_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_5_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_4_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_2_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_1_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_B_loader_0_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_11_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_10_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_9_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_8_empty_n == 1'b0)) | ((icmp_ln96_fu_456_p2 == 1'd0) & (block_A_loader_7_empty_n == 1'b0)))));
end
...
assign icmp_ln96_fu_456_p2 = ((ap_sig_allocacmp_k_16 == 12'd3072) ? 1'b1 : 1'b0);

assign k_17_fu_462_p2 = (ap_sig_allocacmp_k_16 + 12'd1);

assign start_out = real_start;

endmodule //Bert_layer_systolic_array_k_3072_Loop_data_load_proc23

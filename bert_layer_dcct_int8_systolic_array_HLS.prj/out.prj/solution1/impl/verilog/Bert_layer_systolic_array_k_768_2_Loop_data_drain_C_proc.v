...
wire   [23:0] tmp_23_i_fu_1348_p14;
reg   [23:0] tmp_23_i_reg_1698;
wire   [23:0] tmp_24_i_fu_1378_p14;
reg   [23:0] tmp_24_i_reg_1703;
wire   [23:0] tmp_25_i_fu_1408_p14;
reg   [23:0] tmp_25_i_reg_1708;
wire   [23:0] tmp_26_i_fu_1438_p14;
reg   [23:0] tmp_26_i_reg_1713;
wire   [23:0] tmp_27_i_fu_1468_p14;
reg   [23:0] tmp_27_i_reg_1718;
wire   [23:0] tmp_28_i_fu_1498_p14;
reg   [23:0] tmp_28_i_reg_1723;
wire   [23:0] tmp_29_i_fu_1528_p14;
reg   [23:0] tmp_29_i_reg_1728;
wire   [23:0] tmp_30_i_fu_1558_p14;
reg   [23:0] tmp_30_i_reg_1733;
wire   [23:0] tmp_31_i_fu_1588_p14;
reg   [23:0] tmp_31_i_reg_1738;
wire   [23:0] tmp_32_i_fu_1618_p14;
reg   [23:0] tmp_32_i_reg_1743;
wire   [23:0] tmp_33_i_fu_1648_p14;
reg   [23:0] tmp_33_i_reg_1748;
reg   [3:0] n_fu_346;
wire   [3:0] add_ln73_fu_1312_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_349)) begin
        if ((icmp_ln73_fu_1306_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln73_fu_1306_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln73_fu_1306_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln73_fu_1312_p2 = (ap_sig_allocacmp_n_3 + 4'd1);
...
assign block_C_drainer_10_din = tmp_32_i_reg_1743;

assign block_C_drainer_11_din = tmp_33_i_reg_1748;

assign block_C_drainer_1_din = tmp_23_i_reg_1698;

assign block_C_drainer_2_din = tmp_24_i_reg_1703;

assign block_C_drainer_3_din = tmp_25_i_reg_1708;

assign block_C_drainer_4_din = tmp_26_i_reg_1713;

assign block_C_drainer_5_din = tmp_27_i_reg_1718;

assign block_C_drainer_6_din = tmp_28_i_reg_1723;

assign block_C_drainer_7_din = tmp_29_i_reg_1728;

assign block_C_drainer_8_din = tmp_30_i_reg_1733;

assign block_C_drainer_9_din = tmp_31_i_reg_1738;

assign icmp_ln73_fu_1306_p2 = ((ap_sig_allocacmp_n_3 == 4'd12) ? 1'b1 : 1'b0);

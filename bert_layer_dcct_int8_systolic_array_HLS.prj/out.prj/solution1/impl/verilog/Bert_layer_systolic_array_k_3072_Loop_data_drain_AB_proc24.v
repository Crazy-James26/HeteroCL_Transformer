...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_285)) begin
        if ((icmp_ln114_fu_236_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln114_fu_236_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign icmp_ln114_fu_236_p2 = ((ap_sig_allocacmp_k_18 == 12'd3072) ? 1'b1 : 1'b0);

assign k_19_fu_242_p2 = (ap_sig_allocacmp_k_18 + 12'd1);

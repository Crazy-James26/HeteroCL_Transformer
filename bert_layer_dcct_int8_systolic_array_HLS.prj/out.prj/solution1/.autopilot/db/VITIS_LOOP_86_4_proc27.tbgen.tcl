set moduleName VITIS_LOOP_86_4_proc27
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {VITIS_LOOP_86_4_proc27}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_3 int 24 regular {array 36 { 0 1 } 1 1 }  }
	{ block_C_drainer_312 int 24 regular {fifo 0 volatile }  }
	{ jj int 2 regular {fifo 0}  }
	{ ii int 2 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_3", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "block_C_drainer_312", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_drainer_312_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "block_C_drainer_312", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "C_3", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_86_4_proc27_Pipeline_VITIS_LOOP_86_4_fu_54", "Port" : "C_3", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "block_C_drainer_312", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_86_4_proc27_Pipeline_VITIS_LOOP_86_4_fu_54", "Port" : "block_C_drainer_312", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_86_4_proc27_Pipeline_VITIS_LOOP_86_4_fu_54", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_86_4_proc27_Pipeline_VITIS_LOOP_86_4_fu_54.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	C_3 { ap_memory {  { C_3_address0 mem_address 1 6 }  { C_3_ce0 mem_ce 1 1 }  { C_3_we0 mem_we 1 1 }  { C_3_d0 mem_din 1 24 }  { C_3_address1 MemPortADDR2 1 6 }  { C_3_ce1 MemPortCE2 1 1 }  { C_3_q1 MemPortDOUT2 0 24 } } }
	block_C_drainer_312 { ap_fifo {  { block_C_drainer_312_dout fifo_port_we 0 24 }  { block_C_drainer_312_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_312_fifo_cap fifo_update 0 2 }  { block_C_drainer_312_empty_n fifo_status 0 1 }  { block_C_drainer_312_read fifo_data 1 1 } } }

set moduleName init_block_AB_proc_Pipeline_init_block_AB
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {init_block_AB_proc_Pipeline_init_block_AB}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln74 int 8 regular  }
	...
	{ block_B_loader_05 int 8 regular {fifo 1 volatile }  }
	{ block_B_loader_16 int 8 regular {fifo 1 volatile }  }
	{ block_B_loader_27 int 8 regular {fifo 1 volatile }  }
	{ block_B_loader_38 int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln74", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln77", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "block_B_loader_05", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "block_B_loader_16", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "block_B_loader_27", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "block_B_loader_38", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ block_A_loader_01_din sc_out sc_lv 8 signal 10 } 
	...
	{ block_A_loader_12_din sc_out sc_lv 8 signal 11 } 
	...
	{ block_A_loader_23_din sc_out sc_lv 8 signal 12 } 
	...
	{ block_A_loader_34_din sc_out sc_lv 8 signal 13 } 
	...
	{ block_B_loader_05_din sc_out sc_lv 8 signal 14 } 
	...
	{ block_B_loader_16_din sc_out sc_lv 8 signal 15 } 
	...
	{ block_B_loader_27_din sc_out sc_lv 8 signal 16 } 
	...
	{ block_B_loader_38_din sc_out sc_lv 8 signal 17 } 
	...
	{ zext_ln74 sc_in sc_lv 8 signal 0 } 
	{ A_0_address0 sc_out sc_lv 8 signal 1 } 
	{ A_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ A_0_q0 sc_in sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_B_loader_05_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "block_B_loader_05", "role": "din" }} , 
 	...
 	{ "name": "block_B_loader_16_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "block_B_loader_16", "role": "din" }} , 
 	...
 	{ "name": "block_B_loader_27_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "block_B_loader_27", "role": "din" }} , 
 	...
 	{ "name": "block_B_loader_38_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "block_B_loader_38", "role": "din" }} , 
 	...
 	{ "name": "zext_ln74", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln74", "role": "default" }} , 
 	...
 	{ "name": "zext_ln77", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "zext_ln77", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln74 { ap_none {  { zext_ln74 in_data 0 8 } } }
	A_0 { ap_memory {  { A_0_address0 mem_address 1 8 }  { A_0_ce0 mem_ce 1 1 }  { A_0_q0 in_data 0 8 } } }
	A_1 { ap_memory {  { A_1_address0 mem_address 1 8 }  { A_1_ce0 mem_ce 1 1 }  { A_1_q0 in_data 0 8 } } }
	A_2 { ap_memory {  { A_2_address0 mem_address 1 8 }  { A_2_ce0 mem_ce 1 1 }  { A_2_q0 in_data 0 8 } } }
	A_3 { ap_memory {  { A_3_address0 mem_address 1 8 }  { A_3_ce0 mem_ce 1 1 }  { A_3_q0 in_data 0 8 } } }
	zext_ln77 { ap_none {  { zext_ln77 in_data 0 8 } } }
	B_0 { ap_memory {  { B_0_address0 mem_address 1 8 }  { B_0_ce0 mem_ce 1 1 }  { B_0_q0 in_data 0 8 } } }
	B_1 { ap_memory {  { B_1_address0 mem_address 1 8 }  { B_1_ce0 mem_ce 1 1 }  { B_1_q0 in_data 0 8 } } }
	B_2 { ap_memory {  { B_2_address0 mem_address 1 8 }  { B_2_ce0 mem_ce 1 1 }  { B_2_q0 in_data 0 8 } } }
	B_3 { ap_memory {  { B_3_address0 mem_address 1 8 }  { B_3_ce0 mem_ce 1 1 }  { B_3_q0 in_data 0 8 } } }
	...
	block_B_loader_05 { ap_fifo {  { block_B_loader_05_din fifo_port_we 1 8 }  { block_B_loader_05_num_data_valid fifo_status_num_data_valid 0 2 }  { block_B_loader_05_fifo_cap fifo_update 0 2 }  { block_B_loader_05_full_n fifo_status 0 1 }  { block_B_loader_05_write fifo_data 1 1 } } }
	block_B_loader_16 { ap_fifo {  { block_B_loader_16_din fifo_port_we 1 8 }  { block_B_loader_16_num_data_valid fifo_status_num_data_valid 0 2 }  { block_B_loader_16_fifo_cap fifo_update 0 2 }  { block_B_loader_16_full_n fifo_status 0 1 }  { block_B_loader_16_write fifo_data 1 1 } } }
	block_B_loader_27 { ap_fifo {  { block_B_loader_27_din fifo_port_we 1 8 }  { block_B_loader_27_num_data_valid fifo_status_num_data_valid 0 2 }  { block_B_loader_27_fifo_cap fifo_update 0 2 }  { block_B_loader_27_full_n fifo_status 0 1 }  { block_B_loader_27_write fifo_data 1 1 } } }
	block_B_loader_38 { ap_fifo {  { block_B_loader_38_din fifo_port_we 1 8 }  { block_B_loader_38_num_data_valid fifo_status_num_data_valid 0 2 }  { block_B_loader_38_fifo_cap fifo_update 0 2 }  { block_B_loader_38_full_n fifo_status 0 1 }  { block_B_loader_38_write fifo_data 1 1 } } }
}

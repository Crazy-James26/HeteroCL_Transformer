...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_fifo_0_3_dout { I 4 vector } B_fifo_0_3_num_data_valid { I 2 vector } B_fifo_0_3_fifo_cap { I 2 vector } B_fifo_0_3_empty_n { I 1 bit } B_fifo_0_3_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_fifo_0_4_din { O 4 vector } B_fifo_0_4_num_data_valid { I 2 vector } B_fifo_0_4_fifo_cap { I 2 vector } B_fifo_0_4_full_n { I 1 bit } B_fifo_0_4_write { O 1 bit } } \
} "
}

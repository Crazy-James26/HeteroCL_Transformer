...
set C_modelArgList {
	...
	{ block_C_drainer_1035 int 24 regular {fifo 0 volatile }  }
	{ jj int 6 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_10", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "block_C_drainer_1035", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ C_10_d0 sc_out sc_lv 24 signal 0 } 
	{ C_10_address1 sc_out sc_lv 10 signal 0 } 
	{ C_10_ce1 sc_out sc_logic 1 signal 0 } 
	{ C_10_q1 sc_in sc_lv 24 signal 0 } 
	{ block_C_drainer_1035_dout sc_in sc_lv 24 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_drainer_1035_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "block_C_drainer_1035", "role": "dout" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "C_10", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_179_4_proc42_Pipeline_VITIS_LOOP_179_4_fu_46", "Port" : "C_10", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "block_C_drainer_1035", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_179_4_proc42_Pipeline_VITIS_LOOP_179_4_fu_46", "Port" : "block_C_drainer_1035", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
...
set Spec2ImplPortList { 
	C_10 { ap_memory {  { C_10_address0 mem_address 1 10 }  { C_10_ce0 mem_ce 1 1 }  { C_10_we0 mem_we 1 1 }  { C_10_d0 mem_din 1 24 }  { C_10_address1 MemPortADDR2 1 10 }  { C_10_ce1 MemPortCE2 1 1 }  { C_10_q1 MemPortDOUT2 0 24 } } }
	block_C_drainer_1035 { ap_fifo {  { block_C_drainer_1035_dout fifo_port_we 0 24 }  { block_C_drainer_1035_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_1035_fifo_cap fifo_update 0 2 }  { block_C_drainer_1035_empty_n fifo_status 0 1 }  { block_C_drainer_1035_read fifo_data 1 1 } } }

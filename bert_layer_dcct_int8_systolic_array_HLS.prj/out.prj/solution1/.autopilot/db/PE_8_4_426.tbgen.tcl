...
set hasInterrupt 0
set C_modelName {PE_8_4.426}
set C_modelType { int 24 }
set C_modelArgList {
	{ A_fifo_11_3 int 8 regular {fifo 0 volatile }  }
	{ A_fifo_11_4 int 8 regular {fifo 1 volatile }  }
	{ B_fifo_3_11 int 4 regular {fifo 0 volatile }  }
	{ B_fifo_3_12 int 4 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_fifo_11_3", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B_fifo_3_11", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "B_fifo_3_12", "interface" : "fifo", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ B_fifo_3_11_dout sc_in sc_lv 4 signal 2 } 
	...
	{ B_fifo_3_12_din sc_out sc_lv 4 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_fifo_3_11_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "B_fifo_3_11", "role": "dout" }} , 
 	...
 	{ "name": "B_fifo_3_12_din", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "B_fifo_3_12", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_4s_24s_24_4_1_U8838", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	B_fifo_3_11 { ap_fifo {  { B_fifo_3_11_dout fifo_port_we 0 4 }  { B_fifo_3_11_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_3_11_fifo_cap fifo_update 0 2 }  { B_fifo_3_11_empty_n fifo_status 0 1 }  { B_fifo_3_11_read fifo_data 1 1 } } }
	B_fifo_3_12 { ap_fifo {  { B_fifo_3_12_din fifo_port_we 1 4 }  { B_fifo_3_12_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_3_12_fifo_cap fifo_update 0 2 }  { B_fifo_3_12_full_n fifo_status 0 1 }  { B_fifo_3_12_write fifo_data 1 1 } } }
}

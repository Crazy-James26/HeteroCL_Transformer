set moduleName VITIS_LOOP_225_4_proc49
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {VITIS_LOOP_225_4_proc49}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_5 int 24 regular {array 3072 { 0 1 } 1 1 }  }
	{ block_C_drainer_530 int 24 regular {fifo 0 volatile }  }
	{ jj int 8 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_5", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "block_C_drainer_530", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ C_5_d0 sc_out sc_lv 24 signal 0 } 
	{ C_5_address1 sc_out sc_lv 12 signal 0 } 
	{ C_5_ce1 sc_out sc_logic 1 signal 0 } 
	{ C_5_q1 sc_in sc_lv 24 signal 0 } 
	{ block_C_drainer_530_dout sc_in sc_lv 24 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_drainer_530_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "block_C_drainer_530", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "C_5", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_225_4_proc49_Pipeline_VITIS_LOOP_225_4_fu_46", "Port" : "C_5", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "block_C_drainer_530", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_VITIS_LOOP_225_4_proc49_Pipeline_VITIS_LOOP_225_4_fu_46", "Port" : "block_C_drainer_530", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_225_4_proc49_Pipeline_VITIS_LOOP_225_4_fu_46", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_VITIS_LOOP_225_4_proc49_Pipeline_VITIS_LOOP_225_4_fu_46.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	C_5 { ap_memory {  { C_5_address0 mem_address 1 12 }  { C_5_ce0 mem_ce 1 1 }  { C_5_we0 mem_we 1 1 }  { C_5_d0 mem_din 1 24 }  { C_5_address1 MemPortADDR2 1 12 }  { C_5_ce1 MemPortCE2 1 1 }  { C_5_q1 MemPortDOUT2 0 24 } } }
	block_C_drainer_530 { ap_fifo {  { block_C_drainer_530_dout fifo_port_we 0 24 }  { block_C_drainer_530_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_530_fifo_cap fifo_update 0 2 }  { block_C_drainer_530_empty_n fifo_status 0 1 }  { block_C_drainer_530_read fifo_data 1 1 } } }

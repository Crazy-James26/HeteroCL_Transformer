...
set C_modelArgList {
	{ v358 float 32 regular {array 768 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "v358", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v358_address0 sc_out sc_lv 10 signal 0 } 
	{ v358_ce0 sc_out sc_logic 1 signal 0 } 
	{ v358_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v358_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v358", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "v358", "Type" : "Memory", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_124_32_1_1_U5505", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_124_32_1_1_U5506", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Bert_layer_Pipeline_l_S_i_j_0_i13_l_j13 {
		v358 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	v358 { ap_memory {  { v358_address0 mem_address 1 10 }  { v358_ce0 mem_ce 1 1 }  { v358_q0 in_data 0 32 } } }

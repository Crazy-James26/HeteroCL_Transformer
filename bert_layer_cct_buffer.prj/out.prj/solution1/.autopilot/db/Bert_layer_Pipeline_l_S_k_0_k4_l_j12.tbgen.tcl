set moduleName Bert_layer_Pipeline_l_S_k_0_k4_l_j12
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_S_k_0_k4_l_j12}
set C_modelType { void 0 }
set C_modelArgList {
	{ empty int 14 regular  }
	{ v244 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v229 int 32 regular {array 2359296 { 1 3 } 1 1 }  }
	{ v170 float 32 regular {array 3072 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "v244", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v229", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v170", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ v244_address0 sc_out sc_lv 14 signal 1 } 
	{ v244_ce0 sc_out sc_logic 1 signal 1 } 
	{ v244_q0 sc_in sc_lv 32 signal 1 } 
	{ v229_address0 sc_out sc_lv 22 signal 2 } 
	{ v229_ce0 sc_out sc_logic 1 signal 2 } 
	{ v229_q0 sc_in sc_lv 32 signal 2 } 
	{ v170_address0 sc_out sc_lv 12 signal 3 } 
	{ v170_ce0 sc_out sc_logic 1 signal 3 } 
	{ v170_we0 sc_out sc_logic 1 signal 3 } 
	{ v170_d0 sc_out sc_lv 32 signal 3 } 
	{ v170_address1 sc_out sc_lv 12 signal 3 } 
	{ v170_ce1 sc_out sc_logic 1 signal 3 } 
	{ v170_q1 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v244_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v244", "role": "q0" }} , 
 	...
 	{ "name": "v170_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v170", "role": "we0" }} , 
 	{ "name": "v170_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v170", "role": "d0" }} , 
 	{ "name": "v170_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "v170", "role": "address1" }} , 
 	{ "name": "v170_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v170", "role": "ce1" }} , 
 	{ "name": "v170_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v170", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	v244 { ap_memory {  { v244_address0 mem_address 1 14 }  { v244_ce0 mem_ce 1 1 }  { v244_q0 mem_dout 0 32 } } }
	v229 { ap_memory {  { v229_address0 mem_address 1 22 }  { v229_ce0 mem_ce 1 1 }  { v229_q0 mem_dout 0 32 } } }
	v170 { ap_memory {  { v170_address0 mem_address 1 12 }  { v170_ce0 mem_ce 1 1 }  { v170_we0 mem_we 1 1 }  { v170_d0 mem_din 1 32 }  { v170_address1 MemPortADDR2 1 12 }  { v170_ce1 MemPortCE2 1 1 }  { v170_q1 MemPortDOUT2 0 32 } } }
}

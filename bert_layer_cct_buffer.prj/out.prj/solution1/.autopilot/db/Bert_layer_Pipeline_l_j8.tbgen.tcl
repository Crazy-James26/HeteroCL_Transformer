set moduleName Bert_layer_Pipeline_l_j8
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_j8}
set C_modelType { void 0 }
set C_modelArgList {
	{ empty int 14 regular  }
	{ v242 float 32 regular {array 9216 { 0 1 } 1 1 }  }
	{ v228 int 32 regular {array 768 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "v242", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ v242_address1 sc_out sc_lv 14 signal 1 } 
	{ v242_ce1 sc_out sc_logic 1 signal 1 } 
	{ v242_q1 sc_in sc_lv 32 signal 1 } 
	{ v228_address0 sc_out sc_lv 10 signal 2 } 
	{ v228_ce0 sc_out sc_logic 1 signal 2 } 
	{ v228_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v242_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v242", "role": "address1" }} , 
 	{ "name": "v242_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v242", "role": "ce1" }} , 
 	{ "name": "v242_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v242", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	v242 { ap_memory {  { v242_address0 mem_address 1 14 }  { v242_ce0 mem_ce 1 1 }  { v242_we0 mem_we 1 1 }  { v242_d0 mem_din 1 32 }  { v242_address1 MemPortADDR2 1 14 }  { v242_ce1 MemPortCE2 1 1 }  { v242_q1 MemPortDOUT2 0 32 } } }

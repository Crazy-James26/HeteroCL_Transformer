set moduleName Linear_layer_qkv_Pipeline_l_S_k_0_k_l_j
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "v7", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ v220_address0 sc_out sc_lv 14 signal 1 } 
	{ v220_ce0 sc_out sc_logic 1 signal 1 } 
	{ v220_q0 sc_in sc_lv 32 signal 1 } 
	{ v221_address0 sc_out sc_lv 20 signal 2 } 
	{ v221_ce0 sc_out sc_logic 1 signal 2 } 
	{ v221_q0 sc_in sc_lv 32 signal 2 } 
	{ v7_address0 sc_out sc_lv 10 signal 3 } 
	{ v7_ce0 sc_out sc_logic 1 signal 3 } 
	{ v7_we0 sc_out sc_logic 1 signal 3 } 
	{ v7_d0 sc_out sc_lv 32 signal 3 } 
	{ v7_address1 sc_out sc_lv 10 signal 3 } 
	{ v7_ce1 sc_out sc_logic 1 signal 3 } 
	{ v7_q1 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v7_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v7", "role": "we0" }} , 
 	{ "name": "v7_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v7", "role": "d0" }} , 
 	{ "name": "v7_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "v7", "role": "address1" }} , 
 	{ "name": "v7_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v7", "role": "ce1" }} , 
 	{ "name": "v7_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v7", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U4", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	v7 { ap_memory {  { v7_address0 mem_address 1 10 }  { v7_ce0 mem_ce 1 1 }  { v7_we0 mem_we 1 1 }  { v7_d0 mem_din 1 32 }  { v7_address1 MemPortADDR2 1 10 }  { v7_ce1 MemPortCE2 1 1 }  { v7_q1 MemPortDOUT2 0 32 } } }
}

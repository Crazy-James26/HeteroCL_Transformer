set moduleName Self_attention_Pipeline_l_S_k_0_k2_l_j6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Self_attention_Pipeline_l_S_k_0_k2_l_j6}
set C_modelType { void 0 }
set C_modelArgList {
	{ empty int 8 regular  }
	{ v89 float 32 regular {array 144 { 1 3 } 1 1 }  }
	{ V_h float 32 regular {array 768 { 1 3 } 1 1 }  }
	{ v64 float 32 regular {array 64 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "v89", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "V_h", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v64", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ v89_address0 sc_out sc_lv 8 signal 1 } 
	{ v89_ce0 sc_out sc_logic 1 signal 1 } 
	{ v89_q0 sc_in sc_lv 32 signal 1 } 
	{ V_h_address0 sc_out sc_lv 10 signal 2 } 
	{ V_h_ce0 sc_out sc_logic 1 signal 2 } 
	{ V_h_q0 sc_in sc_lv 32 signal 2 } 
	{ v64_address0 sc_out sc_lv 6 signal 3 } 
	{ v64_ce0 sc_out sc_logic 1 signal 3 } 
	{ v64_we0 sc_out sc_logic 1 signal 3 } 
	{ v64_d0 sc_out sc_lv 32 signal 3 } 
	{ v64_address1 sc_out sc_lv 6 signal 3 } 
	{ v64_ce1 sc_out sc_logic 1 signal 3 } 
	{ v64_q1 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v89_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "v89", "role": "address0" }} , 
 	{ "name": "v89_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v89", "role": "ce0" }} , 
 	{ "name": "v89_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v89", "role": "q0" }} , 
 	...
 	{ "name": "v64_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v64", "role": "we0" }} , 
 	{ "name": "v64_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v64", "role": "d0" }} , 
 	{ "name": "v64_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "v64", "role": "address1" }} , 
 	{ "name": "v64_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v64", "role": "ce1" }} , 
 	{ "name": "v64_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v64", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	v89 { ap_memory {  { v89_address0 mem_address 1 8 }  { v89_ce0 mem_ce 1 1 }  { v89_q0 mem_dout 0 32 } } }
	V_h { ap_memory {  { V_h_address0 mem_address 1 10 }  { V_h_ce0 mem_ce 1 1 }  { V_h_q0 mem_dout 0 32 } } }
	v64 { ap_memory {  { v64_address0 mem_address 1 6 }  { v64_ce0 mem_ce 1 1 }  { v64_we0 mem_we 1 1 }  { v64_d0 mem_din 1 32 }  { v64_address1 MemPortADDR2 1 6 }  { v64_ce1 MemPortCE2 1 1 }  { v64_q1 MemPortDOUT2 0 32 } } }
}

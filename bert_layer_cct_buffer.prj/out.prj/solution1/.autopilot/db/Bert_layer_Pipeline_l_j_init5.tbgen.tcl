set moduleName Bert_layer_Pipeline_l_j_init5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_j_init5}
set C_modelType { void 0 }
set C_modelArgList {
	{ v205 float 32 regular {array 768 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v205", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v205_address0 sc_out sc_lv 10 signal 0 } 
	{ v205_ce0 sc_out sc_logic 1 signal 0 } 
	{ v205_we0 sc_out sc_logic 1 signal 0 } 
	{ v205_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	v205 { ap_memory {  { v205_address0 mem_address 1 10 }  { v205_ce0 mem_ce 1 1 }  { v205_we0 mem_we 1 1 }  { v205_d0 mem_din 1 32 } } }
}

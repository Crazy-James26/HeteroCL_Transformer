set moduleName Layer_norm_Pipeline_l_j10
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "mean2_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln277", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "mean2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mean", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sub_ln280", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln277 sc_in sc_lv 4 signal 3 } 
	...
	{ sub_ln280 sc_in sc_lv 14 signal 6 } 
	{ v124_address0 sc_out sc_lv 14 signal 7 } 
	{ v124_ce0 sc_out sc_logic 1 signal 7 } 
	{ v124_q0 sc_in sc_lv 32 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln277", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln277", "role": "default" }} , 
 	...
 	{ "name": "sub_ln280", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln280", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln277 { ap_none {  { zext_ln277 in_data 0 4 } } }
	...
	sub_ln280 { ap_none {  { sub_ln280 in_data 0 14 } } }

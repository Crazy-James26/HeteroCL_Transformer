set moduleName Bert_layer_Pipeline_l_j_back3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_j_back3}
set C_modelType { void 0 }
set C_modelArgList {
	{ empty int 14 regular  }
	{ v242 float 32 regular {array 9216 { 0 3 } 0 1 }  }
	{ v101 float 32 regular {array 768 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "v242", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ v242_we0 sc_out sc_logic 1 signal 1 } 
	{ v242_d0 sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v242_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v242", "role": "we0" }} , 
 	{ "name": "v242_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v242", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	v242 { ap_memory {  { v242_address0 mem_address 1 14 }  { v242_ce0 mem_ce 1 1 }  { v242_we0 mem_we 1 1 }  { v242_d0 mem_din 1 32 } } }
	v101 { ap_memory {  { v101_address0 mem_address 1 10 }  { v101_ce0 mem_ce 1 1 }  { v101_q0 in_data 0 32 } } }
}

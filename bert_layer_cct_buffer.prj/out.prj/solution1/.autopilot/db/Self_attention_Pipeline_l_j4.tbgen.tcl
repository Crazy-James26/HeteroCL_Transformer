set moduleName Self_attention_Pipeline_l_j4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Self_attention_Pipeline_l_j4}
set C_modelType { void 0 }
set C_modelArgList {
	{ inp_sumRow_load float 32 regular  }
	{ inp_sumRow float 32 regular {array 12 { 0 3 } 0 1 }  }
	{ zext_ln108 int 4 regular  }
	{ sub_ln111 int 8 regular  }
	{ v88 float 32 regular {array 144 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "inp_sumRow_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln108", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln111", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "v88", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ zext_ln108 sc_in sc_lv 4 signal 2 } 
	{ sub_ln111 sc_in sc_lv 8 signal 3 } 
	{ v88_address0 sc_out sc_lv 8 signal 4 } 
	{ v88_ce0 sc_out sc_logic 1 signal 4 } 
	{ v88_we0 sc_out sc_logic 1 signal 4 } 
	{ v88_d0 sc_out sc_lv 32 signal 4 } 
	{ v88_address1 sc_out sc_lv 8 signal 4 } 
	{ v88_ce1 sc_out sc_logic 1 signal 4 } 
	{ v88_q1 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln108", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln108", "role": "default" }} , 
 	{ "name": "sub_ln111", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sub_ln111", "role": "default" }} , 
 	...
 	{ "name": "v88_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "v88", "role": "address1" }} , 
 	{ "name": "v88_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v88", "role": "ce1" }} , 
 	{ "name": "v88_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v88", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_10_full_dsp_1_U47", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln108 { ap_none {  { zext_ln108 in_data 0 4 } } }
	sub_ln111 { ap_none {  { sub_ln111 in_data 0 8 } } }
	v88 { ap_memory {  { v88_address0 mem_address 1 8 }  { v88_ce0 mem_ce 1 1 }  { v88_we0 mem_we 1 1 }  { v88_d0 mem_din 1 32 }  { v88_address1 MemPortADDR2 1 8 }  { v88_ce1 MemPortCE2 1 1 }  { v88_q1 MemPortDOUT2 0 32 } } }
}

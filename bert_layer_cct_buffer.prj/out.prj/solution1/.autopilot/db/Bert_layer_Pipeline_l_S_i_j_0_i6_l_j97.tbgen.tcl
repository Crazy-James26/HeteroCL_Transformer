set moduleName Bert_layer_Pipeline_l_S_i_j_0_i6_l_j97
set isTopModule 0
...
set portList { 
	...
	{ v244_address0 sc_out sc_lv 14 signal 0 } 
	{ v244_ce0 sc_out sc_logic 1 signal 0 } 
	{ v244_q0 sc_in sc_lv 32 signal 0 } 
	{ v247_address0 sc_out sc_lv 14 signal 1 } 
	{ v247_ce0 sc_out sc_logic 1 signal 1 } 
	{ v247_q0 sc_in sc_lv 32 signal 1 } 
	{ v248_address0 sc_out sc_lv 14 signal 2 } 
	{ v248_ce0 sc_out sc_logic 1 signal 2 } 
	{ v248_we0 sc_out sc_logic 1 signal 2 } 
	{ v248_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v248_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v248", "role": "address0" }} , 
 	{ "name": "v248_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v248", "role": "ce0" }} , 
 	{ "name": "v248_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v248", "role": "we0" }} , 
 	{ "name": "v248_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v248", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	v248 { ap_memory {  { v248_address0 mem_address 1 14 }  { v248_ce0 mem_ce 1 1 }  { v248_we0 mem_we 1 1 }  { v248_d0 mem_din 1 32 } } }
}

set moduleName Self_attention_Pipeline_l_j_init1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Self_attention_Pipeline_l_j_init1}
set C_modelType { void 0 }
set C_modelArgList {
	{ v28 float 32 regular {array 12 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v28", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v28_address0 sc_out sc_lv 4 signal 0 } 
	{ v28_ce0 sc_out sc_logic 1 signal 0 } 
	{ v28_we0 sc_out sc_logic 1 signal 0 } 
	{ v28_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	v28 { ap_memory {  { v28_address0 mem_address 1 4 }  { v28_ce0 mem_ce 1 1 }  { v28_we0 mem_we 1 1 }  { v28_d0 mem_din 1 32 } } }
}

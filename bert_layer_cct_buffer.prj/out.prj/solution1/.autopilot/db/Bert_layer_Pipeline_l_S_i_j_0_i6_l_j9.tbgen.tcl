set moduleName Bert_layer_Pipeline_l_S_i_j_0_i6_l_j9
set isTopModule 0
...
set portList { 
	...
	{ v243_we0 sc_out sc_logic 1 signal 2 } 
	{ v243_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v243_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v243", "role": "we0" }} , 
 	{ "name": "v243_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v243", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	v243 { ap_memory {  { v243_address0 mem_address 1 14 }  { v243_ce0 mem_ce 1 1 }  { v243_we0 mem_we 1 1 }  { v243_d0 mem_din 1 32 } } }
}

...
architecture behav of exp_generic_double_s is 
    ...
    component Bert_layer_mul_72Shg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_36Thq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_44UhA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    table_exp_Z1_array_s_U : component pow_generic_doublwdI
    generic map (
        DataWidth => 58,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z3_array_V_U : component pow_generic_doublxdS
    generic map (
        DataWidth => 26,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z2_array_V_U : component pow_generic_doublyd2
    generic map (
        DataWidth => 42,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    Bert_layer_mul_72Shg_U116 : component Bert_layer_mul_72Shg
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 72,
    ...
    Bert_layer_mul_36Thq_U117 : component Bert_layer_mul_36Thq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 36,
    ...
    Bert_layer_mul_44UhA_U118 : component Bert_layer_mul_44UhA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 44,
    ...
    Bert_layer_mul_50Ngs_U119 : component Bert_layer_mul_50Ngs
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    Bert_layer_mac_muOgC_U120 : component Bert_layer_mac_muOgC
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,

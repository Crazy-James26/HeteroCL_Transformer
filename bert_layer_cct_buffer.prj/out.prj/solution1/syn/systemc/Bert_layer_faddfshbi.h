...
// ==============================================================
#ifndef __Bert_layer_faddfshbi__HH__
#define __Bert_layer_faddfshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfshbi) {
    ...
    SC_CTOR(Bert_layer_faddfshbi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

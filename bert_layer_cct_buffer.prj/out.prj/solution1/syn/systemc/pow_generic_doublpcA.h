...
// ==============================================================
#ifndef __pow_generic_doublpcA_H__
#define __pow_generic_doublpcA_H__
...
struct pow_generic_doublpcA_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doublpcA_ram) {
...
SC_MODULE(pow_generic_doublpcA) {
...
pow_generic_doublpcA_ram* meminst;


SC_CTOR(pow_generic_doublpcA) {
meminst = new pow_generic_doublpcA_ram("pow_generic_doublpcA_ram");

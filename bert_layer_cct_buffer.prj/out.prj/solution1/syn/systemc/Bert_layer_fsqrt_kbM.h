...
// ==============================================================
#ifndef __Bert_layer_fsqrt_kbM__HH__
#define __Bert_layer_fsqrt_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fsqrt_kbM) {
    ...
    SC_CTOR(Bert_layer_fsqrt_kbM):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {

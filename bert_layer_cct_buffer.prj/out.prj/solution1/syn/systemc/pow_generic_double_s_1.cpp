...
pow_generic_double_s::pow_generic_double_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    pow_reduce_anonymo_20_U = new pow_generic_doublncg("pow_reduce_anonymo_20_U");
    ...
    pow_reduce_anonymo_19_U = new pow_generic_doublocq("pow_reduce_anonymo_19_U");
    ...
    pow_reduce_anonymo_16_U = new pow_generic_doublpcA("pow_reduce_anonymo_16_U");
    ...
    pow_reduce_anonymo_17_U = new pow_generic_doublqcK("pow_reduce_anonymo_17_U");
    ...
    pow_reduce_anonymo_9_U = new pow_generic_doublrcU("pow_reduce_anonymo_9_U");
    ...
    pow_reduce_anonymo_12_U = new pow_generic_doublsc4("pow_reduce_anonymo_12_U");
    ...
    pow_reduce_anonymo_13_U = new pow_generic_doubltde("pow_reduce_anonymo_13_U");
    ...
    pow_reduce_anonymo_14_U = new pow_generic_doubludo("pow_reduce_anonymo_14_U");
    ...
    pow_reduce_anonymo_15_U = new pow_generic_doublvdy("pow_reduce_anonymo_15_U");
    ...
    pow_reduce_anonymo_18_U = new pow_generic_doublwdI("pow_reduce_anonymo_18_U");
    ...
    pow_reduce_anonymo_U = new pow_generic_doublxdS("pow_reduce_anonymo_U");
    ...
    pow_reduce_anonymo_21_U = new pow_generic_doublyd2("pow_reduce_anonymo_21_U");
    ...
    Bert_layer_mul_54zec_U71 = new Bert_layer_mul_54zec<1,2,54,6,54>("Bert_layer_mul_54zec_U71");
    Bert_layer_mul_54zec_U71->clk(ap_clk);
    Bert_layer_mul_54zec_U71->reset(ap_rst);
    Bert_layer_mul_54zec_U71->din0(b_frac_V_1_reg_2402);
    Bert_layer_mul_54zec_U71->din1(grp_fu_844_p1);
    Bert_layer_mul_54zec_U71->ce(ap_var_for_const0);
    Bert_layer_mul_54zec_U71->dout(grp_fu_844_p2);
    Bert_layer_mul_71Aem_U72 = new Bert_layer_mul_71Aem<1,5,71,4,75>("Bert_layer_mul_71Aem_U72");
    Bert_layer_mul_71Aem_U72->clk(ap_clk);
    Bert_layer_mul_71Aem_U72->reset(ap_rst);
    Bert_layer_mul_71Aem_U72->din0(grp_fu_873_p0);
    Bert_layer_mul_71Aem_U72->din1(grp_fu_873_p1);
    Bert_layer_mul_71Aem_U72->ce(ap_var_for_const0);
    Bert_layer_mul_71Aem_U72->dout(grp_fu_873_p2);
    Bert_layer_mul_73Bew_U73 = new Bert_layer_mul_73Bew<1,5,73,6,79>("Bert_layer_mul_73Bew_U73");
    Bert_layer_mul_73Bew_U73->clk(ap_clk);
    Bert_layer_mul_73Bew_U73->reset(ap_rst);
    Bert_layer_mul_73Bew_U73->din0(grp_fu_990_p0);
    Bert_layer_mul_73Bew_U73->din1(grp_fu_990_p1);
    Bert_layer_mul_73Bew_U73->ce(ap_var_for_const0);
    Bert_layer_mul_73Bew_U73->dout(grp_fu_990_p2);
    Bert_layer_mul_83CeG_U74 = new Bert_layer_mul_83CeG<1,5,83,6,89>("Bert_layer_mul_83CeG_U74");
    Bert_layer_mul_83CeG_U74->clk(ap_clk);
    Bert_layer_mul_83CeG_U74->reset(ap_rst);
    Bert_layer_mul_83CeG_U74->din0(grp_fu_1099_p0);
    Bert_layer_mul_83CeG_U74->din1(grp_fu_1099_p1);
    Bert_layer_mul_83CeG_U74->ce(ap_var_for_const0);
    Bert_layer_mul_83CeG_U74->dout(grp_fu_1099_p2);
    Bert_layer_mul_92DeQ_U75 = new Bert_layer_mul_92DeQ<1,5,92,6,98>("Bert_layer_mul_92DeQ_U75");
    Bert_layer_mul_92DeQ_U75->clk(ap_clk);
    Bert_layer_mul_92DeQ_U75->reset(ap_rst);
    Bert_layer_mul_92DeQ_U75->din0(grp_fu_1189_p0);
    Bert_layer_mul_92DeQ_U75->din1(grp_fu_1189_p1);
    Bert_layer_mul_92DeQ_U75->ce(ap_var_for_const0);
    Bert_layer_mul_92DeQ_U75->dout(grp_fu_1189_p2);
    Bert_layer_mul_87Ee0_U76 = new Bert_layer_mul_87Ee0<1,5,87,6,93>("Bert_layer_mul_87Ee0_U76");
    Bert_layer_mul_87Ee0_U76->clk(ap_clk);
    Bert_layer_mul_87Ee0_U76->reset(ap_rst);
    Bert_layer_mul_87Ee0_U76->din0(grp_fu_1279_p0);
    Bert_layer_mul_87Ee0_U76->din1(grp_fu_1279_p1);
    Bert_layer_mul_87Ee0_U76->ce(ap_var_for_const0);
    Bert_layer_mul_87Ee0_U76->dout(grp_fu_1279_p2);
    Bert_layer_mul_82Ffa_U77 = new Bert_layer_mul_82Ffa<1,5,82,6,88>("Bert_layer_mul_82Ffa_U77");
    Bert_layer_mul_82Ffa_U77->clk(ap_clk);
    Bert_layer_mul_82Ffa_U77->reset(ap_rst);
    Bert_layer_mul_82Ffa_U77->din0(grp_fu_1369_p0);
    Bert_layer_mul_82Ffa_U77->din1(grp_fu_1369_p1);
    Bert_layer_mul_82Ffa_U77->ce(ap_var_for_const0);
    Bert_layer_mul_82Ffa_U77->dout(grp_fu_1369_p2);
    Bert_layer_mul_77Gfk_U78 = new Bert_layer_mul_77Gfk<1,5,77,6,83>("Bert_layer_mul_77Gfk_U78");
    Bert_layer_mul_77Gfk_U78->clk(ap_clk);
    Bert_layer_mul_77Gfk_U78->reset(ap_rst);
    Bert_layer_mul_77Gfk_U78->din0(grp_fu_1431_p0);
    Bert_layer_mul_77Gfk_U78->din1(grp_fu_1431_p1);
    Bert_layer_mul_77Gfk_U78->ce(ap_var_for_const0);
    Bert_layer_mul_77Gfk_U78->dout(grp_fu_1431_p2);
    Bert_layer_mul_80Hfu_U79 = new Bert_layer_mul_80Hfu<1,5,80,12,90>("Bert_layer_mul_80Hfu_U79");
    Bert_layer_mul_80Hfu_U79->clk(ap_clk);
    Bert_layer_mul_80Hfu_U79->reset(ap_rst);
    Bert_layer_mul_80Hfu_U79->din0(grp_fu_1440_p0);
    Bert_layer_mul_80Hfu_U79->din1(b_exp_3_reg_2387_pp0_iter42_reg);
    Bert_layer_mul_80Hfu_U79->ce(ap_var_for_const0);
    Bert_layer_mul_80Hfu_U79->dout(grp_fu_1440_p2);
    Bert_layer_mul_54IfE_U80 = new Bert_layer_mul_54IfE<1,5,54,78,131>("Bert_layer_mul_54IfE_U80");
    Bert_layer_mul_54IfE_U80->clk(ap_clk);
    Bert_layer_mul_54IfE_U80->reset(ap_rst);
    Bert_layer_mul_54IfE_U80->din0(grp_fu_1706_p0);
    Bert_layer_mul_54IfE_U80->din1(log_base_V_reg_2764);
    Bert_layer_mul_54IfE_U80->ce(ap_var_for_const0);
    Bert_layer_mul_54IfE_U80->dout(grp_fu_1706_p2);
    Bert_layer_mul_55JfO_U81 = new Bert_layer_mul_55JfO<1,5,55,78,130>("Bert_layer_mul_55JfO_U81");
    Bert_layer_mul_55JfO_U81->clk(ap_clk);
    Bert_layer_mul_55JfO_U81->reset(ap_rst);
    Bert_layer_mul_55JfO_U81->din0(grp_fu_1715_p0);
    Bert_layer_mul_55JfO_U81->din1(log_base_V_reg_2764);
    Bert_layer_mul_55JfO_U81->ce(ap_var_for_const0);
    Bert_layer_mul_55JfO_U81->dout(grp_fu_1715_p2);
    Bert_layer_mul_72KfY_U82 = new Bert_layer_mul_72KfY<1,5,72,13,83>("Bert_layer_mul_72KfY_U82");
    Bert_layer_mul_72KfY_U82->clk(ap_clk);
    Bert_layer_mul_72KfY_U82->reset(ap_rst);
    Bert_layer_mul_72KfY_U82->din0(grp_fu_1831_p0);
    Bert_layer_mul_72KfY_U82->din1(r_exp_V_3_reg_2806);
    Bert_layer_mul_72KfY_U82->ce(ap_var_for_const0);
    Bert_layer_mul_72KfY_U82->dout(grp_fu_1831_p2);
    Bert_layer_mul_43Lf8_U83 = new Bert_layer_mul_43Lf8<1,2,43,36,79>("Bert_layer_mul_43Lf8_U83");
    Bert_layer_mul_43Lf8_U83->clk(ap_clk);
    Bert_layer_mul_43Lf8_U83->reset(ap_rst);
    Bert_layer_mul_43Lf8_U83->din0(grp_fu_1951_p0);
    Bert_layer_mul_43Lf8_U83->din1(grp_fu_1951_p1);
    Bert_layer_mul_43Lf8_U83->ce(ap_var_for_const0);
    Bert_layer_mul_43Lf8_U83->dout(grp_fu_1951_p2);
    Bert_layer_mul_49Mgi_U84 = new Bert_layer_mul_49Mgi<1,2,49,44,93>("Bert_layer_mul_49Mgi_U84");
    Bert_layer_mul_49Mgi_U84->clk(ap_clk);
    Bert_layer_mul_49Mgi_U84->reset(ap_rst);
    Bert_layer_mul_49Mgi_U84->din0(grp_fu_2017_p0);
    Bert_layer_mul_49Mgi_U84->din1(grp_fu_2017_p1);
    Bert_layer_mul_49Mgi_U84->ce(ap_var_for_const0);
    Bert_layer_mul_49Mgi_U84->dout(grp_fu_2017_p2);
    Bert_layer_mul_50Ngs_U85 = new Bert_layer_mul_50Ngs<1,2,50,50,100>("Bert_layer_mul_50Ngs_U85");
    Bert_layer_mul_50Ngs_U85->clk(ap_clk);
    Bert_layer_mul_50Ngs_U85->reset(ap_rst);
    Bert_layer_mul_50Ngs_U85->din0(grp_fu_2095_p0);
    Bert_layer_mul_50Ngs_U85->din1(grp_fu_2095_p1);
    Bert_layer_mul_50Ngs_U85->ce(ap_var_for_const0);
    Bert_layer_mul_50Ngs_U85->dout(grp_fu_2095_p2);
    Bert_layer_mac_muOgC_U86 = new Bert_layer_mac_muOgC<1,1,16,16,19,31>("Bert_layer_mac_muOgC_U86");
    Bert_layer_mac_muOgC_U86->din0(grp_fu_2334_p0);
    Bert_layer_mac_muOgC_U86->din1(m_fix_hi_V_reg_2796);
    Bert_layer_mac_muOgC_U86->din2(rhs_V_13_fu_1762_p3);
    Bert_layer_mac_muOgC_U86->dout(grp_fu_2334_p3);
...
pow_generic_double_s::~pow_generic_double_s() {
    ...
    delete Bert_layer_mul_54zec_U71;
    delete Bert_layer_mul_71Aem_U72;
    delete Bert_layer_mul_73Bew_U73;
    delete Bert_layer_mul_83CeG_U74;
    delete Bert_layer_mul_92DeQ_U75;
    delete Bert_layer_mul_87Ee0_U76;
    delete Bert_layer_mul_82Ffa_U77;
    delete Bert_layer_mul_77Gfk_U78;
    delete Bert_layer_mul_80Hfu_U79;
    delete Bert_layer_mul_54IfE_U80;
    delete Bert_layer_mul_55JfO_U81;
    delete Bert_layer_mul_72KfY_U82;
    delete Bert_layer_mul_43Lf8_U83;
    delete Bert_layer_mul_49Mgi_U84;
    delete Bert_layer_mul_50Ngs_U85;
    delete Bert_layer_mac_muOgC_U86;
}

...
// ==============================================================
#ifndef __Bert_layer_mul_72Shg__HH__
#define __Bert_layer_mul_72Shg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_72Shg) {
    ...
    SC_CTOR(Bert_layer_mul_72Shg):  ACMP_mul_us_U ("ACMP_mul_us_U") {

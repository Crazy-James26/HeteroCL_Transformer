...
#include "Bert_layer_mul_72Shg.h"
#include "Bert_layer_mul_36Thq.h"
#include "Bert_layer_mul_44UhA.h"
...
struct exp_generic_double_s : public sc_module {
    ...
    pow_generic_doublwdI* table_exp_Z1_array_s_U;
    pow_generic_doublxdS* table_f_Z3_array_V_U;
    pow_generic_doublyd2* table_f_Z2_array_V_U;
    Bert_layer_mul_72Shg<1,5,72,13,84>* Bert_layer_mul_72Shg_U116;
    Bert_layer_mul_36Thq<1,2,36,43,79>* Bert_layer_mul_36Thq_U117;
    Bert_layer_mul_44UhA<1,2,44,49,93>* Bert_layer_mul_44UhA_U118;
    Bert_layer_mul_50Ngs<1,2,50,50,100>* Bert_layer_mul_50Ngs_U119;
    Bert_layer_mac_muOgC<1,1,16,16,19,31>* Bert_layer_mac_muOgC_U120;

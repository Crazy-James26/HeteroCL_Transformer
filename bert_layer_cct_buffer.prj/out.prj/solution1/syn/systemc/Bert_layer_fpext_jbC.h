...
// ==============================================================
#ifndef __Bert_layer_fpext_jbC__HH__
#define __Bert_layer_fpext_jbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fpext_jbC) {
    ...
    SC_CTOR(Bert_layer_fpext_jbC):  ACMP_fpext_U ("ACMP_fpext_U") {

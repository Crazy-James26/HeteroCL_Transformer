...
// ==============================================================
#ifndef __Bert_layer_fptrunibs__HH__
#define __Bert_layer_fptrunibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fptrunibs) {
    ...
    SC_CTOR(Bert_layer_fptrunibs):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

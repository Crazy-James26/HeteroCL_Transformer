...
architecture behav of generic_tanh_float_s is 
    ...
    signal tmp_i_61_reg_411 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component Bert_layer_fsub_3VhK IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_fcmp_3WhU IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Bert_layer_fadd_3bkb_U125 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3VhK_U126 : component Bert_layer_fsub_3VhK
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fsub_3VhK_U129 : component Bert_layer_fsub_3VhK
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U130 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    Bert_layer_fdiv_3eOg_U131 : component Bert_layer_fdiv_3eOg
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    Bert_layer_fptrunibs_U132 : component Bert_layer_fptrunibs
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => tmp_i_61_reg_411,
        ce => ap_const_logic_1,
        dout => grp_fu_133_p1);

    Bert_layer_fpext_jbC_U133 : component Bert_layer_fpext_jbC
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_fcmp_3WhU_U134 : component Bert_layer_fcmp_3WhU
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_dadd_6lbW_U135 : component Bert_layer_dadd_6lbW
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_5_reg_367_pp0_iter30_reg = ap_const_lv1_1) and (icmp_ln841_reg_397_pp0_iter30_reg = ap_const_lv1_0) and (icmp_ln833_5_reg_393_pp0_iter30_reg = ap_const_lv1_0) and (ap_const_lv1_0 = and_ln75_reg_358_pp0_iter30_reg) and (icmp_ln849_reg_354_pp0_iter30_reg = ap_const_lv1_0) and (icmp_ln833_reg_350_pp0_iter30_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_i_61_reg_411 <= grp_fu_145_p2;
            end if;
        end if;
    end process;
    process (ap_clk)

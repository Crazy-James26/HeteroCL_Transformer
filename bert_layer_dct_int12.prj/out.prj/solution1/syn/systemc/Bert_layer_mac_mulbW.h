...
// ==============================================================
#ifndef __Bert_layer_mac_mulbW__HH__
#define __Bert_layer_mac_mulbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mac_mulbW) {
    ...
    SC_CTOR(Bert_layer_mac_mulbW):  simcore_mac_0_U ("simcore_mac_0_U") {

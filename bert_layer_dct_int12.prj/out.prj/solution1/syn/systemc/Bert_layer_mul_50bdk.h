...
// ==============================================================
#ifndef __Bert_layer_mul_50bdk__HH__
#define __Bert_layer_mul_50bdk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_50bdk) {
    ...
    SC_CTOR(Bert_layer_mul_50bdk):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

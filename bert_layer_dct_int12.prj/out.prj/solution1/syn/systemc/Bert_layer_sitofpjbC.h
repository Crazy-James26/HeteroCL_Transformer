...
// ==============================================================
#ifndef __Bert_layer_sitofpjbC__HH__
#define __Bert_layer_sitofpjbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_sitofpjbC) {
    ...
    SC_CTOR(Bert_layer_sitofpjbC):  ACMP_sitofp_U ("ACMP_sitofp_U") {

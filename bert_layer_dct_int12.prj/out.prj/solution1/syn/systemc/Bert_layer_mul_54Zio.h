...
// ==============================================================
#ifndef __Bert_layer_mul_54Zio__HH__
#define __Bert_layer_mul_54Zio__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_54Zio) {
    ...
    SC_CTOR(Bert_layer_mul_54Zio):  ACMP_mul_su_U ("ACMP_mul_su_U") {

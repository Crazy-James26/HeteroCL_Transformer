...
// ==============================================================
#ifndef __Bert_layer_mul_44bkl__HH__
#define __Bert_layer_mul_44bkl__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_44bkl) {
    ...
    SC_CTOR(Bert_layer_mul_44bkl):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

...
// ==============================================================
#ifndef __Bert_layer_mul_72bak__HH__
#define __Bert_layer_mul_72bak__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_72bak) {
    ...
    SC_CTOR(Bert_layer_mul_72bak):  ACMP_mul_us_U ("ACMP_mul_us_U") {

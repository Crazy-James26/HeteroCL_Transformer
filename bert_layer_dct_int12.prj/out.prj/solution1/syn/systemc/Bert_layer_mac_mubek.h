...
// ==============================================================
#ifndef __Bert_layer_mac_mubek__HH__
#define __Bert_layer_mac_mubek__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mac_mubek) {
    ...
    SC_CTOR(Bert_layer_mac_mubek):  simcore_mac_1_U ("simcore_mac_1_U") {

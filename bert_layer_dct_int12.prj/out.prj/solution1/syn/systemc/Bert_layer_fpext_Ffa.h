...
// ==============================================================
#ifndef __Bert_layer_fpext_Ffa__HH__
#define __Bert_layer_fpext_Ffa__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fpext_Ffa) {
    ...
    SC_CTOR(Bert_layer_fpext_Ffa):  ACMP_fpext_U ("ACMP_fpext_U") {

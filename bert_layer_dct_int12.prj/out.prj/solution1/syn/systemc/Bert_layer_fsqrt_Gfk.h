...
// ==============================================================
#ifndef __Bert_layer_fsqrt_Gfk__HH__
#define __Bert_layer_fsqrt_Gfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fsqrt_Gfk) {
    ...
    SC_CTOR(Bert_layer_fsqrt_Gfk):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {

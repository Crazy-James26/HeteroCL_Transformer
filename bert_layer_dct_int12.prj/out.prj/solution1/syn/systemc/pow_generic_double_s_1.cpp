...
pow_generic_double_s::pow_generic_double_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    pow_reduce_anonymo_20_U = new pow_generic_doublNgs("pow_reduce_anonymo_20_U");
    ...
    pow_reduce_anonymo_19_U = new pow_generic_doublOgC("pow_reduce_anonymo_19_U");
    ...
    pow_reduce_anonymo_16_U = new pow_generic_doublPgM("pow_reduce_anonymo_16_U");
    ...
    pow_reduce_anonymo_17_U = new pow_generic_doublQgW("pow_reduce_anonymo_17_U");
    ...
    pow_reduce_anonymo_9_U = new pow_generic_doublRg6("pow_reduce_anonymo_9_U");
    ...
    pow_reduce_anonymo_12_U = new pow_generic_doublShg("pow_reduce_anonymo_12_U");
    ...
    pow_reduce_anonymo_13_U = new pow_generic_doublThq("pow_reduce_anonymo_13_U");
    ...
    pow_reduce_anonymo_14_U = new pow_generic_doublUhA("pow_reduce_anonymo_14_U");
    ...
    pow_reduce_anonymo_15_U = new pow_generic_doublVhK("pow_reduce_anonymo_15_U");
    ...
    pow_reduce_anonymo_18_U = new pow_generic_doublWhU("pow_reduce_anonymo_18_U");
    ...
    pow_reduce_anonymo_U = new pow_generic_doublXh4("pow_reduce_anonymo_U");
    ...
    pow_reduce_anonymo_21_U = new pow_generic_doublYie("pow_reduce_anonymo_21_U");
    ...
    Bert_layer_mul_54Zio_U95 = new Bert_layer_mul_54Zio<1,2,54,6,54>("Bert_layer_mul_54Zio_U95");
    Bert_layer_mul_54Zio_U95->clk(ap_clk);
    Bert_layer_mul_54Zio_U95->reset(ap_rst);
    Bert_layer_mul_54Zio_U95->din0(b_frac_V_1_reg_2402);
    Bert_layer_mul_54Zio_U95->din1(grp_fu_844_p1);
    Bert_layer_mul_54Zio_U95->ce(ap_var_for_const0);
    Bert_layer_mul_54Zio_U95->dout(grp_fu_844_p2);
    Bert_layer_mul_710iy_U96 = new Bert_layer_mul_710iy<1,5,71,4,75>("Bert_layer_mul_710iy_U96");
    Bert_layer_mul_710iy_U96->clk(ap_clk);
    Bert_layer_mul_710iy_U96->reset(ap_rst);
    Bert_layer_mul_710iy_U96->din0(grp_fu_873_p0);
    Bert_layer_mul_710iy_U96->din1(grp_fu_873_p1);
    Bert_layer_mul_710iy_U96->ce(ap_var_for_const0);
    Bert_layer_mul_710iy_U96->dout(grp_fu_873_p2);
    Bert_layer_mul_731iI_U97 = new Bert_layer_mul_731iI<1,5,73,6,79>("Bert_layer_mul_731iI_U97");
    Bert_layer_mul_731iI_U97->clk(ap_clk);
    Bert_layer_mul_731iI_U97->reset(ap_rst);
    Bert_layer_mul_731iI_U97->din0(grp_fu_990_p0);
    Bert_layer_mul_731iI_U97->din1(grp_fu_990_p1);
    Bert_layer_mul_731iI_U97->ce(ap_var_for_const0);
    Bert_layer_mul_731iI_U97->dout(grp_fu_990_p2);
    Bert_layer_mul_832iS_U98 = new Bert_layer_mul_832iS<1,5,83,6,89>("Bert_layer_mul_832iS_U98");
    Bert_layer_mul_832iS_U98->clk(ap_clk);
    Bert_layer_mul_832iS_U98->reset(ap_rst);
    Bert_layer_mul_832iS_U98->din0(grp_fu_1099_p0);
    Bert_layer_mul_832iS_U98->din1(grp_fu_1099_p1);
    Bert_layer_mul_832iS_U98->ce(ap_var_for_const0);
    Bert_layer_mul_832iS_U98->dout(grp_fu_1099_p2);
    Bert_layer_mul_923i2_U99 = new Bert_layer_mul_923i2<1,5,92,6,98>("Bert_layer_mul_923i2_U99");
    Bert_layer_mul_923i2_U99->clk(ap_clk);
    Bert_layer_mul_923i2_U99->reset(ap_rst);
    Bert_layer_mul_923i2_U99->din0(grp_fu_1189_p0);
    Bert_layer_mul_923i2_U99->din1(grp_fu_1189_p1);
    Bert_layer_mul_923i2_U99->ce(ap_var_for_const0);
    Bert_layer_mul_923i2_U99->dout(grp_fu_1189_p2);
    Bert_layer_mul_874jc_U100 = new Bert_layer_mul_874jc<1,5,87,6,93>("Bert_layer_mul_874jc_U100");
    Bert_layer_mul_874jc_U100->clk(ap_clk);
    Bert_layer_mul_874jc_U100->reset(ap_rst);
    Bert_layer_mul_874jc_U100->din0(grp_fu_1279_p0);
    Bert_layer_mul_874jc_U100->din1(grp_fu_1279_p1);
    Bert_layer_mul_874jc_U100->ce(ap_var_for_const0);
    Bert_layer_mul_874jc_U100->dout(grp_fu_1279_p2);
    Bert_layer_mul_825jm_U101 = new Bert_layer_mul_825jm<1,5,82,6,88>("Bert_layer_mul_825jm_U101");
    Bert_layer_mul_825jm_U101->clk(ap_clk);
    Bert_layer_mul_825jm_U101->reset(ap_rst);
    Bert_layer_mul_825jm_U101->din0(grp_fu_1369_p0);
    Bert_layer_mul_825jm_U101->din1(grp_fu_1369_p1);
    Bert_layer_mul_825jm_U101->ce(ap_var_for_const0);
    Bert_layer_mul_825jm_U101->dout(grp_fu_1369_p2);
    Bert_layer_mul_776jw_U102 = new Bert_layer_mul_776jw<1,5,77,6,83>("Bert_layer_mul_776jw_U102");
    Bert_layer_mul_776jw_U102->clk(ap_clk);
    Bert_layer_mul_776jw_U102->reset(ap_rst);
    Bert_layer_mul_776jw_U102->din0(grp_fu_1431_p0);
    Bert_layer_mul_776jw_U102->din1(grp_fu_1431_p1);
    Bert_layer_mul_776jw_U102->ce(ap_var_for_const0);
    Bert_layer_mul_776jw_U102->dout(grp_fu_1431_p2);
    Bert_layer_mul_807jG_U103 = new Bert_layer_mul_807jG<1,5,80,12,90>("Bert_layer_mul_807jG_U103");
    Bert_layer_mul_807jG_U103->clk(ap_clk);
    Bert_layer_mul_807jG_U103->reset(ap_rst);
    Bert_layer_mul_807jG_U103->din0(grp_fu_1440_p0);
    Bert_layer_mul_807jG_U103->din1(b_exp_3_reg_2387_pp0_iter42_reg);
    Bert_layer_mul_807jG_U103->ce(ap_var_for_const0);
    Bert_layer_mul_807jG_U103->dout(grp_fu_1440_p2);
    Bert_layer_mul_548jQ_U104 = new Bert_layer_mul_548jQ<1,5,54,78,131>("Bert_layer_mul_548jQ_U104");
    Bert_layer_mul_548jQ_U104->clk(ap_clk);
    Bert_layer_mul_548jQ_U104->reset(ap_rst);
    Bert_layer_mul_548jQ_U104->din0(grp_fu_1706_p0);
    Bert_layer_mul_548jQ_U104->din1(log_base_V_reg_2764);
    Bert_layer_mul_548jQ_U104->ce(ap_var_for_const0);
    Bert_layer_mul_548jQ_U104->dout(grp_fu_1706_p2);
    Bert_layer_mul_559j0_U105 = new Bert_layer_mul_559j0<1,5,55,78,130>("Bert_layer_mul_559j0_U105");
    Bert_layer_mul_559j0_U105->clk(ap_clk);
    Bert_layer_mul_559j0_U105->reset(ap_rst);
    Bert_layer_mul_559j0_U105->din0(grp_fu_1715_p0);
    Bert_layer_mul_559j0_U105->din1(log_base_V_reg_2764);
    Bert_layer_mul_559j0_U105->ce(ap_var_for_const0);
    Bert_layer_mul_559j0_U105->dout(grp_fu_1715_p2);
    Bert_layer_mul_72bak_U106 = new Bert_layer_mul_72bak<1,5,72,13,83>("Bert_layer_mul_72bak_U106");
    Bert_layer_mul_72bak_U106->clk(ap_clk);
    Bert_layer_mul_72bak_U106->reset(ap_rst);
    Bert_layer_mul_72bak_U106->din0(grp_fu_1831_p0);
    Bert_layer_mul_72bak_U106->din1(r_exp_V_3_reg_2806);
    Bert_layer_mul_72bak_U106->ce(ap_var_for_const0);
    Bert_layer_mul_72bak_U106->dout(grp_fu_1831_p2);
    Bert_layer_mul_43bbk_U107 = new Bert_layer_mul_43bbk<1,2,43,36,79>("Bert_layer_mul_43bbk_U107");
    Bert_layer_mul_43bbk_U107->clk(ap_clk);
    Bert_layer_mul_43bbk_U107->reset(ap_rst);
    Bert_layer_mul_43bbk_U107->din0(grp_fu_1951_p0);
    Bert_layer_mul_43bbk_U107->din1(grp_fu_1951_p1);
    Bert_layer_mul_43bbk_U107->ce(ap_var_for_const0);
    Bert_layer_mul_43bbk_U107->dout(grp_fu_1951_p2);
    Bert_layer_mul_49bck_U108 = new Bert_layer_mul_49bck<1,2,49,44,93>("Bert_layer_mul_49bck_U108");
    Bert_layer_mul_49bck_U108->clk(ap_clk);
    Bert_layer_mul_49bck_U108->reset(ap_rst);
    Bert_layer_mul_49bck_U108->din0(grp_fu_2017_p0);
    Bert_layer_mul_49bck_U108->din1(grp_fu_2017_p1);
    Bert_layer_mul_49bck_U108->ce(ap_var_for_const0);
    Bert_layer_mul_49bck_U108->dout(grp_fu_2017_p2);
    Bert_layer_mul_50bdk_U109 = new Bert_layer_mul_50bdk<1,2,50,50,100>("Bert_layer_mul_50bdk_U109");
    Bert_layer_mul_50bdk_U109->clk(ap_clk);
    Bert_layer_mul_50bdk_U109->reset(ap_rst);
    Bert_layer_mul_50bdk_U109->din0(grp_fu_2095_p0);
    Bert_layer_mul_50bdk_U109->din1(grp_fu_2095_p1);
    Bert_layer_mul_50bdk_U109->ce(ap_var_for_const0);
    Bert_layer_mul_50bdk_U109->dout(grp_fu_2095_p2);
    Bert_layer_mac_mubek_U110 = new Bert_layer_mac_mubek<1,1,16,16,19,31>("Bert_layer_mac_mubek_U110");
    Bert_layer_mac_mubek_U110->din0(grp_fu_2334_p0);
    Bert_layer_mac_mubek_U110->din1(m_fix_hi_V_reg_2796);
    Bert_layer_mac_mubek_U110->din2(rhs_V_13_fu_1762_p3);
    Bert_layer_mac_mubek_U110->dout(grp_fu_2334_p3);
...
pow_generic_double_s::~pow_generic_double_s() {
    ...
    delete Bert_layer_mul_54Zio_U95;
    delete Bert_layer_mul_710iy_U96;
    delete Bert_layer_mul_731iI_U97;
    delete Bert_layer_mul_832iS_U98;
    delete Bert_layer_mul_923i2_U99;
    delete Bert_layer_mul_874jc_U100;
    delete Bert_layer_mul_825jm_U101;
    delete Bert_layer_mul_776jw_U102;
    delete Bert_layer_mul_807jG_U103;
    delete Bert_layer_mul_548jQ_U104;
    delete Bert_layer_mul_559j0_U105;
    delete Bert_layer_mul_72bak_U106;
    delete Bert_layer_mul_43bbk_U107;
    delete Bert_layer_mul_49bck_U108;
    delete Bert_layer_mul_50bdk_U109;
    delete Bert_layer_mac_mubek_U110;
}

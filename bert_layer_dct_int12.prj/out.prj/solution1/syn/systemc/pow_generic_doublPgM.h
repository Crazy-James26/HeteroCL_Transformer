...
// ==============================================================
#ifndef __pow_generic_doublPgM_H__
#define __pow_generic_doublPgM_H__
...
struct pow_generic_doublPgM_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doublPgM_ram) {
...
SC_MODULE(pow_generic_doublPgM) {
...
pow_generic_doublPgM_ram* meminst;


SC_CTOR(pow_generic_doublPgM) {
meminst = new pow_generic_doublPgM_ram("pow_generic_doublPgM_ram");

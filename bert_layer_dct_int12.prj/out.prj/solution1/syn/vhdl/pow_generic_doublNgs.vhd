...
entity pow_generic_doublNgs_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_doublNgs_rom is 
...
entity pow_generic_doublNgs is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of pow_generic_doublNgs is
    component pow_generic_doublNgs_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_doublNgs_rom_U :  component pow_generic_doublNgs_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

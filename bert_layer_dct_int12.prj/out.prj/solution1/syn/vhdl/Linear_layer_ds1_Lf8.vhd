...
entity Linear_layer_ds1_Lf8_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 12; 
            AWIDTH     : integer := 22; 
            MEM_SIZE    : integer := 2359296
    ); 
    port (
...
architecture rtl of Linear_layer_ds1_Lf8_ram is 
...
entity Linear_layer_ds1_Lf8 is
    generic (
        DataWidth : INTEGER := 12;
        AddressRange : INTEGER := 2359296;
...
architecture arch of Linear_layer_ds1_Lf8 is
    component Linear_layer_ds1_Lf8_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    Linear_layer_ds1_Lf8_ram_U :  component Linear_layer_ds1_Lf8_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

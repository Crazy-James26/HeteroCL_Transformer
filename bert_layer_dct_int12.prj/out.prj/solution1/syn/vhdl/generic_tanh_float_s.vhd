...
architecture behav of generic_tanh_float_s is 
    ...
    signal tmp_i_61_reg_389 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component Bert_layer_faddfsDeQ IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_dadd_6Hfu IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    Bert_layer_faddfsDeQ_U149 : component Bert_layer_faddfsDeQ
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3hbi_U150 : component Bert_layer_fmul_3hbi
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    Bert_layer_fdiv_3ibs_U151 : component Bert_layer_fdiv_3ibs
    generic map (
        ID => 1,
        NUM_STAGE => 16,
        din0_WIDTH => 32,
    ...
    Bert_layer_fptrunEe0_U152 : component Bert_layer_fptrunEe0
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    Bert_layer_fpext_Ffa_U153 : component Bert_layer_fpext_Ffa
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_fcmp_3kbM_U154 : component Bert_layer_fcmp_3kbM
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Bert_layer_dadd_6Hfu_U155 : component Bert_layer_dadd_6Hfu
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,

...
module Bert_layer_Layer_norm_Pipeline_l_j29 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln598_1_fu_179_p1;
reg   [31:0] v357_fu_46;
...
reg   [9:0] ap_sig_allocacmp_j29_1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_j29_1 = 10'd0;
    end else begin
        ap_sig_allocacmp_j29_1 = j29_fu_54;
    end
end
...
assign add_ln597_fu_163_p2 = (ap_sig_allocacmp_j29_1 + 10'd1);
...
assign icmp_ln597_fu_157_p2 = ((ap_sig_allocacmp_j29_1 == 10'd768) ? 1'b1 : 1'b0);
...
assign v345_address0 = zext_ln598_1_fu_179_p1;

assign zext_ln596_cast_fu_133_p1 = zext_ln596;

assign zext_ln598_1_fu_179_p1 = add_ln598_fu_173_p2;

assign zext_ln598_fu_169_p1 = ap_sig_allocacmp_j29_1;

endmodule //Bert_layer_Layer_norm_Pipeline_l_j29

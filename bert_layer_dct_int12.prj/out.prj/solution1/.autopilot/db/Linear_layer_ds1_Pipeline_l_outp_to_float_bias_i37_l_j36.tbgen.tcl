set moduleName Linear_layer_ds1_Pipeline_l_outp_to_float_bias_i37_l_j36
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_layer_ds1_Pipeline_l_outp_to_float_bias_i37_l_j36}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_inp2 float 32 regular {array 12 { 1 3 } 1 1 }  }
	{ v388 float 32 regular {array 36864 { 0 3 } 0 1 }  }
	{ q_outp4 int 32 regular {array 36864 { 1 3 } 1 1 }  }
	{ max_W2 float 32 regular {array 3072 { 1 3 } 1 1 }  }
	{ v562 int 32 regular {array 3072 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_inp2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v388", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "q_outp4", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ max_inp2_address0 sc_out sc_lv 4 signal 0 } 
	{ max_inp2_ce0 sc_out sc_logic 1 signal 0 } 
	{ max_inp2_q0 sc_in sc_lv 32 signal 0 } 
	{ v388_address0 sc_out sc_lv 16 signal 1 } 
	{ v388_ce0 sc_out sc_logic 1 signal 1 } 
	{ v388_we0 sc_out sc_logic 1 signal 1 } 
	{ v388_d0 sc_out sc_lv 32 signal 1 } 
	{ q_outp4_address0 sc_out sc_lv 16 signal 2 } 
	{ q_outp4_ce0 sc_out sc_logic 1 signal 2 } 
	{ q_outp4_q0 sc_in sc_lv 32 signal 2 } 
	{ max_W2_address0 sc_out sc_lv 12 signal 3 } 
	{ max_W2_ce0 sc_out sc_logic 1 signal 3 } 
	{ max_W2_q0 sc_in sc_lv 32 signal 3 } 
	{ v562_address0 sc_out sc_lv 12 signal 4 } 
	{ v562_ce0 sc_out sc_logic 1 signal 4 } 
	{ v562_q0 sc_in sc_lv 32 signal 4 } 
	{ grp_fu_672_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_672_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_672_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_inp2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "max_inp2", "role": "address0" }} , 
 	{ "name": "max_inp2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "max_inp2", "role": "ce0" }} , 
 	{ "name": "max_inp2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_inp2", "role": "q0" }} , 
 	...
 	{ "name": "q_outp4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "q_outp4", "role": "address0" }} , 
 	{ "name": "q_outp4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "q_outp4", "role": "ce0" }} , 
 	{ "name": "q_outp4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "q_outp4", "role": "q0" }} , 
 	...
 	{ "name": "grp_fu_672_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_672_p_opcode", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "36903", "Max" : "36903"}
	, {"Name" : "Interval", "Min" : "36903", "Max" : "36903"}
]}
...
set Spec2ImplPortList { 
	max_inp2 { ap_memory {  { max_inp2_address0 mem_address 1 4 }  { max_inp2_ce0 mem_ce 1 1 }  { max_inp2_q0 mem_dout 0 32 } } }
	v388 { ap_memory {  { v388_address0 mem_address 1 16 }  { v388_ce0 mem_ce 1 1 }  { v388_we0 mem_we 1 1 }  { v388_d0 mem_din 1 32 } } }
	q_outp4 { ap_memory {  { q_outp4_address0 mem_address 1 16 }  { q_outp4_ce0 mem_ce 1 1 }  { q_outp4_q0 mem_dout 0 32 } } }

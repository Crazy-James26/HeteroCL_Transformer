set moduleName Linear_layer_ds0_Pipeline_l_inp_to_int_i24_l_j24
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_layer_ds0_Pipeline_l_inp_to_int_i24_l_j24}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_inp1 float 32 regular {array 12 { 1 3 } 1 1 }  }
	{ v260 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ q_inp1_V int 12 regular {array 9216 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_inp1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v260", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "q_inp1_V", "interface" : "memory", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_inp1_address0 sc_out sc_lv 4 signal 0 } 
	{ max_inp1_ce0 sc_out sc_logic 1 signal 0 } 
	{ max_inp1_q0 sc_in sc_lv 32 signal 0 } 
	{ v260_address0 sc_out sc_lv 14 signal 1 } 
	{ v260_ce0 sc_out sc_logic 1 signal 1 } 
	{ v260_q0 sc_in sc_lv 32 signal 1 } 
	{ q_inp1_V_address0 sc_out sc_lv 14 signal 2 } 
	{ q_inp1_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ q_inp1_V_we0 sc_out sc_logic 1 signal 2 } 
	{ q_inp1_V_d0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_inp1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_inp1", "role": "q0" }} , 
 	...
 	{ "name": "q_inp1_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "q_inp1_V", "role": "we0" }} , 
 	{ "name": "q_inp1_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "q_inp1_V", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	max_inp1 { ap_memory {  { max_inp1_address0 mem_address 1 4 }  { max_inp1_ce0 mem_ce 1 1 }  { max_inp1_q0 mem_dout 0 32 } } }
	v260 { ap_memory {  { v260_address0 mem_address 1 14 }  { v260_ce0 mem_ce 1 1 }  { v260_q0 mem_dout 0 32 } } }
	q_inp1_V { ap_memory {  { q_inp1_V_address0 mem_address 1 14 }  { q_inp1_V_ce0 mem_ce 1 1 }  { q_inp1_V_we0 mem_we 1 1 }  { q_inp1_V_d0 mem_din 1 12 } } }
}

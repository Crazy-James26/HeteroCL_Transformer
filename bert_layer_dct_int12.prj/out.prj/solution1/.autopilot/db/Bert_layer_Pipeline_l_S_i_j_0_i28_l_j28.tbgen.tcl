set moduleName Bert_layer_Pipeline_l_S_i_j_0_i28_l_j28
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_S_i_j_0_i28_l_j28}
set C_modelType { void 0 }
set C_modelArgList {
	{ v552 int 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v574 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v575 float 32 regular {array 9216 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v552", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v574", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v575", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v574_address0 sc_out sc_lv 14 signal 1 } 
	{ v574_ce0 sc_out sc_logic 1 signal 1 } 
	{ v574_q0 sc_in sc_lv 32 signal 1 } 
	{ v575_address0 sc_out sc_lv 14 signal 2 } 
	{ v575_ce0 sc_out sc_logic 1 signal 2 } 
	{ v575_we0 sc_out sc_logic 1 signal 2 } 
	{ v575_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v574_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v574", "role": "address0" }} , 
 	{ "name": "v574_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v574", "role": "ce0" }} , 
 	{ "name": "v574_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v574", "role": "q0" }} , 
 	{ "name": "v575_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v575", "role": "address0" }} , 
 	{ "name": "v575_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v575", "role": "ce0" }} , 
 	{ "name": "v575_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v575", "role": "we0" }} , 
 	{ "name": "v575_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v575", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	v574 { ap_memory {  { v574_address0 mem_address 1 14 }  { v574_ce0 mem_ce 1 1 }  { v574_q0 mem_dout 0 32 } } }
	v575 { ap_memory {  { v575_address0 mem_address 1 14 }  { v575_ce0 mem_ce 1 1 }  { v575_we0 mem_we 1 1 }  { v575_d0 mem_din 1 32 } } }
}

set moduleName Linear_layer_ds0_Pipeline_l_W_to_int_i25_l_j25
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_layer_ds0_Pipeline_l_W_to_int_i25_l_j25}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_W1 float 32 regular {array 768 { 1 3 } 1 1 }  }
	{ v559 int 32 regular {array 589824 { 1 3 } 1 1 }  }
	{ q_W1_V int 12 regular {array 589824 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_W1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v559", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "q_W1_V", "interface" : "memory", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_W1_address0 sc_out sc_lv 10 signal 0 } 
	{ max_W1_ce0 sc_out sc_logic 1 signal 0 } 
	{ max_W1_q0 sc_in sc_lv 32 signal 0 } 
	{ v559_address0 sc_out sc_lv 20 signal 1 } 
	{ v559_ce0 sc_out sc_logic 1 signal 1 } 
	{ v559_q0 sc_in sc_lv 32 signal 1 } 
	{ q_W1_V_address0 sc_out sc_lv 20 signal 2 } 
	{ q_W1_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ q_W1_V_we0 sc_out sc_logic 1 signal 2 } 
	{ q_W1_V_d0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_W1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_W1", "role": "q0" }} , 
 	...
 	{ "name": "q_W1_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "q_W1_V", "role": "we0" }} , 
 	{ "name": "q_W1_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "q_W1_V", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	max_W1 { ap_memory {  { max_W1_address0 mem_address 1 10 }  { max_W1_ce0 mem_ce 1 1 }  { max_W1_q0 mem_dout 0 32 } } }
	v559 { ap_memory {  { v559_address0 mem_address 1 20 }  { v559_ce0 mem_ce 1 1 }  { v559_q0 mem_dout 0 32 } } }
	q_W1_V { ap_memory {  { q_W1_V_address0 mem_address 1 20 }  { q_W1_V_ce0 mem_ce 1 1 }  { q_W1_V_we0 mem_we 1 1 }  { q_W1_V_d0 mem_din 1 12 } } }
}

set moduleName Attention_layer_Pipeline_VITIS_LOOP_155_3_VITIS_LOOP_156_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Attention_layer_Pipeline_VITIS_LOOP_155_3_VITIS_LOOP_156_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ q_outp1 int 32 regular {array 144 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "q_outp1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ q_outp1_we0 sc_out sc_logic 1 signal 0 } 
	{ q_outp1_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	q_outp1 { ap_memory {  { q_outp1_address0 mem_address 1 8 }  { q_outp1_ce0 mem_ce 1 1 }  { q_outp1_we0 mem_we 1 1 }  { q_outp1_d0 mem_din 1 32 } } }
}

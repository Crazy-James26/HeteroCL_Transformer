set moduleName Linear_layer_ds2_Pipeline_l_inp_to_int_i41_l_j40
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_layer_ds2_Pipeline_l_inp_to_int_i41_l_j40}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_inp3 float 32 regular {array 12 { 1 3 } 1 1 }  }
	{ v475 float 32 regular {array 36864 { 1 3 } 1 1 }  }
	{ q_inp3_V int 12 regular {array 36864 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_inp3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "q_inp3_V", "interface" : "memory", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v475_address0 sc_out sc_lv 16 signal 1 } 
	{ v475_ce0 sc_out sc_logic 1 signal 1 } 
	{ v475_q0 sc_in sc_lv 32 signal 1 } 
	{ q_inp3_V_address0 sc_out sc_lv 16 signal 2 } 
	{ q_inp3_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ q_inp3_V_we0 sc_out sc_logic 1 signal 2 } 
	{ q_inp3_V_d0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "q_inp3_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "q_inp3_V", "role": "we0" }} , 
 	{ "name": "q_inp3_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "q_inp3_V", "role": "d0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "36891", "Max" : "36891"}
	, {"Name" : "Interval", "Min" : "36891", "Max" : "36891"}
]}
...
set Spec2ImplPortList { 
	...
	q_inp3_V { ap_memory {  { q_inp3_V_address0 mem_address 1 16 }  { q_inp3_V_ce0 mem_ce 1 1 }  { q_inp3_V_we0 mem_we 1 1 }  { q_inp3_V_d0 mem_din 1 12 } } }
}

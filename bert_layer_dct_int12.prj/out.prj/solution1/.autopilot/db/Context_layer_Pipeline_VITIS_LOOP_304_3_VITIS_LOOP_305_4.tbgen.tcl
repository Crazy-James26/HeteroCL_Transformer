set moduleName Context_layer_Pipeline_VITIS_LOOP_304_3_VITIS_LOOP_305_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Context_layer_Pipeline_VITIS_LOOP_304_3_VITIS_LOOP_305_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ q_outp2 int 32 regular {array 768 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "q_outp2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ q_outp2_address0 sc_out sc_lv 10 signal 0 } 
	{ q_outp2_ce0 sc_out sc_logic 1 signal 0 } 
	{ q_outp2_we0 sc_out sc_logic 1 signal 0 } 
	{ q_outp2_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	q_outp2 { ap_memory {  { q_outp2_address0 mem_address 1 10 }  { q_outp2_ce0 mem_ce 1 1 }  { q_outp2_we0 mem_we 1 1 }  { q_outp2_d0 mem_din 1 32 } } }
}

set moduleName Linear_layer_ds2_Pipeline_l_W_to_int_i42_l_j41
set isTopModule 0
...
set portList { 
	...
	{ max_W3_q0 sc_in sc_lv 32 signal 0 } 
	{ v563_address0 sc_out sc_lv 22 signal 1 } 
	{ v563_ce0 sc_out sc_logic 1 signal 1 } 
	{ v563_q0 sc_in sc_lv 32 signal 1 } 
	{ q_W3_V_address0 sc_out sc_lv 22 signal 2 } 
	{ q_W3_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ q_W3_V_we0 sc_out sc_logic 1 signal 2 } 
	{ q_W3_V_d0 sc_out sc_lv 12 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "q_W3_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "q_W3_V", "role": "we0" }} , 
 	{ "name": "q_W3_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "q_W3_V", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	q_W3_V { ap_memory {  { q_W3_V_address0 mem_address 1 22 }  { q_W3_V_ce0 mem_ce 1 1 }  { q_W3_V_we0 mem_we 1 1 }  { q_W3_V_d0 mem_din 1 12 } } }
}

; ModuleID = '/home/jz2292/project/transformer/heterocl_file/bert_layer_dct_int12.prj/out.prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_Bert_layer_ir([768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="12" %v552, [768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v553, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v554, [768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v555, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v556, [768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v557, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v558, [768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v559, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v560, [768 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3072" %v561, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3072" %v562, [3072 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v563, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v564, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v565, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v566, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v567, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="768" %v568, [768 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="12" %v569) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 36864)
  %v552_copy = bitcast i8* %malloccall to [12 x [768 x float]]*
  %malloccall1 = tail call i8* @malloc(i64 2359296)
  %v553_copy = bitcast i8* %malloccall1 to [768 x [768 x float]]*
  %v554_copy = alloca [768 x float], align 512
  %malloccall2 = tail call i8* @malloc(i64 2359296)
  %v555_copy = bitcast i8* %malloccall2 to [768 x [768 x float]]*
  %v556_copy = alloca [768 x float], align 512
  %malloccall3 = tail call i8* @malloc(i64 2359296)
  %v557_copy = bitcast i8* %malloccall3 to [768 x [768 x float]]*
  %v558_copy = alloca [768 x float], align 512
  %malloccall4 = tail call i8* @malloc(i64 2359296)
  %v559_copy = bitcast i8* %malloccall4 to [768 x [768 x float]]*
  %v560_copy = alloca [768 x float], align 512
  %malloccall5 = tail call i8* @malloc(i64 9437184)
  %v561_copy = bitcast i8* %malloccall5 to [3072 x [768 x float]]*
  %malloccall6 = tail call i8* @malloc(i64 12288)
  %v562_copy = bitcast i8* %malloccall6 to [3072 x float]*
  %malloccall7 = tail call i8* @malloc(i64 9437184)
  %v563_copy = bitcast i8* %malloccall7 to [768 x [3072 x float]]*
  %v564_copy = alloca [768 x float], align 512
  %v565_copy = alloca [768 x float], align 512
  %v566_copy = alloca [768 x float], align 512
  %v567_copy = alloca [768 x float], align 512
  %v568_copy = alloca [768 x float], align 512
  %malloccall8 = tail call i8* @malloc(i64 36864)
  %v569_copy = bitcast i8* %malloccall8 to [12 x [768 x float]]*
  %0 = bitcast [768 x float]* %v552 to [12 x [768 x float]]*
  %1 = bitcast [768 x float]* %v553 to [768 x [768 x float]]*
  %2 = bitcast float* %v554 to [768 x float]*
  %3 = bitcast [768 x float]* %v555 to [768 x [768 x float]]*
  %4 = bitcast float* %v556 to [768 x float]*
  %5 = bitcast [768 x float]* %v557 to [768 x [768 x float]]*
  %6 = bitcast float* %v558 to [768 x float]*
  %7 = bitcast [768 x float]* %v559 to [768 x [768 x float]]*
  %8 = bitcast float* %v560 to [768 x float]*
  %9 = bitcast [768 x float]* %v561 to [3072 x [768 x float]]*
  %10 = bitcast float* %v562 to [3072 x float]*
  %11 = bitcast [3072 x float]* %v563 to [768 x [3072 x float]]*
  %12 = bitcast float* %v564 to [768 x float]*
  %13 = bitcast float* %v565 to [768 x float]*
  %14 = bitcast float* %v566 to [768 x float]*
  %15 = bitcast float* %v567 to [768 x float]*
  %16 = bitcast float* %v568 to [768 x float]*
  %17 = bitcast [768 x float]* %v569 to [12 x [768 x float]]*
  call fastcc void @copy_in([12 x [768 x float]]* nonnull %0, [12 x [768 x float]]* %v552_copy, [768 x [768 x float]]* nonnull %1, [768 x [768 x float]]* %v553_copy, [768 x float]* nonnull %2, [768 x float]* nonnull align 512 %v554_copy, [768 x [768 x float]]* nonnull %3, [768 x [768 x float]]* %v555_copy, [768 x float]* nonnull %4, [768 x float]* nonnull align 512 %v556_copy, [768 x [768 x float]]* nonnull %5, [768 x [768 x float]]* %v557_copy, [768 x float]* nonnull %6, [768 x float]* nonnull align 512 %v558_copy, [768 x [768 x float]]* nonnull %7, [768 x [768 x float]]* %v559_copy, [768 x float]* nonnull %8, [768 x float]* nonnull align 512 %v560_copy, [3072 x [768 x float]]* nonnull %9, [3072 x [768 x float]]* %v561_copy, [3072 x float]* nonnull %10, [3072 x float]* %v562_copy, [768 x [3072 x float]]* nonnull %11, [768 x [3072 x float]]* %v563_copy, [768 x float]* nonnull %12, [768 x float]* nonnull align 512 %v564_copy, [768 x float]* nonnull %13, [768 x float]* nonnull align 512 %v565_copy, [768 x float]* nonnull %14, [768 x float]* nonnull align 512 %v566_copy, [768 x float]* nonnull %15, [768 x float]* nonnull align 512 %v567_copy, [768 x float]* nonnull %16, [768 x float]* nonnull align 512 %v568_copy, [12 x [768 x float]]* nonnull %17, [12 x [768 x float]]* %v569_copy)
  %18 = getelementptr inbounds [12 x [768 x float]], [12 x [768 x float]]* %v552_copy, i32 0, i32 0
  %19 = getelementptr inbounds [768 x [768 x float]], [768 x [768 x float]]* %v553_copy, i32 0, i32 0
  %20 = getelementptr inbounds [768 x float], [768 x float]* %v554_copy, i32 0, i32 0
  %21 = getelementptr inbounds [768 x [768 x float]], [768 x [768 x float]]* %v555_copy, i32 0, i32 0
  %22 = getelementptr inbounds [768 x float], [768 x float]* %v556_copy, i32 0, i32 0
  %23 = getelementptr inbounds [768 x [768 x float]], [768 x [768 x float]]* %v557_copy, i32 0, i32 0
  %24 = getelementptr inbounds [768 x float], [768 x float]* %v558_copy, i32 0, i32 0
  %25 = getelementptr inbounds [768 x [768 x float]], [768 x [768 x float]]* %v559_copy, i32 0, i32 0
  %26 = getelementptr inbounds [768 x float], [768 x float]* %v560_copy, i32 0, i32 0
  %27 = getelementptr inbounds [3072 x [768 x float]], [3072 x [768 x float]]* %v561_copy, i32 0, i32 0
  %28 = getelementptr inbounds [3072 x float], [3072 x float]* %v562_copy, i32 0, i32 0
  %29 = getelementptr inbounds [768 x [3072 x float]], [768 x [3072 x float]]* %v563_copy, i32 0, i32 0
  %30 = getelementptr inbounds [768 x float], [768 x float]* %v564_copy, i32 0, i32 0
  %31 = getelementptr inbounds [768 x float], [768 x float]* %v565_copy, i32 0, i32 0
  %32 = getelementptr inbounds [768 x float], [768 x float]* %v566_copy, i32 0, i32 0
  %33 = getelementptr inbounds [768 x float], [768 x float]* %v567_copy, i32 0, i32 0
  %34 = getelementptr inbounds [768 x float], [768 x float]* %v568_copy, i32 0, i32 0
  %35 = getelementptr inbounds [12 x [768 x float]], [12 x [768 x float]]* %v569_copy, i32 0, i32 0
  ...
  call void @copy_back([12 x [768 x float]]* %0, [12 x [768 x float]]* %v552_copy, [768 x [768 x float]]* %1, [768 x [768 x float]]* %v553_copy, [768 x float]* %2, [768 x float]* %v554_copy, [768 x [768 x float]]* %3, [768 x [768 x float]]* %v555_copy, [768 x float]* %4, [768 x float]* %v556_copy, [768 x [768 x float]]* %5, [768 x [768 x float]]* %v557_copy, [768 x float]* %6, [768 x float]* %v558_copy, [768 x [768 x float]]* %7, [768 x [768 x float]]* %v559_copy, [768 x float]* %8, [768 x float]* %v560_copy, [3072 x [768 x float]]* %9, [3072 x [768 x float]]* %v561_copy, [3072 x float]* %10, [3072 x float]* %v562_copy, [768 x [3072 x float]]* %11, [768 x [3072 x float]]* %v563_copy, [768 x float]* %12, [768 x float]* %v564_copy, [768 x float]* %13, [768 x float]* %v565_copy, [768 x float]* %14, [768 x float]* %v566_copy, [768 x float]* %15, [768 x float]* %v567_copy, [768 x float]* %16, [768 x float]* %v568_copy, [12 x [768 x float]]* %17, [12 x [768 x float]]* %v569_copy)

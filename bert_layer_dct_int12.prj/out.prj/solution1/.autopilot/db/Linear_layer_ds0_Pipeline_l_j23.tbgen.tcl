set moduleName Linear_layer_ds0_Pipeline_l_j23
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_layer_ds0_Pipeline_l_j23}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_W1_load float 32 regular  }
	{ max_W1 float 32 regular {array 768 { 0 3 } 0 1 }  }
	{ zext_ln490 int 10 regular  }
	{ sub_ln492 int 20 regular  }
	{ v559 int 32 regular {array 589824 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_W1_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "max_W1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln490", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln492", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ max_W1_load sc_in sc_lv 32 signal 0 } 
	{ max_W1_address0 sc_out sc_lv 10 signal 1 } 
	{ max_W1_ce0 sc_out sc_logic 1 signal 1 } 
	{ max_W1_we0 sc_out sc_logic 1 signal 1 } 
	{ max_W1_d0 sc_out sc_lv 32 signal 1 } 
	{ zext_ln490 sc_in sc_lv 10 signal 2 } 
	{ sub_ln492 sc_in sc_lv 20 signal 3 } 
	{ v559_address0 sc_out sc_lv 20 signal 4 } 
	{ v559_ce0 sc_out sc_logic 1 signal 4 } 
	{ v559_q0 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_W1_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_W1_load", "role": "default" }} , 
 	{ "name": "max_W1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "max_W1", "role": "address0" }} , 
 	{ "name": "max_W1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "max_W1", "role": "ce0" }} , 
 	{ "name": "max_W1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "max_W1", "role": "we0" }} , 
 	{ "name": "max_W1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_W1", "role": "d0" }} , 
 	{ "name": "zext_ln490", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "zext_ln490", "role": "default" }} , 
 	{ "name": "sub_ln492", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sub_ln492", "role": "default" }} , 
...
set Spec2ImplPortList { 
	max_W1_load { ap_none {  { max_W1_load in_data 0 32 } } }
	max_W1 { ap_memory {  { max_W1_address0 mem_address 1 10 }  { max_W1_ce0 mem_ce 1 1 }  { max_W1_we0 mem_we 1 1 }  { max_W1_d0 mem_din 1 32 } } }
	zext_ln490 { ap_none {  { zext_ln490 in_data 0 10 } } }
	sub_ln492 { ap_none {  { sub_ln492 in_data 0 20 } } }
	v559 { ap_memory {  { v559_address0 mem_address 1 20 }  { v559_ce0 mem_ce 1 1 }  { v559_q0 in_data 0 32 } } }
}

...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name Bert_layer_dadd_64ns_64ns_64_7_full_dsp_1_x_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name Bert_layer_dadd_64ns_64ns_64_7_full_dsp_1_x_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips Bert_layer_dadd_64ns_64ns_64_7_full_dsp_1_x_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files Bert_layer_dadd_64ns_64ns_64_7_full_dsp_1_x_ip.xci]
generate_target {synthesis simulation} [get_files Bert_layer_dadd_64ns_64ns_64_7_full_dsp_1_x_ip.xci]

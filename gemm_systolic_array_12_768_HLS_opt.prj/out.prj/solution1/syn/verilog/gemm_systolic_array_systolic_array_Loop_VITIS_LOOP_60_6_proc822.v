...
module gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc822 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_8_fu_163_p14;
reg   [31:0] tmp_8_reg_212;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln60_fu_151_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_8_reg_212 <= tmp_8_fu_163_p14;
    end
end
...
assign add_ln60_fu_157_p2 = (ap_sig_allocacmp_n_2 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_8_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_8_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((block_C_drainer_8_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (block_C_drainer_8_full_n == 1'b0);
end
...
assign block_C_drainer_8_din = tmp_8_reg_212;

assign icmp_ln60_fu_151_p2 = ((ap_sig_allocacmp_n_2 == 4'd12) ? 1'b1 : 1'b0);

endmodule //gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc822

...
module gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc721 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_7_fu_163_p14;
reg   [31:0] tmp_7_reg_212;
...
assign add_ln60_fu_157_p2 = (ap_sig_allocacmp_n_3 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((block_C_drainer_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (block_C_drainer_7_full_n == 1'b0);
end
...
assign block_C_drainer_7_din = tmp_7_reg_212;

assign icmp_ln60_fu_151_p2 = ((ap_sig_allocacmp_n_3 == 4'd12) ? 1'b1 : 1'b0);

endmodule //gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc721

...
module gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc418 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_4_fu_163_p14;
reg   [31:0] tmp_4_reg_212;
reg    ap_block_pp0_stage0_11001;
reg   [3:0] n_fu_60;
wire   [3:0] add_ln60_fu_157_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_n_6;
...
mux_124_32_1_1_U1106(
    ...
    .din10(p_read10),
    .din11(p_read11),
    .din12(ap_sig_allocacmp_n_6),
    .dout(tmp_4_fu_163_p14)
);
...
always @ (posedge ap_clk) begin
    if (((icmp_ln60_fu_151_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_4_reg_212 <= tmp_4_fu_163_p14;
    end
end
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_n_6 = 4'd0;
    end else begin
        ap_sig_allocacmp_n_6 = n_fu_60;
    end
end
...
assign add_ln60_fu_157_p2 = (ap_sig_allocacmp_n_6 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((block_C_drainer_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((block_C_drainer_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_done_reg == 1'b1) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (block_C_drainer_4_full_n == 1'b0);
end
...
assign block_C_drainer_4_din = tmp_4_reg_212;

assign icmp_ln60_fu_151_p2 = ((ap_sig_allocacmp_n_6 == 4'd12) ? 1'b1 : 1'b0);

endmodule //gemm_systolic_array_systolic_array_Loop_VITIS_LOOP_60_6_proc418

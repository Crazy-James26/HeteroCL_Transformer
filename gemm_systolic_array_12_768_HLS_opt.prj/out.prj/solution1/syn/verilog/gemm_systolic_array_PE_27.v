...
module gemm_systolic_array_PE_27 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [31:0] A_fifo_2_3_read_reg_155;
reg    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_state6_pp0_stage1_iter1;
wire    ap_block_state10_pp0_stage1_iter2;
reg    ap_block_pp0_stage1_11001;
reg   [31:0] B_fifo_3_2_read_reg_160;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_fifo_2_3_read_reg_155 <= A_fifo_2_3_dout;
        B_fifo_3_2_read_reg_160 <= B_fifo_3_2_dout;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        if (((ap_enable_reg_pp0_iter1 == 1'b1) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
            ap_sig_allocacmp_C_out_out_0_load_80 = 32'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            ap_sig_allocacmp_C_out_out_0_load_80 = grp_fu_78_p2;
        end else begin
            ap_sig_allocacmp_C_out_out_0_load_80 = C_out_out_0_fu_46;
        end
    end else begin
        ap_sig_allocacmp_C_out_out_0_load_80 = C_out_out_0_fu_46;
    end
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_3_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_4_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_2_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_3_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_3_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_4_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_2_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_3_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_3_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_4_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_2_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_3_empty_n))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_3_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_4_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_3_2_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_2_3_empty_n)));
end
...
assign grp_fu_82_p0 = A_fifo_2_3_read_reg_155;

assign grp_fu_82_p1 = B_fifo_3_2_read_reg_160;

assign icmp_ln7_fu_99_p2 = ((ap_sig_allocacmp_k == 10'd768) ? 1'b1 : 1'b0);

assign k_86_fu_105_p2 = (ap_sig_allocacmp_k + 10'd1);

assign start_out = real_start;

endmodule //gemm_systolic_array_PE_27

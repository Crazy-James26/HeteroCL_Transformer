set moduleName systolic_array_Loop_VITIS_LOOP_60_6_proc317
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {systolic_array_Loop_VITIS_LOOP_60_6_proc317}
...
set portList { 
	...
	{ block_C_drainer_3_din sc_out sc_lv 32 signal 12 } 
	{ block_C_drainer_3_num_data_valid sc_in sc_lv 2 signal 12 } 
	{ block_C_drainer_3_fifo_cap sc_in sc_lv 2 signal 12 } 
	{ block_C_drainer_3_full_n sc_in sc_logic 1 signal 12 } 
	{ block_C_drainer_3_write sc_out sc_logic 1 signal 12 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "13", "DependentChanType" : "1"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "12", "DependentChanType" : "1"},
			{"Name" : "p_read2", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "11", "DependentChanType" : "1"},
			{"Name" : "p_read3", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "10", "DependentChanType" : "1"},
			{"Name" : "p_read4", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "1"},
			{"Name" : "p_read5", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "1"},
			{"Name" : "p_read6", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "7", "DependentChanType" : "1"},
			{"Name" : "p_read7", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "1"},
			{"Name" : "p_read8", "Type" : "None", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "1"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_124_32_1_1_U1092", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	block_C_drainer_3 { ap_fifo {  { block_C_drainer_3_din fifo_port_we 1 32 }  { block_C_drainer_3_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_3_fifo_cap fifo_update 0 2 }  { block_C_drainer_3_full_n fifo_status 0 1 }  { block_C_drainer_3_write fifo_data 1 1 } } }
}

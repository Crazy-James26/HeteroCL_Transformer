...
module gemm_systolic_array_PE_113 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_out;
output   start_write;
input  [31:0] A_fifo_9_5_dout;
input  [1:0] A_fifo_9_5_num_data_valid;
input  [1:0] A_fifo_9_5_fifo_cap;
input   A_fifo_9_5_empty_n;
output   A_fifo_9_5_read;
output  [31:0] A_fifo_9_6_din;
input  [1:0] A_fifo_9_6_num_data_valid;
input  [1:0] A_fifo_9_6_fifo_cap;
input   A_fifo_9_6_full_n;
output   A_fifo_9_6_write;
input  [31:0] B_fifo_5_9_dout;
input  [1:0] B_fifo_5_9_num_data_valid;
input  [1:0] B_fifo_5_9_fifo_cap;
input   B_fifo_5_9_empty_n;
output   B_fifo_5_9_read;
output  [31:0] B_fifo_5_10_din;
input  [1:0] B_fifo_5_10_num_data_valid;
input  [1:0] B_fifo_5_10_fifo_cap;
input   B_fifo_5_10_full_n;
output   B_fifo_5_10_write;
output  [31:0] ap_return;

reg ap_idle;
reg start_write;
reg A_fifo_9_5_read;
reg A_fifo_9_6_write;
reg B_fifo_5_9_read;
reg B_fifo_5_10_write;
reg[31:0] ap_return;
...
reg   [31:0] A_fifo_9_5_read_reg_155;
reg    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_state6_pp0_stage1_iter1;
wire    ap_block_state10_pp0_stage1_iter2;
reg    ap_block_pp0_stage1_11001;
reg   [31:0] B_fifo_5_9_read_reg_160;
...
reg   [31:0] ap_sig_allocacmp_C_out_out_0_load_127;
...
gemm_systolic_array_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U839(
    .clk(ap_clk),
    .reset(ap_rst),
...
gemm_systolic_array_fmul_32ns_32ns_32_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fmul_32ns_32ns_32_4_max_dsp_1_U840(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_82_p0),
    .din1(grp_fu_82_p1),
...
always @ (*) begin
    if (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_fifo_9_5_read = 1'b1;
    end else begin
        A_fifo_9_5_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_fifo_9_6_write = 1'b1;
    end else begin
        A_fifo_9_6_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        B_fifo_5_10_write = 1'b1;
    end else begin
        B_fifo_5_10_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        B_fifo_5_9_read = 1'b1;
    end else begin
        B_fifo_5_9_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        if (((ap_enable_reg_pp0_iter1 == 1'b1) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
            ap_sig_allocacmp_C_out_out_0_load_127 = 32'd0;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
...
assign A_fifo_9_6_din = A_fifo_9_5_dout;

assign B_fifo_5_10_din = B_fifo_5_9_dout;
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_10_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_6_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_9_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_5_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_10_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_6_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_9_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_5_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_10_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_6_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_9_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_5_empty_n))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_10_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_6_full_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == B_fifo_5_9_empty_n)) | ((icmp_ln7_reg_151 == 1'd0) & (1'b0 == A_fifo_9_5_empty_n)));
end
...
assign grp_fu_82_p0 = A_fifo_9_5_read_reg_155;

assign grp_fu_82_p1 = B_fifo_5_9_read_reg_160;

assign icmp_ln7_fu_99_p2 = ((ap_sig_allocacmp_k == 10'd768) ? 1'b1 : 1'b0);

assign k_133_fu_105_p2 = (ap_sig_allocacmp_k + 10'd1);

assign start_out = real_start;

endmodule //gemm_systolic_array_PE_113

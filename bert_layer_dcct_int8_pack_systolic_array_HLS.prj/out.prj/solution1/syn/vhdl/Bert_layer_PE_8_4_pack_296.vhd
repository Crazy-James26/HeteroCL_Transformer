...
entity Bert_layer_PE_8_4_pack_296 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_PE_8_4_pack_296 is 
...
attribute shreg_extract : string;
    ...
    signal k_451_fu_112_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal ap_sig_allocacmp_C_out_out_0_load_422 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal trunc_ln674_390_fu_167_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_403_fu_170_p5 : STD_LOGIC_VECTOR (36 downto 0);
...
begin
    mul_mul_17s_8s_25_4_1_U4037 : component Bert_layer_mul_mul_17s_8s_25_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 17,
    ...
    ap_return_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln7_reg_222_pp0_iter2_reg, ap_sig_allocacmp_C_out_out_0_load_422, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln7_reg_222_pp0_iter2_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_C_out_out_0_load_422_assign_proc : process(ap_enable_reg_pp0_iter4, ap_block_pp0_stage0, C_out_out_0_fu_66, add_ln886_fu_186_p2)
    begin
    ...
    k_451_fu_112_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k) + unsigned(ap_const_lv10_1));
    ...
    tmp_403_fu_170_p5 <= (((ap_const_lv1_0 & tmp_s_fu_158_p4) & ap_const_lv12_0) & trunc_ln674_390_fu_167_p1);
    tmp_s_fu_158_p4 <= grp_fu_200_p2(24 downto 13);
    trunc_ln674_390_fu_167_p1 <= grp_fu_200_p2(12 - 1 downto 0);
    trunc_ln674_fu_133_p1 <= B_fifo_10_9_dout(4 - 1 downto 0);
    zext_ln886_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_403_fu_170_p5),48));
end behav;

...
module Bert_layer_systolic_array_k_64_Loop_data_drain_C_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [23:0] tmp_81_i_fu_236_p6;
reg   [23:0] tmp_81_i_reg_298;
wire   [23:0] tmp_82_i_fu_250_p6;
reg   [23:0] tmp_82_i_reg_303;
wire   [23:0] tmp_83_i_fu_264_p6;
reg   [23:0] tmp_83_i_reg_308;
reg   [2:0] n_fu_74;
wire   [2:0] add_ln177_fu_216_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_n_4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_133)) begin
        if ((icmp_ln177_fu_210_p2 == 1'd0)) begin
            n_fu_74 <= add_ln177_fu_216_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln177_fu_210_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_81_i_reg_298 <= tmp_81_i_fu_236_p6;
        tmp_82_i_reg_303 <= tmp_82_i_fu_250_p6;
        tmp_83_i_reg_308 <= tmp_83_i_fu_264_p6;
        tmp_i_reg_293 <= tmp_i_fu_222_p6;
    end
end

always @ (*) begin
    if (((icmp_ln177_fu_210_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln177_fu_216_p2 = (ap_sig_allocacmp_n_4 + 3'd1);
...
assign block_C_drainer_1_din = tmp_81_i_reg_298;

assign block_C_drainer_2_din = tmp_82_i_reg_303;

assign block_C_drainer_3_din = tmp_83_i_reg_308;

assign icmp_ln177_fu_210_p2 = ((ap_sig_allocacmp_n_4 == 3'd4) ? 1'b1 : 1'b0);

endmodule //Bert_layer_systolic_array_k_64_Loop_data_drain_C_proc

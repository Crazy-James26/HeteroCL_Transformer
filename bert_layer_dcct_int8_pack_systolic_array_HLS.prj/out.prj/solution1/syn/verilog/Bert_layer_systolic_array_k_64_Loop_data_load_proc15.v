...
module Bert_layer_systolic_array_k_64_Loop_data_load_proc15 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [7:0] tmp_70_reg_212;
reg   [7:0] tmp_71_reg_217;
reg   [7:0] tmp_72_reg_222;
reg   [7:0] tmp_73_reg_227;
reg   [7:0] tmp_74_reg_232;
reg   [7:0] tmp_75_reg_237;
reg   [7:0] tmp_76_reg_242;
reg   [6:0] k_fu_64;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_259)) begin
        if ((icmp_ln149_fu_180_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln149_fu_180_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_70_reg_212 <= block_A_loader_1_dout;
        tmp_71_reg_217 <= block_A_loader_2_dout;
        tmp_72_reg_222 <= block_A_loader_3_dout;
        tmp_73_reg_227 <= block_B_loader_0_dout;
        tmp_74_reg_232 <= block_B_loader_1_dout;
        tmp_75_reg_237 <= block_B_loader_2_dout;
        tmp_76_reg_242 <= block_B_loader_3_dout;
...
always @ (*) begin
    if (((icmp_ln149_fu_180_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln149_fu_180_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0))) begin
...
always @ (*) begin
    if (((icmp_ln149_fu_180_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign A_fifo_0_0_din = tmp_reg_207;

assign A_fifo_1_0_din = tmp_70_reg_212;

assign A_fifo_2_0_din = tmp_71_reg_217;

assign A_fifo_3_0_din = tmp_72_reg_222;

assign B_fifo_0_0_din = tmp_73_reg_227;

assign B_fifo_1_0_din = tmp_74_reg_232;

assign B_fifo_2_0_din = tmp_75_reg_237;

assign B_fifo_3_0_din = tmp_76_reg_242;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b0 == B_fifo_3_0_full_n) | (1'b0 == B_fifo_2_0_full_n) | (1'b0 == B_fifo_1_0_full_n) | (1'b0 == B_fifo_0_0_full_n) | (1'b0 == A_fifo_3_0_full_n) | (1'b0 == A_fifo_2_0_full_n) | (1'b0 == A_fifo_1_0_full_n) | (1'b0 == A_fifo_0_0_full_n))) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((block_B_loader_2_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_B_loader_1_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_B_loader_0_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((icmp_ln149_fu_180_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln149_fu_180_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((block_B_loader_2_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_B_loader_1_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_B_loader_0_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln149_fu_180_p2 == 1'd0)) | ((icmp_ln149_fu_180_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln149_fu_180_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)));
end
...
assign icmp_ln149_fu_180_p2 = ((ap_sig_allocacmp_k_12 == 7'd64) ? 1'b1 : 1'b0);

assign k_13_fu_186_p2 = (ap_sig_allocacmp_k_12 + 7'd1);

assign start_out = real_start;

endmodule //Bert_layer_systolic_array_k_64_Loop_data_load_proc15

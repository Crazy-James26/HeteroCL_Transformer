set moduleName VITIS_LOOP_86_4_proc_Pipeline_VITIS_LOOP_86_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {VITIS_LOOP_86_4_proc_Pipeline_VITIS_LOOP_86_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_0 int 24 regular {array 36 { 0 1 } 1 1 }  }
	{ block_C_drainer_09 int 24 regular {fifo 0 volatile }  }
	{ tmp int 4 regular  }
	{ sub_ln886 int 6 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_0", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "block_C_drainer_09", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ block_C_drainer_09_dout sc_in sc_lv 24 signal 1 } 
	{ block_C_drainer_09_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ block_C_drainer_09_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ block_C_drainer_09_empty_n sc_in sc_logic 1 signal 1 } 
	{ block_C_drainer_09_read sc_out sc_logic 1 signal 1 } 
	...
	{ C_0_address1 sc_out sc_lv 6 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_drainer_09_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "block_C_drainer_09", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	C_0 { ap_memory {  { C_0_address0 mem_address 1 6 }  { C_0_ce0 mem_ce 1 1 }  { C_0_we0 mem_we 1 1 }  { C_0_d0 mem_din 1 24 }  { C_0_address1 MemPortADDR2 1 6 }  { C_0_ce1 MemPortCE2 1 1 }  { C_0_q1 in_data 0 24 } } }
	block_C_drainer_09 { ap_fifo {  { block_C_drainer_09_dout fifo_port_we 0 24 }  { block_C_drainer_09_num_data_valid fifo_status_num_data_valid 0 2 }  { block_C_drainer_09_fifo_cap fifo_update 0 2 }  { block_C_drainer_09_empty_n fifo_status 0 1 }  { block_C_drainer_09_read fifo_data 1 1 } } }

...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_fifo_3_6_dout { I 8 vector } B_fifo_3_6_num_data_valid { I 2 vector } B_fifo_3_6_fifo_cap { I 2 vector } B_fifo_3_6_empty_n { I 1 bit } B_fifo_3_6_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { B_fifo_3_7_din { O 8 vector } B_fifo_3_7_num_data_valid { I 2 vector } B_fifo_3_7_fifo_cap { I 2 vector } B_fifo_3_7_full_n { I 1 bit } B_fifo_3_7_write { O 1 bit } } \
} "
}

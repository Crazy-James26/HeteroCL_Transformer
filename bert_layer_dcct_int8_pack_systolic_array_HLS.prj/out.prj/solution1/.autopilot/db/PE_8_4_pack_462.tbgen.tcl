set moduleName PE_8_4_pack_462
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {PE_8_4_pack.462}
set C_modelType { int 48 }
set C_modelArgList {
	{ A_fifo_11_8 int 8 regular {fifo 0 volatile }  }
	{ A_fifo_11_9 int 8 regular {fifo 1 volatile }  }
	{ B_fifo_8_11 int 8 regular {fifo 0 volatile }  }
	{ B_fifo_8_12 int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_fifo_11_8", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "A_fifo_11_9", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_fifo_8_11", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "B_fifo_8_12", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ A_fifo_11_8_dout sc_in sc_lv 8 signal 0 } 
	...
	{ B_fifo_8_11_dout sc_in sc_lv 8 signal 2 } 
	...
	{ A_fifo_11_9_din sc_out sc_lv 8 signal 1 } 
	...
	{ B_fifo_8_12_din sc_out sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_fifo_11_8_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "A_fifo_11_8", "role": "dout" }} , 
 	...
 	{ "name": "B_fifo_8_11_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "B_fifo_8_11", "role": "dout" }} , 
 	...
 	{ "name": "A_fifo_11_9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "A_fifo_11_9", "role": "din" }} , 
 	...
 	{ "name": "B_fifo_8_12_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "B_fifo_8_12", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_17s_8s_25_4_1_U6569", "Parent" : "0"},
...
set Spec2ImplPortList { 
	A_fifo_11_8 { ap_fifo {  { A_fifo_11_8_dout fifo_port_we 0 8 }  { A_fifo_11_8_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_11_8_fifo_cap fifo_update 0 2 }  { A_fifo_11_8_empty_n fifo_status 0 1 }  { A_fifo_11_8_read fifo_data 1 1 } } }
	A_fifo_11_9 { ap_fifo {  { A_fifo_11_9_din fifo_port_we 1 8 }  { A_fifo_11_9_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_11_9_fifo_cap fifo_update 0 2 }  { A_fifo_11_9_full_n fifo_status 0 1 }  { A_fifo_11_9_write fifo_data 1 1 } } }
	B_fifo_8_11 { ap_fifo {  { B_fifo_8_11_dout fifo_port_we 0 8 }  { B_fifo_8_11_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_8_11_fifo_cap fifo_update 0 2 }  { B_fifo_8_11_empty_n fifo_status 0 1 }  { B_fifo_8_11_read fifo_data 1 1 } } }
	B_fifo_8_12 { ap_fifo {  { B_fifo_8_12_din fifo_port_we 1 8 }  { B_fifo_8_12_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_8_12_fifo_cap fifo_update 0 2 }  { B_fifo_8_12_full_n fifo_status 0 1 }  { B_fifo_8_12_write fifo_data 1 1 } } }
}

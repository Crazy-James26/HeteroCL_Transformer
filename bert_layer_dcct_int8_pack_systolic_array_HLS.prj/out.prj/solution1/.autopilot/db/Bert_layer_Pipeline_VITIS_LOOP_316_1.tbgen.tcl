set moduleName Bert_layer_Pipeline_VITIS_LOOP_316_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_VITIS_LOOP_316_1}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "Bert_layer_Pipeline_VITIS_LOOP_316_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_316_1", "PipelineType" : "NotSupport"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Bert_layer_Pipeline_VITIS_LOOP_316_1 {

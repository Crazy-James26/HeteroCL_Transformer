...
entity Bert_layer_systolic_array_k_768_3_Loop_data_drain_AB_proc22 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    B_fifo_0_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_1_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_2_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_3_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_4_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_5_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_6_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_7_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_8_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_9_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_10_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    ...
    B_fifo_11_12_dout : IN STD_LOGIC_VECTOR (7 downto 0);
...
architecture behav of Bert_layer_systolic_array_k_768_3_Loop_data_drain_AB_proc22 is 
...
attribute shreg_extract : string;
    ...
    signal k_2_fu_78 : STD_LOGIC_VECTOR (9 downto 0);
    signal k_7_fu_240_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    k_2_fu_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_285)) then
                if ((icmp_ln65_fu_234_p2 = ap_const_lv1_0)) then 
                    k_2_fu_78 <= k_7_fu_240_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    k_2_fu_78 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln65_fu_234_p2, ap_start_int)
    begin
        if (((icmp_ln65_fu_234_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_k_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, k_2_fu_78, ap_loop_init, ap_start_int)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ...
            ap_sig_allocacmp_k <= k_2_fu_78;
        end if; 
    end process;

    icmp_ln65_fu_234_p2 <= "1" when (ap_sig_allocacmp_k = ap_const_lv10_300) else "0";
    k_7_fu_240_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k) + unsigned(ap_const_lv10_1));
end behav;

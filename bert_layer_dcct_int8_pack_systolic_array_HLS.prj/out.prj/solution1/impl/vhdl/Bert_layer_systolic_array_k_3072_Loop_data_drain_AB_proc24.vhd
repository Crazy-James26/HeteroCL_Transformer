...
attribute shreg_extract : string;
    ...
    signal icmp_ln116_fu_234_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_285)) then
                if ((icmp_ln116_fu_234_p2 = ap_const_lv1_0)) then 
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln116_fu_234_p2, ap_start_int)
    begin
        if (((icmp_ln116_fu_234_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln116_fu_234_p2 <= "1" when (ap_sig_allocacmp_k_18 = ap_const_lv12_C00) else "0";

...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_141)) begin
        if ((icmp_ln218_fu_106_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln218_fu_106_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign icmp_ln218_fu_106_p2 = ((ap_sig_allocacmp_k_22 == 4'd12) ? 1'b1 : 1'b0);

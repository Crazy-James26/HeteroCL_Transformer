...
reg   [7:0] tmp_100_reg_212;
reg   [7:0] tmp_101_reg_217;
reg   [7:0] tmp_102_reg_222;
reg   [7:0] tmp_103_reg_227;
reg   [7:0] tmp_104_reg_232;
reg   [7:0] tmp_105_reg_237;
reg   [7:0] tmp_106_reg_242;
reg   [3:0] k_fu_64;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_259)) begin
        if ((icmp_ln200_fu_180_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln200_fu_180_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln200_fu_180_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln200_fu_180_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0))) begin
...
always @ (*) begin
    if (((icmp_ln200_fu_180_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign A_fifo_1_0_din = tmp_100_reg_212;

assign A_fifo_2_0_din = tmp_101_reg_217;

assign A_fifo_3_0_din = tmp_102_reg_222;

assign B_fifo_0_0_din = tmp_103_reg_227;

assign B_fifo_1_0_din = tmp_104_reg_232;

assign B_fifo_2_0_din = tmp_105_reg_237;

assign B_fifo_3_0_din = tmp_106_reg_242;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b0 == B_fifo_3_0_full_n) | (1'b0 == B_fifo_2_0_full_n) | (1'b0 == B_fifo_1_0_full_n) | (1'b0 == B_fifo_0_0_full_n) | (1'b0 == A_fifo_3_0_full_n) | (1'b0 == A_fifo_2_0_full_n) | (1'b0 == A_fifo_1_0_full_n) | (1'b0 == A_fifo_0_0_full_n))) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((block_B_loader_2_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_B_loader_1_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_B_loader_0_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((icmp_ln200_fu_180_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln200_fu_180_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((block_B_loader_2_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_B_loader_1_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_B_loader_0_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln200_fu_180_p2 == 1'd0)) | ((icmp_ln200_fu_180_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln200_fu_180_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)));
end
...
assign icmp_ln200_fu_180_p2 = ((ap_sig_allocacmp_k_20 == 4'd12) ? 1'b1 : 1'b0);

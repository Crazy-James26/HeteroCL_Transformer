...
module Bert_layer_PE_8_4_pack_128 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [11:0] trunc_ln674_544_fu_167_p1;
wire   [36:0] tmp_557_fu_170_p5;
...
assign k_605_fu_112_p2 = (ap_sig_allocacmp_k + 10'd1);
...
assign tmp_557_fu_170_p5 = {{{{{{1'd0}, {tmp_s_fu_158_p4}}}, {12'd0}}}, {trunc_ln674_544_fu_167_p1}};

assign tmp_s_fu_158_p4 = {{grp_fu_200_p2[24:13]}};

assign trunc_ln674_544_fu_167_p1 = grp_fu_200_p2[11:0];

assign trunc_ln674_fu_133_p1 = B_fifo_5_10_dout[3:0];

assign zext_ln886_fu_182_p1 = tmp_557_fu_170_p5;

endmodule //Bert_layer_PE_8_4_pack_128

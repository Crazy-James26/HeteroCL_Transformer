...
module Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc24 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_285)) begin
        if ((icmp_ln116_fu_234_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln116_fu_234_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign icmp_ln116_fu_234_p2 = ((ap_sig_allocacmp_k_18 == 12'd3072) ? 1'b1 : 1'b0);

assign k_19_fu_240_p2 = (ap_sig_allocacmp_k_18 + 12'd1);

endmodule //Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc24

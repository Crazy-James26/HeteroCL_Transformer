...
reg   [7:0] tmp_77_reg_484;
reg   [7:0] tmp_78_reg_489;
reg   [7:0] tmp_79_reg_494;
reg   [7:0] tmp_80_reg_499;
reg   [7:0] tmp_81_reg_504;
reg   [7:0] tmp_82_reg_509;
reg   [7:0] tmp_83_reg_514;
reg   [7:0] tmp_84_reg_519;
reg   [7:0] tmp_85_reg_524;
reg   [7:0] tmp_86_reg_529;
reg   [7:0] tmp_87_reg_534;
reg   [7:0] tmp_88_reg_539;
reg   [7:0] tmp_89_reg_544;
reg   [7:0] tmp_90_reg_549;
reg   [7:0] tmp_91_reg_554;
reg   [7:0] tmp_92_reg_559;
reg   [7:0] tmp_93_reg_564;
reg   [7:0] tmp_94_reg_569;
reg   [7:0] tmp_95_reg_574;
reg   [7:0] tmp_96_reg_579;
reg   [7:0] tmp_97_reg_584;
reg   [7:0] tmp_98_reg_589;
reg   [7:0] tmp_99_reg_594;
reg   [11:0] k_fu_128;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_595)) begin
        if ((icmp_ln98_fu_452_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln98_fu_452_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_77_reg_484 <= block_A_loader_1_dout;
        tmp_78_reg_489 <= block_A_loader_2_dout;
        tmp_79_reg_494 <= block_A_loader_3_dout;
        tmp_80_reg_499 <= block_A_loader_4_dout;
        tmp_81_reg_504 <= block_A_loader_5_dout;
        tmp_82_reg_509 <= block_A_loader_6_dout;
        tmp_83_reg_514 <= block_A_loader_7_dout;
        tmp_84_reg_519 <= block_A_loader_8_dout;
        tmp_85_reg_524 <= block_A_loader_9_dout;
        tmp_86_reg_529 <= block_A_loader_10_dout;
        tmp_87_reg_534 <= block_A_loader_11_dout;
        tmp_88_reg_539 <= block_B_loader_0_dout;
        tmp_89_reg_544 <= block_B_loader_1_dout;
        tmp_90_reg_549 <= block_B_loader_2_dout;
        tmp_91_reg_554 <= block_B_loader_3_dout;
        tmp_92_reg_559 <= block_B_loader_4_dout;
        tmp_93_reg_564 <= block_B_loader_5_dout;
        tmp_94_reg_569 <= block_B_loader_6_dout;
        tmp_95_reg_574 <= block_B_loader_7_dout;
        tmp_96_reg_579 <= block_B_loader_8_dout;
        tmp_97_reg_584 <= block_B_loader_9_dout;
        tmp_98_reg_589 <= block_B_loader_10_dout;
        tmp_99_reg_594 <= block_B_loader_11_dout;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln98_fu_452_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln98_fu_452_p2 == 1'd0) & (ap_start_int == 1'b1) & (ap_done_reg == 1'b0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln98_fu_452_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign A_fifo_10_0_din = tmp_86_reg_529;

assign A_fifo_11_0_din = tmp_87_reg_534;

assign A_fifo_1_0_din = tmp_77_reg_484;

assign A_fifo_2_0_din = tmp_78_reg_489;

assign A_fifo_3_0_din = tmp_79_reg_494;

assign A_fifo_4_0_din = tmp_80_reg_499;

assign A_fifo_5_0_din = tmp_81_reg_504;

assign A_fifo_6_0_din = tmp_82_reg_509;

assign A_fifo_7_0_din = tmp_83_reg_514;

assign A_fifo_8_0_din = tmp_84_reg_519;

assign A_fifo_9_0_din = tmp_85_reg_524;

assign B_fifo_0_0_din = tmp_88_reg_539;

assign B_fifo_10_0_din = tmp_98_reg_589;

assign B_fifo_11_0_din = tmp_99_reg_594;

assign B_fifo_1_0_din = tmp_89_reg_544;

assign B_fifo_2_0_din = tmp_90_reg_549;

assign B_fifo_3_0_din = tmp_91_reg_554;

assign B_fifo_4_0_din = tmp_92_reg_559;

assign B_fifo_5_0_din = tmp_93_reg_564;

assign B_fifo_6_0_din = tmp_94_reg_569;

assign B_fifo_7_0_din = tmp_95_reg_574;

assign B_fifo_8_0_din = tmp_96_reg_579;

assign B_fifo_9_0_din = tmp_97_reg_584;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b0 == B_fifo_11_0_full_n) | (1'b0 == B_fifo_10_0_full_n) | (1'b0 == B_fifo_9_0_full_n) | (1'b0 == B_fifo_8_0_full_n) | (1'b0 == B_fifo_7_0_full_n) | (1'b0 == B_fifo_6_0_full_n) | (1'b0 == B_fifo_5_0_full_n) | (1'b0 == B_fifo_4_0_full_n) | (1'b0 == B_fifo_3_0_full_n) | (1'b0 == B_fifo_2_0_full_n) | (1'b0 == B_fifo_1_0_full_n) | (1'b0 == B_fifo_0_0_full_n) | (1'b0 == A_fifo_11_0_full_n) | (1'b0 == A_fifo_10_0_full_n) | (1'b0 == A_fifo_9_0_full_n) | (1'b0 == A_fifo_8_0_full_n) | (1'b0 == A_fifo_7_0_full_n) | (1'b0 == A_fifo_6_0_full_n) | (1'b0 == A_fifo_5_0_full_n) | (1'b0 == A_fifo_4_0_full_n) | (1'b0 == A_fifo_3_0_full_n) | (1'b0 == A_fifo_2_0_full_n) | (1'b0 == A_fifo_1_0_full_n) | (1'b0 == A_fifo_0_0_full_n))) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((block_A_loader_6_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((block_A_loader_5_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((block_A_loader_4_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((block_A_loader_3_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((block_A_loader_2_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((block_A_loader_1_empty_n == 1'b0) & (icmp_ln98_fu_452_p2 == 1'd0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_0_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_11_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_10_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_9_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_8_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_7_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_6_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_5_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_4_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_3_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_2_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_1_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_B_loader_0_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_11_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_10_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_9_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_8_empty_n == 1'b0)) | ((icmp_ln98_fu_452_p2 == 1'd0) & (block_A_loader_7_empty_n == 1'b0)))));
end
...
assign icmp_ln98_fu_452_p2 = ((ap_sig_allocacmp_k_16 == 12'd3072) ? 1'b1 : 1'b0);

...
void Bert_layer(
  ...
  #pragma HLS array_partition variable=buf17 complete
  #pragma HLS array_partition variable=buf18 complete
  #pragma HLS array_partition variable=buf19 complete
  #pragma HLS array_partition variable=buf20 complete
  #pragma HLS array_partition variable=buf21 complete
  #pragma HLS array_partition variable=buf22 complete
  #pragma HLS array_partition variable=buf23 complete
  #pragma HLS array_partition variable=buf24 complete
  #pragma HLS array_partition variable=buf25 complete
  #pragma HLS array_partition variable=buf26 complete
  #pragma HLS array_partition variable=buf27 complete
  #pragma HLS array_partition variable=buf28 complete

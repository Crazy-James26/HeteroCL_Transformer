...
module gemm_systolic_array_Block_entry_proc_proc162 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    jj_blk_n;
reg   [5:0] C_1_3_addr_reg_74;
reg   [31:0] C_1_3_load_reg_79;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_state3;
wire   [31:0] grp_fu_57_p2;
reg   [31:0] add96_1_3_i_i_reg_94;
...
gemm_systolic_array_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U3282(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_57_p0),
    .din1(block_C_1558),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        C_1_3_addr_reg_74 <= zext_ln20_fu_61_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        C_1_3_load_reg_79 <= C_1_3_q0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        add96_1_3_i_i_reg_94 <= grp_fu_57_p2;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        C_1_3_address0 = C_1_3_addr_reg_74;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        C_1_3_address0 = zext_ln20_fu_61_p1;
    end else begin
        C_1_3_address0 = 'bx;
    end
end
...
assign C_1_3_d0 = add96_1_3_i_i_reg_94;
...
assign grp_fu_57_p0 = C_1_3_load_reg_79;

assign zext_ln20_fu_61_p1 = jj_dout;

endmodule //gemm_systolic_array_Block_entry_proc_proc162

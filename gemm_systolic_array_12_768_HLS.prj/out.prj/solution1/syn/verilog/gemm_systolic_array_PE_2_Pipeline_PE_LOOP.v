...
module gemm_systolic_array_PE_2_Pipeline_PE_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] A_fifo_0_2_read_reg_175;
reg    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_state6_pp0_stage1_iter1;
wire    ap_block_state10_pp0_stage1_iter2;
reg    ap_block_pp0_stage1_11001;
reg   [31:0] B_fifo_2_0_read_reg_180;
...
gemm_systolic_array_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U441(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln8_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        A_fifo_0_2_read_reg_175 <= A_fifo_0_2_dout;
        B_fifo_2_0_read_reg_180 <= B_fifo_2_0_dout;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_1_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_3_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_0_empty_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_2_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_1_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_3_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_0_empty_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_2_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_1_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_3_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_0_empty_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_2_empty_n))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = (((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_1_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_3_full_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == B_fifo_2_0_empty_n)) | ((icmp_ln8_reg_171 == 1'd0) & (1'b0 == A_fifo_0_2_empty_n)));
end
...
assign grp_fu_101_p0 = A_fifo_0_2_read_reg_175;

assign grp_fu_101_p1 = B_fifo_2_0_read_reg_180;

assign icmp_ln8_fu_118_p2 = ((ap_sig_allocacmp_k == 10'd768) ? 1'b1 : 1'b0);

assign k_85_fu_124_p2 = (ap_sig_allocacmp_k + 10'd1);

assign p_out = empty_fu_52;

endmodule //gemm_systolic_array_PE_2_Pipeline_PE_LOOP

...
module gemm_systolic_array_systolic_array_Loop_data_load_proc1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] block_A_loader_0_read_reg_479;
reg    ap_block_pp0_stage0_11001;
reg   [31:0] block_A_loader_1_read_reg_484;
reg   [31:0] block_A_loader_2_read_reg_489;
reg   [31:0] block_A_loader_3_read_reg_494;
reg   [31:0] block_A_loader_4_read_reg_499;
reg   [31:0] block_A_loader_5_read_reg_504;
reg   [31:0] block_A_loader_6_read_reg_509;
reg   [31:0] block_A_loader_7_read_reg_514;
reg   [31:0] block_A_loader_8_read_reg_519;
reg   [31:0] block_A_loader_9_read_reg_524;
reg   [31:0] block_A_loader_10_read_reg_529;
reg   [31:0] block_A_loader_11_read_reg_534;
reg   [31:0] block_B_loader_0_read_reg_539;
reg   [31:0] block_B_loader_1_read_reg_544;
reg   [31:0] block_B_loader_2_read_reg_549;
reg   [31:0] block_B_loader_3_read_reg_554;
reg   [31:0] block_B_loader_4_read_reg_559;
reg   [31:0] block_B_loader_5_read_reg_564;
reg   [31:0] block_B_loader_6_read_reg_569;
reg   [31:0] block_B_loader_7_read_reg_574;
reg   [31:0] block_B_loader_8_read_reg_579;
reg   [31:0] block_B_loader_9_read_reg_584;
reg   [31:0] block_B_loader_10_read_reg_589;
reg   [31:0] block_B_loader_11_read_reg_594;
reg   [9:0] k_fu_128;
wire   [9:0] k_2_fu_458_p2;
wire    ap_loop_init;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln31_fu_452_p2 == 1'd0) & (ap_done_reg == 1'b0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_condition_581 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign icmp_ln31_fu_452_p2 = ((ap_sig_allocacmp_k_1 == 10'd768) ? 1'b1 : 1'b0);

assign k_2_fu_458_p2 = (ap_sig_allocacmp_k_1 + 10'd1);

endmodule //gemm_systolic_array_systolic_array_Loop_data_load_proc1

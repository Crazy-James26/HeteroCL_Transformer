...
struct PE118 : public sc_module {
    ...
    // Module declarations
    PE118(sc_module_name name);
    SC_HAS_PROCESS(PE118);

    ~PE118();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U945;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U946;
    ...
    sc_signal< sc_lv<32> > tmp_171_reg_189;

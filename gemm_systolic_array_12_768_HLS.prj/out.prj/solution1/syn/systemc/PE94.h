...
struct PE94 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U777;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U778;
    ...
    sc_signal< sc_lv<32> > tmp_52_reg_189;

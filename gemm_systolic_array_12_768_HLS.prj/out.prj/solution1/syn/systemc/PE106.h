...
struct PE106 : public sc_module {
    ...
    // Module declarations
    PE106(sc_module_name name);
    SC_HAS_PROCESS(PE106);

    ~PE106();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U861;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U862;
    ...
    sc_signal< sc_lv<32> > tmp_183_reg_189;

...
struct PE168 : public sc_module {
    ...
    // Module declarations
    PE168(sc_module_name name);
    SC_HAS_PROCESS(PE168);

    ~PE168();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1295;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1296;
    ...
    sc_signal< sc_lv<32> > tmp_121_reg_189;

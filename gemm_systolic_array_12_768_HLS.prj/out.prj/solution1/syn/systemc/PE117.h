...
struct PE117 : public sc_module {
    ...
    // Module declarations
    PE117(sc_module_name name);
    SC_HAS_PROCESS(PE117);

    ~PE117();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U938;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U939;
    ...
    sc_signal< sc_lv<32> > tmp_172_reg_189;

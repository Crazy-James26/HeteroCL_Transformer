...
struct PE137 : public sc_module {
    ...
    // Module declarations
    PE137(sc_module_name name);
    SC_HAS_PROCESS(PE137);

    ~PE137();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1078;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1079;
    ...
    sc_signal< sc_lv<32> > tmp_152_reg_189;

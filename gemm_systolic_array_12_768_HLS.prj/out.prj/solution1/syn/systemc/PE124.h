...
struct PE124 : public sc_module {
    ...
    // Module declarations
    PE124(sc_module_name name);
    SC_HAS_PROCESS(PE124);

    ~PE124();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U987;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U988;
    ...
    sc_signal< sc_lv<32> > tmp_165_reg_189;

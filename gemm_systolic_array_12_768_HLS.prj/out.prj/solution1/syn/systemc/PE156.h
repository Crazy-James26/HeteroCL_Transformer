...
struct PE156 : public sc_module {
    ...
    // Module declarations
    PE156(sc_module_name name);
    SC_HAS_PROCESS(PE156);

    ~PE156();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1211;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1212;
    ...
    sc_signal< sc_lv<32> > tmp_133_reg_189;

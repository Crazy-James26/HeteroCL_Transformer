...
struct PE157 : public sc_module {
    ...
    // Module declarations
    PE157(sc_module_name name);
    SC_HAS_PROCESS(PE157);

    ~PE157();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1218;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1219;
    ...
    sc_signal< sc_lv<32> > tmp_132_reg_189;

...
struct PE73 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U630;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U631;
    ...
    sc_signal< sc_lv<32> > tmp_73_reg_189;

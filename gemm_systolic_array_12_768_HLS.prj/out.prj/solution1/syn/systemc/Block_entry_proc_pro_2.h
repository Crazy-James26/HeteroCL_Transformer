...
#ifndef _Block_entry_proc_pro_2_HH_
#define _Block_entry_proc_pro_2_HH_
...
struct Block_entry_proc_pro_2 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_2(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_2);

    ~Block_entry_proc_pro_2();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U2328;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<8> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > jj_0_i_0_blk_n;
    sc_signal< sc_lv<6> > C_11_9_addr_reg_61;

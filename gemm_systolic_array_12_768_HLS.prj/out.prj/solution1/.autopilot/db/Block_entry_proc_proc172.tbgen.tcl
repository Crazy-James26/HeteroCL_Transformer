set moduleName Block_entry_proc_proc172
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Block_entry_proc_proc172}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_2_1 int 32 regular {array 64 { 2 3 } 1 1 }  }
	{ jj int 6 regular {fifo 0}  }
	{ block_C_2568 float 32 regular {pointer 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_2_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "jj", "interface" : "fifo", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "block_C_2568", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ C_2_1_address0 sc_out sc_lv 6 signal 0 } 
	{ C_2_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ C_2_1_we0 sc_out sc_logic 1 signal 0 } 
	{ C_2_1_d0 sc_out sc_lv 32 signal 0 } 
	{ C_2_1_q0 sc_in sc_lv 32 signal 0 } 
	...
	{ block_C_2568 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_C_2568", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "block_C_2568", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "Block_entry_proc_proc172",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "block_C_2568", "Type" : "None", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U3322", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	Block_entry_proc_proc172 {
		C_2_1 {Type IO LastRead 0 FirstWrite 7}
		jj {Type I LastRead 0 FirstWrite -1}
		block_C_2568 {Type I LastRead 1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	block_C_2568 { ap_none {  { block_C_2568 in_data 0 32 } } }
}

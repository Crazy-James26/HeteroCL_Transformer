...
void systolic_array(hls::stream<d_type> A_loader[block_M],
     hls::stream<d_type> B_loader[block_N],
     d_type C[block_M][block_N], int k_size) {_ssdm_SpecArrayDimSize(A_loader, 12);_ssdm_SpecArrayDimSize(B_loader, 12);_ssdm_SpecArrayDimSize(C, 12);

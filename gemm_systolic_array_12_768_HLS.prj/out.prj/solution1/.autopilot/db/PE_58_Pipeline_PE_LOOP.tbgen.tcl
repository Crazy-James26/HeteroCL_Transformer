set moduleName PE_58_Pipeline_PE_LOOP
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {PE.58_Pipeline_PE_LOOP}
...
set portList { 
	...
	{ A_fifo_4_10_dout sc_in sc_lv 32 signal 1 } 
	{ A_fifo_4_10_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ A_fifo_4_10_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ A_fifo_4_10_empty_n sc_in sc_logic 1 signal 1 } 
	{ A_fifo_4_10_read sc_out sc_logic 1 signal 1 } 
	...
	{ A_fifo_4_11_din sc_out sc_lv 32 signal 3 } 
	{ A_fifo_4_11_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ A_fifo_4_11_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ A_fifo_4_11_full_n sc_in sc_logic 1 signal 3 } 
	{ A_fifo_4_11_write sc_out sc_logic 1 signal 3 } 
	{ B_fifo_10_5_din sc_out sc_lv 32 signal 4 } 
	{ B_fifo_10_5_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ B_fifo_10_5_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ B_fifo_10_5_full_n sc_in sc_logic 1 signal 4 } 
	{ B_fifo_10_5_write sc_out sc_logic 1 signal 4 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "A_fifo_4_10", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "A_fifo_4_10_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "B_fifo_10_4", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "B_fifo_10_4_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "A_fifo_4_11", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "A_fifo_4_11_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "B_fifo_10_5", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U1225", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U1226", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	PE_58_Pipeline_PE_LOOP {

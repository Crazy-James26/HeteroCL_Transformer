...
set hasInterrupt 0
set C_modelName {PE.19}
set C_modelType { void 0 }
set C_modelArgList {
	{ A_fifo_1_7 int 32 regular {fifo 0 volatile }  }
	{ A_fifo_1_8 int 32 regular {fifo 1 volatile }  }
	{ B_fifo_7_1 int 32 regular {fifo 0 volatile }  }
	{ B_fifo_7_2 int 32 regular {fifo 1 volatile }  }
	{ C_out_in float 32 regular {fifo 0}  }
	{ C_out_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_fifo_1_7", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "A_fifo_1_8", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_fifo_7_1", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "B_fifo_7_2", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ A_fifo_1_7_dout sc_in sc_lv 32 signal 0 } 
	...
	{ A_fifo_1_8_din sc_out sc_lv 32 signal 1 } 
	...
	{ B_fifo_7_1_dout sc_in sc_lv 32 signal 2 } 
	...
	{ B_fifo_7_2_din sc_out sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_fifo_1_7_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "A_fifo_1_7", "role": "dout" }} , 
 	...
 	{ "name": "A_fifo_1_8_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "A_fifo_1_8", "role": "din" }} , 
 	...
 	{ "name": "B_fifo_7_1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_fifo_7_1", "role": "dout" }} , 
 	...
 	{ "name": "B_fifo_7_2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_fifo_7_2", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "A_fifo_1_7", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_19_Pipeline_PE_LOOP_fu_59", "Port" : "A_fifo_1_7", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "A_fifo_1_8", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_19_Pipeline_PE_LOOP_fu_59", "Port" : "A_fifo_1_8", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "B_fifo_7_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_19_Pipeline_PE_LOOP_fu_59", "Port" : "B_fifo_7_1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "B_fifo_7_2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_19_Pipeline_PE_LOOP_fu_59", "Port" : "B_fifo_7_2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_PE_19_Pipeline_PE_LOOP_fu_59", "Parent" : "0", "Child" : ["2", "3", "4"],
		"CDFG" : "PE_19_Pipeline_PE_LOOP",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "A_fifo_1_7", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "A_fifo_1_7_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "B_fifo_7_1", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "B_fifo_7_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "A_fifo_1_8", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "A_fifo_1_8_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "B_fifo_7_2", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_19_Pipeline_PE_LOOP_fu_59.fadd_32ns_32ns_32_5_full_dsp_1_U679", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_19_Pipeline_PE_LOOP_fu_59.fmul_32ns_32ns_32_4_max_dsp_1_U680", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_19_Pipeline_PE_LOOP_fu_59.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	A_fifo_1_7 { ap_fifo {  { A_fifo_1_7_dout fifo_port_we 0 32 }  { A_fifo_1_7_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_1_7_fifo_cap fifo_update 0 2 }  { A_fifo_1_7_empty_n fifo_status 0 1 }  { A_fifo_1_7_read fifo_data 1 1 } } }
	A_fifo_1_8 { ap_fifo {  { A_fifo_1_8_din fifo_port_we 1 32 }  { A_fifo_1_8_num_data_valid fifo_status_num_data_valid 0 2 }  { A_fifo_1_8_fifo_cap fifo_update 0 2 }  { A_fifo_1_8_full_n fifo_status 0 1 }  { A_fifo_1_8_write fifo_data 1 1 } } }
	B_fifo_7_1 { ap_fifo {  { B_fifo_7_1_dout fifo_port_we 0 32 }  { B_fifo_7_1_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_7_1_fifo_cap fifo_update 0 2 }  { B_fifo_7_1_empty_n fifo_status 0 1 }  { B_fifo_7_1_read fifo_data 1 1 } } }
	B_fifo_7_2 { ap_fifo {  { B_fifo_7_2_din fifo_port_we 1 32 }  { B_fifo_7_2_num_data_valid fifo_status_num_data_valid 0 2 }  { B_fifo_7_2_fifo_cap fifo_update 0 2 }  { B_fifo_7_2_full_n fifo_status 0 1 }  { B_fifo_7_2_write fifo_data 1 1 } } }

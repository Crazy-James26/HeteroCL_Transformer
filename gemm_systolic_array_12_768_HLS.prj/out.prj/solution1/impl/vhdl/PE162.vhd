...
architecture behav of PE162 is 
    ...
    signal tmp_127_reg_189 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    gemm_systolic_arrbkb_U1253 : component gemm_systolic_arrbkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    gemm_systolic_arrcud_U1254 : component gemm_systolic_arrcud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,

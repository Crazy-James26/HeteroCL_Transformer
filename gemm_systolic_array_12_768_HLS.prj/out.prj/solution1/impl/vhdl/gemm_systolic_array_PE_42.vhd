...
attribute shreg_extract : string;
    ...
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_done : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_idle : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_ready : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_6_read : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_3_read : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_7_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_7_write : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_4_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_4_write : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_p_out : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_p_out_ap_vld : STD_LOGIC;
    signal grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg : STD_LOGIC := '0';
    ...
    component gemm_systolic_array_PE_42_Pipeline_PE_LOOP IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_PE_42_Pipeline_PE_LOOP_fu_59 : component gemm_systolic_array_PE_42_Pipeline_PE_LOOP
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_ready = ap_const_logic_1)) then 
                    grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, C_out_in_empty_n, grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    A_fifo_3_6_read_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_6_read, ap_CS_fsm_state3)
    begin
    ...
    A_fifo_3_7_write_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_7_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            A_fifo_3_7_write <= grp_PE_42_Pipeline_PE_LOOP_fu_59_A_fifo_3_7_write;
        else 
    ...
    B_fifo_6_3_read_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_3_read, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            B_fifo_6_3_read <= grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_3_read;
        else 
    ...
    B_fifo_6_4_write_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_4_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            B_fifo_6_4_write <= grp_PE_42_Pipeline_PE_LOOP_fu_59_B_fifo_6_4_write;
        else 
    ...
    C_out_out_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_p_out, ap_CS_fsm_state4, C_out_out_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_done)
    begin
        if ((grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_done = ap_const_logic_0)) then 
    ...
    grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start <= grp_PE_42_Pipeline_PE_LOOP_fu_59_ap_start_reg;
end behav;

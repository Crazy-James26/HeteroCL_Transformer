...
struct exp_generic_double_s : public sc_module {
    ...
    Bert_layer_mul_72QgW<1,5,72,13,84>* Bert_layer_mul_72QgW_U109;
    Bert_layer_mul_36Rg6<1,2,36,43,79>* Bert_layer_mul_36Rg6_U110;
    Bert_layer_mul_44Shg<1,2,44,49,93>* Bert_layer_mul_44Shg_U111;
    Bert_layer_mul_50Lf8<1,2,50,50,100>* Bert_layer_mul_50Lf8_U112;
    Bert_layer_mac_muMgi<1,1,16,16,19,31>* Bert_layer_mac_muMgi_U113;

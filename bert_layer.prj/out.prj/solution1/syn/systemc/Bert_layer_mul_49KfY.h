...
// ==============================================================
#ifndef __Bert_layer_mul_49KfY__HH__
#define __Bert_layer_mul_49KfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_49KfY) {
    ...
    SC_CTOR(Bert_layer_mul_49KfY):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {

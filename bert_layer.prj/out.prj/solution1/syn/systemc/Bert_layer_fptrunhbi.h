...
// ==============================================================
#ifndef __Bert_layer_fptrunhbi__HH__
#define __Bert_layer_fptrunhbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fptrunhbi) {
    ...
    SC_CTOR(Bert_layer_fptrunhbi):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

...
entity pow_generic_doublncg_rom is 
    generic(
             DWIDTH     : integer := 105; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of pow_generic_doublncg_rom is 
...
entity pow_generic_doublncg is
    generic (
...
architecture arch of pow_generic_doublncg is
    component pow_generic_doublncg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_doublncg_rom_U :  component pow_generic_doublncg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

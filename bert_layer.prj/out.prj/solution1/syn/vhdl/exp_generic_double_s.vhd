...
architecture behav of exp_generic_double_s is 
    ...
    component Bert_layer_mul_72QgW IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_36Rg6 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component Bert_layer_mul_44Shg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    table_exp_Z1_array_s_U : component pow_generic_doubludo
    generic map (
        DataWidth => 58,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z3_array_V_U : component pow_generic_doublvdy
    generic map (
        DataWidth => 26,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    table_f_Z2_array_V_U : component pow_generic_doublwdI
    generic map (
        DataWidth => 42,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    Bert_layer_mul_72QgW_U109 : component Bert_layer_mul_72QgW
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 72,
    ...
    Bert_layer_mul_36Rg6_U110 : component Bert_layer_mul_36Rg6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 36,
    ...
    Bert_layer_mul_44Shg_U111 : component Bert_layer_mul_44Shg
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 44,
    ...
    Bert_layer_mul_50Lf8_U112 : component Bert_layer_mul_50Lf8
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 50,
    ...
    Bert_layer_mac_muMgi_U113 : component Bert_layer_mac_muMgi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,

...
struct PE158 : public sc_module {
    ...
    // Module declarations
    PE158(sc_module_name name);
    SC_HAS_PROCESS(PE158);

    ~PE158();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1225;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1226;
    ...
    sc_signal< sc_lv<32> > tmp_131_reg_189;

...
struct PE161 : public sc_module {
    ...
    // Module declarations
    PE161(sc_module_name name);
    SC_HAS_PROCESS(PE161);

    ~PE161();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1253;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1254;
    ...
    sc_signal< sc_lv<32> > tmp_128_reg_189;

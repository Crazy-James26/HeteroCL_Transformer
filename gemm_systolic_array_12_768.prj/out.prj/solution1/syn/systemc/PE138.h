...
struct PE138 : public sc_module {
    ...
    // Module declarations
    PE138(sc_module_name name);
    SC_HAS_PROCESS(PE138);

    ~PE138();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1092;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1093;
    ...
    sc_signal< sc_lv<32> > tmp_151_reg_189;

...
struct PE160 : public sc_module {
    ...
    // Module declarations
    PE160(sc_module_name name);
    SC_HAS_PROCESS(PE160);

    ~PE160();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1246;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1247;
    ...
    sc_signal< sc_lv<32> > tmp_129_reg_189;

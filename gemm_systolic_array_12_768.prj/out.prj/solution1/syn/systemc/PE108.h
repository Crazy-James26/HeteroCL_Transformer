...
struct PE108 : public sc_module {
    ...
    // Module declarations
    PE108(sc_module_name name);
    SC_HAS_PROCESS(PE108);

    ~PE108();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U882;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U883;
    ...
    sc_signal< sc_lv<32> > tmp_181_reg_189;

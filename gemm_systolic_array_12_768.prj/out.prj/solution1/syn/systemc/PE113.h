...
struct PE113 : public sc_module {
    ...
    // Module declarations
    PE113(sc_module_name name);
    SC_HAS_PROCESS(PE113);

    ~PE113();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U917;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U918;
    ...
    sc_signal< sc_lv<32> > tmp_176_reg_189;

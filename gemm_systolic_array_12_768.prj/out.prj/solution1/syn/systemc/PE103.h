...
struct PE103 : public sc_module {
    ...
    // Module declarations
    PE103(sc_module_name name);
    SC_HAS_PROCESS(PE103);

    ~PE103();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U847;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U848;
    ...
    sc_signal< sc_lv<32> > tmp_186_reg_189;

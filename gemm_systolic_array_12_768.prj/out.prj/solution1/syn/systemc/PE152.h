...
struct PE152 : public sc_module {
    ...
    // Module declarations
    PE152(sc_module_name name);
    SC_HAS_PROCESS(PE152);

    ~PE152();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1190;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1191;
    ...
    sc_signal< sc_lv<32> > tmp_137_reg_189;

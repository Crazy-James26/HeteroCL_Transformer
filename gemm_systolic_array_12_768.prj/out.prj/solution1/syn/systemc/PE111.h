...
struct PE111 : public sc_module {
    ...
    // Module declarations
    PE111(sc_module_name name);
    SC_HAS_PROCESS(PE111);

    ~PE111();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U903;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U904;
    ...
    sc_signal< sc_lv<32> > tmp_178_reg_189;

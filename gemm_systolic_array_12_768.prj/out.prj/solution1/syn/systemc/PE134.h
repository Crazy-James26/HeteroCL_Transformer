...
struct PE134 : public sc_module {
    ...
    // Module declarations
    PE134(sc_module_name name);
    SC_HAS_PROCESS(PE134);

    ~PE134();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1064;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1065;
    ...
    sc_signal< sc_lv<32> > tmp_155_reg_189;

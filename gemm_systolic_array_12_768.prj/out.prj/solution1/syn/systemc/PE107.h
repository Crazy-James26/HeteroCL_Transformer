...
struct PE107 : public sc_module {
    ...
    // Module declarations
    PE107(sc_module_name name);
    SC_HAS_PROCESS(PE107);

    ~PE107();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U875;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U876;

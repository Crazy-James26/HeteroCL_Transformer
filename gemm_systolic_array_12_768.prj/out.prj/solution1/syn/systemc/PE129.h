...
struct PE129 : public sc_module {
    ...
    // Module declarations
    PE129(sc_module_name name);
    SC_HAS_PROCESS(PE129);

    ~PE129();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1029;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1030;
    ...
    sc_signal< sc_lv<32> > tmp_160_reg_189;

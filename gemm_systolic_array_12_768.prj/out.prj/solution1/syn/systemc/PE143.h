...
struct PE143 : public sc_module {
    ...
    // Module declarations
    PE143(sc_module_name name);
    SC_HAS_PROCESS(PE143);

    ~PE143();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1120;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1121;
    ...
    sc_signal< sc_lv<32> > tmp_146_reg_189;

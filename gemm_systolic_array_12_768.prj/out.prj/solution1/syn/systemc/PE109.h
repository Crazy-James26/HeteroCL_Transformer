...
struct PE109 : public sc_module {
    ...
    // Module declarations
    PE109(sc_module_name name);
    SC_HAS_PROCESS(PE109);

    ~PE109();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U889;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U890;
    ...
    sc_signal< sc_lv<32> > tmp_180_reg_189;

...
struct PE125 : public sc_module {
    ...
    // Module declarations
    PE125(sc_module_name name);
    SC_HAS_PROCESS(PE125);

    ~PE125();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1001;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1002;
    ...
    sc_signal< sc_lv<32> > tmp_164_reg_189;

...
struct PE114 : public sc_module {
    ...
    // Module declarations
    PE114(sc_module_name name);
    SC_HAS_PROCESS(PE114);

    ~PE114();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U924;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U925;
    ...
    sc_signal< sc_lv<32> > tmp_175_reg_189;

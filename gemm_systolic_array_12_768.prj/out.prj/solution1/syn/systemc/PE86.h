...
struct PE86 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U728;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U729;
    ...
    sc_signal< sc_lv<32> > tmp_60_reg_189;

...
struct PE150 : public sc_module {
    ...
    // Module declarations
    PE150(sc_module_name name);
    SC_HAS_PROCESS(PE150);

    ~PE150();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1176;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1177;
    ...
    sc_signal< sc_lv<32> > tmp_139_reg_189;

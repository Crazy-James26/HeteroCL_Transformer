...
struct PE171 : public sc_module {
    ...
    // Module declarations
    PE171(sc_module_name name);
    SC_HAS_PROCESS(PE171);

    ~PE171();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1316;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1317;
    ...
    sc_signal< sc_lv<32> > tmp_118_reg_189;

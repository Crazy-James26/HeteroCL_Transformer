...
#include "gemm_systolic_arrcud.h"

namespace ap_rtl {

struct PE179 : public sc_module {
    ...
    // Module declarations
    PE179(sc_module_name name);
    SC_HAS_PROCESS(PE179);

    ~PE179();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1372;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1373;
    ...
    sc_signal< sc_lv<1> > icmp_ln8_reg_174;

...
PE81::PE81(sc_module_name name) : sc_module(name), mVcdFile(0) {
    gemm_systolic_arrbkb_U693 = new gemm_systolic_arrbkb<1,5,32,32,32>("gemm_systolic_arrbkb_U693");
    gemm_systolic_arrbkb_U693->clk(ap_clk);
    gemm_systolic_arrbkb_U693->reset(ap_rst);
    gemm_systolic_arrbkb_U693->din0(C_out_i);
    gemm_systolic_arrbkb_U693->din1(tmp_s_reg_195);
    gemm_systolic_arrbkb_U693->ce(grp_fu_150_ce);
    gemm_systolic_arrbkb_U693->dout(grp_fu_150_p2);
    gemm_systolic_arrcud_U694 = new gemm_systolic_arrcud<1,4,32,32,32>("gemm_systolic_arrcud_U694");
    gemm_systolic_arrcud_U694->clk(ap_clk);
    gemm_systolic_arrcud_U694->reset(ap_rst);
    gemm_systolic_arrcud_U694->din0(A_in_V_dout);
    gemm_systolic_arrcud_U694->din1(B_in_V_dout);
    gemm_systolic_arrcud_U694->ce(grp_fu_156_ce);
    gemm_systolic_arrcud_U694->dout(grp_fu_156_p2);
...
PE81::~PE81() {
    ...
    delete gemm_systolic_arrbkb_U693;
    delete gemm_systolic_arrcud_U694;
}

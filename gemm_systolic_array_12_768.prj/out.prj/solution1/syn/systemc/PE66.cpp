...
PE66::PE66(sc_module_name name) : sc_module(name), mVcdFile(0) {
    gemm_systolic_arrbkb_U588 = new gemm_systolic_arrbkb<1,5,32,32,32>("gemm_systolic_arrbkb_U588");
    gemm_systolic_arrbkb_U588->clk(ap_clk);
    gemm_systolic_arrbkb_U588->reset(ap_rst);
    gemm_systolic_arrbkb_U588->din0(C_out_i);
    gemm_systolic_arrbkb_U588->din1(tmp_s_reg_195);
    gemm_systolic_arrbkb_U588->ce(grp_fu_150_ce);
    gemm_systolic_arrbkb_U588->dout(grp_fu_150_p2);
    gemm_systolic_arrcud_U589 = new gemm_systolic_arrcud<1,4,32,32,32>("gemm_systolic_arrcud_U589");
    gemm_systolic_arrcud_U589->clk(ap_clk);
    gemm_systolic_arrcud_U589->reset(ap_rst);
    gemm_systolic_arrcud_U589->din0(A_in_V_dout);
    gemm_systolic_arrcud_U589->din1(B_in_V_dout);
    gemm_systolic_arrcud_U589->ce(grp_fu_156_ce);
    gemm_systolic_arrcud_U589->dout(grp_fu_156_p2);
...
PE66::~PE66() {
    ...
    delete gemm_systolic_arrbkb_U588;
    delete gemm_systolic_arrcud_U589;
}

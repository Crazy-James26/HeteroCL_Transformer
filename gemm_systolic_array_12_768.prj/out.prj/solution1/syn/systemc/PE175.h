...
struct PE175 : public sc_module {
    ...
    // Module declarations
    PE175(sc_module_name name);
    SC_HAS_PROCESS(PE175);

    ~PE175();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1351;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1352;
    ...
    sc_signal< sc_lv<32> > tmp_114_reg_189;

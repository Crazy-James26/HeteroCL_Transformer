...
struct PE181 : public sc_module {
    ...
    // Module declarations
    PE181(sc_module_name name);
    SC_HAS_PROCESS(PE181);

    ~PE181();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1386;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1387;
    ...
    sc_signal< sc_lv<32> > tmp_108_reg_189;

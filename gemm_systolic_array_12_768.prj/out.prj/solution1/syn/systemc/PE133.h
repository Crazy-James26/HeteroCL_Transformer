...
struct PE133 : public sc_module {
    ...
    // Module declarations
    PE133(sc_module_name name);
    SC_HAS_PROCESS(PE133);

    ~PE133();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1057;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1058;
    ...
    sc_signal< sc_lv<32> > tmp_156_reg_189;

...
struct PE169 : public sc_module {
    ...
    // Module declarations
    PE169(sc_module_name name);
    SC_HAS_PROCESS(PE169);

    ~PE169();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1309;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1310;
    ...
    sc_signal< sc_lv<32> > tmp_120_reg_189;

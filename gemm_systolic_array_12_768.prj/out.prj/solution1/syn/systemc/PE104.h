...
struct PE104 : public sc_module {
    ...
    // Module declarations
    PE104(sc_module_name name);
    SC_HAS_PROCESS(PE104);

    ~PE104();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U854;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U855;
    ...
    sc_signal< sc_lv<32> > tmp_185_reg_189;

...
struct PE163 : public sc_module {
    ...
    // Module declarations
    PE163(sc_module_name name);
    SC_HAS_PROCESS(PE163);

    ~PE163();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1267;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1268;
    ...
    sc_signal< sc_lv<32> > tmp_126_reg_189;

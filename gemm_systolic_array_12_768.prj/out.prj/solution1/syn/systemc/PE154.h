...
struct PE154 : public sc_module {
    ...
    // Module declarations
    PE154(sc_module_name name);
    SC_HAS_PROCESS(PE154);

    ~PE154();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1197;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1198;
    ...
    sc_signal< sc_lv<32> > tmp_135_reg_189;

...
struct PE144 : public sc_module {
    ...
    // Module declarations
    PE144(sc_module_name name);
    SC_HAS_PROCESS(PE144);

    ~PE144();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1134;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1135;
    ...
    sc_signal< sc_lv<32> > tmp_145_reg_189;

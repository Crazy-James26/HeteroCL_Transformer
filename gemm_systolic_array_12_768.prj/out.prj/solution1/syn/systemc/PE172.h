...
struct PE172 : public sc_module {
    ...
    // Module declarations
    PE172(sc_module_name name);
    SC_HAS_PROCESS(PE172);

    ~PE172();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1323;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1324;
    ...
    sc_signal< sc_lv<32> > tmp_117_reg_189;

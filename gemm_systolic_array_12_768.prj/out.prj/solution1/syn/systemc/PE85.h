...
struct PE85 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U721;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U722;
    ...
    sc_signal< sc_lv<32> > tmp_61_reg_189;

...
PE97::PE97(sc_module_name name) : sc_module(name), mVcdFile(0) {
    gemm_systolic_arrbkb_U805 = new gemm_systolic_arrbkb<1,5,32,32,32>("gemm_systolic_arrbkb_U805");
    gemm_systolic_arrbkb_U805->clk(ap_clk);
    gemm_systolic_arrbkb_U805->reset(ap_rst);
    gemm_systolic_arrbkb_U805->din0(C_out_i);
    gemm_systolic_arrbkb_U805->din1(tmp_s_reg_195);
    gemm_systolic_arrbkb_U805->ce(grp_fu_150_ce);
    gemm_systolic_arrbkb_U805->dout(grp_fu_150_p2);
    gemm_systolic_arrcud_U806 = new gemm_systolic_arrcud<1,4,32,32,32>("gemm_systolic_arrcud_U806");
    gemm_systolic_arrcud_U806->clk(ap_clk);
    gemm_systolic_arrcud_U806->reset(ap_rst);
    gemm_systolic_arrcud_U806->din0(A_in_V_dout);
    gemm_systolic_arrcud_U806->din1(B_in_V_dout);
    gemm_systolic_arrcud_U806->ce(grp_fu_156_ce);
    gemm_systolic_arrcud_U806->dout(grp_fu_156_p2);
...
PE97::~PE97() {
    ...
    delete gemm_systolic_arrbkb_U805;
    delete gemm_systolic_arrcud_U806;
}

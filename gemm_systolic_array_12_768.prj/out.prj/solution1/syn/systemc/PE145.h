...
struct PE145 : public sc_module {
    ...
    // Module declarations
    PE145(sc_module_name name);
    SC_HAS_PROCESS(PE145);

    ~PE145();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1141;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1142;
    ...
    sc_signal< sc_lv<32> > tmp_144_reg_189;

...
struct PE148 : public sc_module {
    ...
    // Module declarations
    PE148(sc_module_name name);
    SC_HAS_PROCESS(PE148);

    ~PE148();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1162;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1163;
    ...
    sc_signal< sc_lv<32> > tmp_141_reg_189;

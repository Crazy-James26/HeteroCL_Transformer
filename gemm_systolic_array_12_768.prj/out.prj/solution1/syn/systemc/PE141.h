...
struct PE141 : public sc_module {
    ...
    // Module declarations
    PE141(sc_module_name name);
    SC_HAS_PROCESS(PE141);

    ~PE141();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1113;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1114;
    ...
    sc_signal< sc_lv<32> > tmp_148_reg_189;

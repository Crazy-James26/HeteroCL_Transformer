...
PE57::PE57(sc_module_name name) : sc_module(name), mVcdFile(0) {
    gemm_systolic_arrbkb_U525 = new gemm_systolic_arrbkb<1,5,32,32,32>("gemm_systolic_arrbkb_U525");
    gemm_systolic_arrbkb_U525->clk(ap_clk);
    gemm_systolic_arrbkb_U525->reset(ap_rst);
    gemm_systolic_arrbkb_U525->din0(C_out_i);
    gemm_systolic_arrbkb_U525->din1(tmp_s_reg_195);
    gemm_systolic_arrbkb_U525->ce(grp_fu_150_ce);
    gemm_systolic_arrbkb_U525->dout(grp_fu_150_p2);
    gemm_systolic_arrcud_U526 = new gemm_systolic_arrcud<1,4,32,32,32>("gemm_systolic_arrcud_U526");
    gemm_systolic_arrcud_U526->clk(ap_clk);
    gemm_systolic_arrcud_U526->reset(ap_rst);
    gemm_systolic_arrcud_U526->din0(A_in_V_dout);
    gemm_systolic_arrcud_U526->din1(B_in_V_dout);
    gemm_systolic_arrcud_U526->ce(grp_fu_156_ce);
    gemm_systolic_arrcud_U526->dout(grp_fu_156_p2);
...
PE57::~PE57() {
    ...
    delete gemm_systolic_arrbkb_U525;
    delete gemm_systolic_arrcud_U526;
}

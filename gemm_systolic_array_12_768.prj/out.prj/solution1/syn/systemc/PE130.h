...
struct PE130 : public sc_module {
    ...
    // Module declarations
    PE130(sc_module_name name);
    SC_HAS_PROCESS(PE130);

    ~PE130();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1036;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1037;
    ...
    sc_signal< sc_lv<32> > tmp_159_reg_189;

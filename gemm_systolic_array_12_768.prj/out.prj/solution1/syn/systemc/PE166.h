...
struct PE166 : public sc_module {
    ...
    // Module declarations
    PE166(sc_module_name name);
    SC_HAS_PROCESS(PE166);

    ~PE166();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1288;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1289;
    ...
    sc_signal< sc_lv<32> > tmp_123_reg_189;

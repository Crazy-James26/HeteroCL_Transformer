...
struct PE151 : public sc_module {
    ...
    // Module declarations
    PE151(sc_module_name name);
    SC_HAS_PROCESS(PE151);

    ~PE151();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1183;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1184;
    ...
    sc_signal< sc_lv<32> > tmp_138_reg_189;

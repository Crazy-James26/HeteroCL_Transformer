...
struct PE132 : public sc_module {
    ...
    // Module declarations
    PE132(sc_module_name name);
    SC_HAS_PROCESS(PE132);

    ~PE132();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1043;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1044;
    ...
    sc_signal< sc_lv<32> > tmp_157_reg_189;

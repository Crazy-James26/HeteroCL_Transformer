...
struct PE67 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U588;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U589;
    ...
    sc_signal< sc_lv<32> > tmp_79_reg_189;

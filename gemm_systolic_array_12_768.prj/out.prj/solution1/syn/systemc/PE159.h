...
struct PE159 : public sc_module {
    ...
    // Module declarations
    PE159(sc_module_name name);
    SC_HAS_PROCESS(PE159);

    ~PE159();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1232;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1233;
    ...
    sc_signal< sc_lv<32> > tmp_130_reg_189;

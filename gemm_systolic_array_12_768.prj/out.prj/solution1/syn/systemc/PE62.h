...
struct PE62 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U560;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U561;
    ...
    sc_signal< sc_lv<32> > tmp_84_reg_189;

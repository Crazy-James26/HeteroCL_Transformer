...
struct PE121 : public sc_module {
    ...
    // Module declarations
    PE121(sc_module_name name);
    SC_HAS_PROCESS(PE121);

    ~PE121();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U966;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U967;
    ...
    sc_signal< sc_lv<32> > tmp_168_reg_189;

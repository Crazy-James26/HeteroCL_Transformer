...
struct PE173 : public sc_module {
    ...
    // Module declarations
    PE173(sc_module_name name);
    SC_HAS_PROCESS(PE173);

    ~PE173();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1330;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1331;
    ...
    sc_signal< sc_lv<32> > tmp_116_reg_189;

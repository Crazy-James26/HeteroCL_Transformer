...
struct PE122 : public sc_module {
    ...
    // Module declarations
    PE122(sc_module_name name);
    SC_HAS_PROCESS(PE122);

    ~PE122();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U980;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U981;
    ...
    sc_signal< sc_lv<32> > tmp_167_reg_189;

...
struct PE44 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U427;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U428;
    ...
    sc_signal< sc_lv<32> > tmp_102_reg_189;

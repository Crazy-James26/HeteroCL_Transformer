...
struct PE128 : public sc_module {
    ...
    // Module declarations
    PE128(sc_module_name name);
    SC_HAS_PROCESS(PE128);

    ~PE128();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1022;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1023;
    ...
    sc_signal< sc_lv<32> > tmp_161_reg_189;

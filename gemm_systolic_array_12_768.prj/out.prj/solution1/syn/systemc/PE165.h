...
struct PE165 : public sc_module {
    ...
    // Module declarations
    PE165(sc_module_name name);
    SC_HAS_PROCESS(PE165);

    ~PE165();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1281;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1282;
    ...
    sc_signal< sc_lv<32> > tmp_124_reg_189;

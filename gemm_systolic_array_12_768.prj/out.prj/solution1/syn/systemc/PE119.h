...
struct PE119 : public sc_module {
    ...
    // Module declarations
    PE119(sc_module_name name);
    SC_HAS_PROCESS(PE119);

    ~PE119();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U959;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U960;
    ...
    sc_signal< sc_lv<32> > tmp_170_reg_189;

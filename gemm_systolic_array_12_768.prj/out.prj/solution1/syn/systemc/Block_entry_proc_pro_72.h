...
#ifndef _Block_entry_proc_pro_72_HH_
#define _Block_entry_proc_pro_72_HH_
...
struct Block_entry_proc_pro_72 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_72(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_72);

    ~Block_entry_proc_pro_72();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U2118;

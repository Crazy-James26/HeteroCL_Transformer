...
struct PE115 : public sc_module {
    ...
    // Module declarations
    PE115(sc_module_name name);
    SC_HAS_PROCESS(PE115);

    ~PE115();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U931;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U932;
    ...
    sc_signal< sc_lv<32> > tmp_174_reg_189;

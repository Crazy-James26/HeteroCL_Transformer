...
struct PE126 : public sc_module {
    ...
    // Module declarations
    PE126(sc_module_name name);
    SC_HAS_PROCESS(PE126);

    ~PE126();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1008;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1009;
    ...
    sc_signal< sc_lv<32> > tmp_163_reg_189;

...
struct PE135 : public sc_module {
    ...
    // Module declarations
    PE135(sc_module_name name);
    SC_HAS_PROCESS(PE135);

    ~PE135();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1071;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1072;
    ...
    sc_signal< sc_lv<32> > tmp_154_reg_189;

...
#ifndef _Block_entry_proc_pro_59_HH_
#define _Block_entry_proc_pro_59_HH_
...
struct Block_entry_proc_pro_59 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_59(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_59);

    ~Block_entry_proc_pro_59();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U2157;

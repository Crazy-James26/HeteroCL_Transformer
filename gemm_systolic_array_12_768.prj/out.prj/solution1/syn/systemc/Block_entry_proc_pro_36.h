...
#ifndef _Block_entry_proc_pro_36_HH_
#define _Block_entry_proc_pro_36_HH_
...
struct Block_entry_proc_pro_36 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_36(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_36);

    ~Block_entry_proc_pro_36();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U2226;

...
struct PE177 : public sc_module {
    ...
    // Module declarations
    PE177(sc_module_name name);
    SC_HAS_PROCESS(PE177);

    ~PE177();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U1365;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U1366;
    ...
    sc_signal< sc_lv<32> > tmp_112_reg_189;

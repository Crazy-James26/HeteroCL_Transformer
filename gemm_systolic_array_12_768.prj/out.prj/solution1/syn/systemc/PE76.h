...
struct PE76 : public sc_module {
    ...
    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U651;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U652;
    ...
    sc_signal< sc_lv<32> > tmp_70_reg_189;

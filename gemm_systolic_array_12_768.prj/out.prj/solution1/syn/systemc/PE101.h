...
struct PE101 : public sc_module {
    ...
    // Module declarations
    PE101(sc_module_name name);
    SC_HAS_PROCESS(PE101);

    ~PE101();

    sc_trace_file* mVcdFile;

    gemm_systolic_arrbkb<1,5,32,32,32>* gemm_systolic_arrbkb_U833;
    gemm_systolic_arrcud<1,4,32,32,32>* gemm_systolic_arrcud_U834;
    ...
    sc_signal< sc_lv<32> > tmp_188_reg_189;

...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((jj_0_i_0_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                C_10_3_addr_reg_61 <= zext_ln54_fu_56_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    C_10_3_address0_assign_proc : process(ap_CS_fsm_state1, C_10_3_addr_reg_61, zext_ln54_fu_56_p1, ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            C_10_3_address0 <= C_10_3_addr_reg_61;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            C_10_3_address0 <= zext_ln54_fu_56_p1(6 - 1 downto 0);
        else 

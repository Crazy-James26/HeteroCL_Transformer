...
module Block_entry_proc_pro_89 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if ((~((jj_0_i_0_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        C_4_6_addr_reg_61 <= zext_ln54_fu_56_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        C_4_6_address0 = zext_ln54_fu_56_p1;
    end else begin
        C_4_6_address0 = 'bx;
    end
end
...
endmodule //Block_entry_proc_pro_89

# 1 "systolic_array.cpp"
# 1 "systolic_array.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
void systolic_array(hls::stream<d_type> A_loader[block_M], hls::stream<d_type> B_loader[block_N], d_type C[block_M][block_N], int k_size) {_ssdm_SpecArrayDimSize(A_loader, 12);_ssdm_SpecArrayDimSize(B_loader, 12);_ssdm_SpecArrayDimSize(C, 12);
    hls::stream<d_type> A_fifo[block_M][block_N + 1];
    hls::stream<d_type> B_fifo[block_N][block_M + 1];

_ssdm_SpecStream( A_fifo, 0, 2, "");
_ssdm_SpecStream( B_fifo, 0, 2, "");

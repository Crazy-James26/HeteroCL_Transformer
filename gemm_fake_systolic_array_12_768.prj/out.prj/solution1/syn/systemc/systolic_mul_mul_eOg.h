...
// ==============================================================
#ifndef __systolic_mul_mul_eOg__HH__
#define __systolic_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(systolic_mul_mul_eOg) {
    ...
    SC_CTOR(systolic_mul_mul_eOg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
architecture behav of PE366 is 
    ...
    signal tmp_408_reg_189 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U819 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U820 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,

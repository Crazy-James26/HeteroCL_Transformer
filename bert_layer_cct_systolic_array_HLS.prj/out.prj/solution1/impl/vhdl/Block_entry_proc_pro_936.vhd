...
entity Block_entry_proc_pro_936 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_entry_proc_pro_936 is 
    ...
    signal C_11_3_addr_reg_61 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal C_11_3_load_reg_66 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_fu_51_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_i_0_11_3_i_reg_71 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U2310 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((jj_0_i_0_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                C_11_3_addr_reg_61 <= zext_ln56_fu_56_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then
                tmp_i_0_11_3_i_reg_71 <= grp_fu_51_p2;
            end if;
        end if;
    end process;
    ...
    C_11_3_address0_assign_proc : process(ap_CS_fsm_state1, C_11_3_addr_reg_61, zext_ln56_fu_56_p1, ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            C_11_3_address0 <= C_11_3_addr_reg_61;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            C_11_3_address0 <= zext_ln56_fu_56_p1(6 - 1 downto 0);
        else 
    ...
    C_11_3_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, jj_0_i_0_empty_n, ap_CS_fsm_state8)
    begin
    ...
    C_11_3_d0 <= tmp_i_0_11_3_i_reg_71;

    C_11_3_we0_assign_proc : process(ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 

...
architecture behav of PE_1472 is 
    ...
    signal k_0_reg_139 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal k_reg_178 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_reg_183 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_482_reg_189 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_phi_mux_k_0_phi_fu_143_p4 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U3803 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U3804 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    icmp_ln7_fu_162_p2 <= "1" when (ap_phi_mux_k_0_phi_fu_143_p4 = ap_const_lv4_C) else "0";
    ...
    k_fu_168_p2 <= std_logic_vector(unsigned(ap_phi_mux_k_0_phi_fu_143_p4) + unsigned(ap_const_lv4_1));

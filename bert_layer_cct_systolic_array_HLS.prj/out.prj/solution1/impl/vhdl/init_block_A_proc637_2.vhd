...
entity init_block_A_proc637_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of init_block_A_proc637_2 is 
    ...
    signal zext_ln97_cast_fu_221_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln97_cast_reg_254 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal k_fu_231_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal k_reg_262 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln94_fu_225_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_0_i_i_reg_202 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal zext_ln97_1_fu_246_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_213_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln97_fu_237_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln97_fu_241_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln94_fu_225_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    k_0_i_i_reg_202_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ii_0_i_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    zext_ln97_cast_reg_254(7 downto 6) <= zext_ln97_cast_fu_221_p1(7 downto 6);
            end if;
        end if;
    end process;
    zext_ln97_cast_reg_254(5 downto 0) <= "000000";
    zext_ln97_cast_reg_254(8) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ii_0_i_empty_n, block_A_loader_0_V_full_n, block_A_loader_1_V_full_n, block_A_loader_2_V_full_n, block_A_loader_3_V_full_n, ap_CS_fsm_state3, ap_CS_fsm_state2, icmp_ln94_fu_225_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln94_fu_225_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    A_0_address0 <= zext_ln97_1_fu_246_p1(8 - 1 downto 0);
    ...
    A_1_address0 <= zext_ln97_1_fu_246_p1(8 - 1 downto 0);
    ...
    A_2_address0 <= zext_ln97_1_fu_246_p1(8 - 1 downto 0);
    ...
    A_3_address0 <= zext_ln97_1_fu_246_p1(8 - 1 downto 0);
    ...
    add_ln97_fu_241_p2 <= std_logic_vector(unsigned(zext_ln97_cast_reg_254) + unsigned(zext_ln97_fu_237_p1));
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln94_fu_225_p2)
    begin
        if (((icmp_ln94_fu_225_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln94_fu_225_p2)
    begin
        if (((icmp_ln94_fu_225_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln94_fu_225_p2 <= "1" when (k_0_i_i_reg_202 = ap_const_lv7_40) else "0";
    ...
    k_fu_231_p2 <= std_logic_vector(unsigned(k_0_i_i_reg_202) + unsigned(ap_const_lv7_1));
    tmp_s_fu_213_p3 <= (ii_0_i_dout & ap_const_lv6_0);
    zext_ln97_1_fu_246_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln97_fu_241_p2),64));
    zext_ln97_cast_fu_221_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_213_p3),9));
    zext_ln97_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_0_i_i_reg_202),9));
end behav;

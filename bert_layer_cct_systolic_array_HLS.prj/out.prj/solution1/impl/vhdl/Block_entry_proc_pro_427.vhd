...
entity Block_entry_proc_pro_427 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_entry_proc_pro_427 is 
    ...
    signal C_0_4_addr_reg_61 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal C_0_4_load_reg_66 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_fu_51_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_i_0_0_4_i_reg_71 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U7586 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((jj_0_i_0_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                C_0_4_addr_reg_61 <= zext_ln296_fu_56_p1(8 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    C_0_4_address0_assign_proc : process(ap_CS_fsm_state1, C_0_4_addr_reg_61, zext_ln296_fu_56_p1, ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            C_0_4_address0 <= C_0_4_addr_reg_61;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            C_0_4_address0 <= zext_ln296_fu_56_p1(8 - 1 downto 0);
        else 
    ...
    C_0_4_ce0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, jj_0_i_0_empty_n, ap_CS_fsm_state8)
    begin

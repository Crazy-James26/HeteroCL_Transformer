...
architecture behav of PE548 is 
    ...
    signal tmp_264_reg_189 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U9888 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U9889 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,

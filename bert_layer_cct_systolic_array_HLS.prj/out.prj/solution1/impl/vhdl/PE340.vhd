...
architecture behav of PE340 is 
    ...
    signal tmp_434_reg_189 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Bert_layer_fadd_3bkb_U637 : component Bert_layer_fadd_3bkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    Bert_layer_fmul_3cud_U638 : component Bert_layer_fmul_3cud
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,

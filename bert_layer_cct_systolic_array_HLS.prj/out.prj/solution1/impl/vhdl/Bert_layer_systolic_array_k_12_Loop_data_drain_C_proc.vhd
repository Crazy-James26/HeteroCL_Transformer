...
attribute shreg_extract : string;
    ...
    signal icmp_ln212_fu_210_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_i_1395_fu_236_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_i_1395_reg_314 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_43_i_fu_250_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_43_i_reg_319 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_44_i_fu_264_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_44_i_reg_324 : STD_LOGIC_VECTOR (31 downto 0);
    signal n_fu_74 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln212_fu_216_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component Bert_layer_mux_43_32_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mux_43_32_1_1_U4459 : component Bert_layer_mux_43_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_43_32_1_1_U4460 : component Bert_layer_mux_43_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din3 => p_read7,
        din4 => ap_sig_allocacmp_n_6,
        dout => tmp_i_1395_fu_236_p6);

    mux_43_32_1_1_U4461 : component Bert_layer_mux_43_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din3 => p_read11,
        din4 => ap_sig_allocacmp_n_6,
        dout => tmp_43_i_fu_250_p6);

    mux_43_32_1_1_U4462 : component Bert_layer_mux_43_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_133)) then
                if ((icmp_ln212_fu_210_p2 = ap_const_lv1_0)) then 
                    n_fu_74 <= add_ln212_fu_216_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln212_fu_210_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_43_i_reg_319 <= tmp_43_i_fu_250_p6;
                tmp_44_i_reg_324 <= tmp_44_i_fu_264_p6;
                tmp_i_1395_reg_314 <= tmp_i_1395_fu_236_p6;
    ...
    add_ln212_fu_216_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_n_6) + unsigned(ap_const_lv3_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln212_fu_210_p2, ap_start_int)
    begin
        if (((icmp_ln212_fu_210_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    block_C_drainer_0_din <= tmp_i_reg_309;
    ...
    block_C_drainer_1_din <= tmp_i_1395_reg_314;
    ...
    block_C_drainer_2_din <= tmp_43_i_reg_319;
    ...
    block_C_drainer_3_din <= tmp_44_i_reg_324;
    ...
    icmp_ln212_fu_210_p2 <= "1" when (ap_sig_allocacmp_n_6 = ap_const_lv3_4) else "0";
end behav;

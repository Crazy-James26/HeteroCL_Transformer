...
architecture behav of Bert_layer_PE_583 is 
...
attribute shreg_extract : string;
    ...
    signal k_102_fu_98_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    fadd_32ns_32ns_32_5_full_dsp_1_U3825 : component Bert_layer_fadd_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_4_max_dsp_1_U3826 : component Bert_layer_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    ap_return_assign_proc : process(icmp_ln7_reg_143_pp0_iter1_reg, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_11001, ap_sig_allocacmp_C_out_out_0_load_73, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln7_reg_143_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_C_out_out_0_load_73_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage2, C_out_out_0_fu_44, grp_fu_76_p2, ap_block_pp0_stage2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
            ap_sig_allocacmp_C_out_out_0_load_73 <= grp_fu_76_p2;
        else 
            ap_sig_allocacmp_C_out_out_0_load_73 <= C_out_out_0_fu_44;
        end if; 
    end process;
    ...
    k_102_fu_98_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_k) + unsigned(ap_const_lv7_1));
end behav;

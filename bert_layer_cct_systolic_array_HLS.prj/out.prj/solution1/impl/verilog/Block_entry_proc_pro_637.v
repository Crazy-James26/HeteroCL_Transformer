...
module Block_entry_proc_pro_637 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    jj_0_i_0_blk_n;
reg   [5:0] C_6_10_addr_reg_61;
reg    ap_block_state1;
reg   [31:0] C_6_10_load_reg_66;
...
always @ (posedge ap_clk) begin
    if ((~((jj_0_i_0_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        C_6_10_addr_reg_61 <= zext_ln236_fu_56_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        C_6_10_address0 = zext_ln236_fu_56_p1;
    end else begin
        C_6_10_address0 = 'bx;
    end
end
...
assign C_6_10_d0 = tmp_i_0_6_10_i_reg_71;
...
endmodule //Block_entry_proc_pro_637

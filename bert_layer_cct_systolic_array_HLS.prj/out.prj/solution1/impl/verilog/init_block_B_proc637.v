...
reg   [3:0] jj_0_i_read_reg_238;
reg    ap_block_state1;
wire   [3:0] k_fu_217_p2;
reg   [3:0] k_reg_246;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln162_fu_211_p2;
reg   [3:0] k3_0_i_i_reg_200;
reg    ap_block_state3;
wire   [63:0] zext_ln165_fu_230_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln162_fu_211_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln162_fu_211_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign B_0_address0 = zext_ln165_fu_230_p1;

assign B_1_address0 = zext_ln165_fu_230_p1;

assign B_2_address0 = zext_ln165_fu_230_p1;

assign B_3_address0 = zext_ln165_fu_230_p1;
...
assign icmp_ln162_fu_211_p2 = ((k3_0_i_i_reg_200 == 4'd12) ? 1'b1 : 1'b0);

assign k_fu_217_p2 = (k3_0_i_i_reg_200 + 4'd1);

assign tmp_s_fu_223_p3 = {{k3_0_i_i_reg_200}, {jj_0_i_read_reg_238}};

assign zext_ln165_fu_230_p1 = tmp_s_fu_223_p3;

endmodule //init_block_B_proc637

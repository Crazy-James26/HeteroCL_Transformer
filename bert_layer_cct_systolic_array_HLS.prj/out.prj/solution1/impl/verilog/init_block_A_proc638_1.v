...
wire   [9:0] add_ln274_fu_489_p2;
reg   [9:0] add_ln274_reg_514;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln274_fu_483_p2;
reg   [9:0] k_0_i_0_reg_472;
reg    ap_block_state3;
reg    ap_block_state1;
wire   [63:0] zext_ln277_fu_495_p1;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln274_fu_483_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln274_fu_483_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign A_0_address0 = zext_ln277_fu_495_p1;

assign A_10_address0 = zext_ln277_fu_495_p1;

assign A_11_address0 = zext_ln277_fu_495_p1;

assign A_1_address0 = zext_ln277_fu_495_p1;

assign A_2_address0 = zext_ln277_fu_495_p1;

assign A_3_address0 = zext_ln277_fu_495_p1;

assign A_4_address0 = zext_ln277_fu_495_p1;

assign A_5_address0 = zext_ln277_fu_495_p1;

assign A_6_address0 = zext_ln277_fu_495_p1;

assign A_7_address0 = zext_ln277_fu_495_p1;

assign A_8_address0 = zext_ln277_fu_495_p1;

assign A_9_address0 = zext_ln277_fu_495_p1;

assign add_ln274_fu_489_p2 = (k_0_i_0_reg_472 + 10'd1);
...
assign icmp_ln274_fu_483_p2 = ((k_0_i_0_reg_472 == 10'd768) ? 1'b1 : 1'b0);

assign zext_ln277_fu_495_p1 = k_0_i_0_reg_472;

endmodule //init_block_A_proc638_1

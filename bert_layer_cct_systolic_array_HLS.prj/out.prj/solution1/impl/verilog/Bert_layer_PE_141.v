...
reg   [31:0] ap_sig_allocacmp_C_out_out_0_load_561;
...
Bert_layer_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U1002(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln7_reg_143_pp0_iter1_reg == 1'd1))) begin
            ap_return_preg <= ap_sig_allocacmp_C_out_out_0_load_561;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln7_reg_143_pp0_iter1_reg == 1'd1))) begin
        ap_return = ap_sig_allocacmp_C_out_out_0_load_561;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_C_out_out_0_load_561 = grp_fu_76_p2;
    end else begin
        ap_sig_allocacmp_C_out_out_0_load_561 = C_out_out_0_fu_44;
    end
end
...
assign k_590_fu_98_p2 = (ap_sig_allocacmp_k + 10'd1);

assign start_out = real_start;

endmodule //Bert_layer_PE_141

...
module Block_entry_proc_pro_911 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
Bert_layer_fadd_3bkb #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
Bert_layer_fadd_3bkb_U3437(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(C_0_0_load_reg_128),
    .din1(32'd0),
    .ce(1'b1),
    .dout(grp_fu_73_p2)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        C_0_0_addr_reg_123 <= sext_ln116_fu_107_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        C_0_0_load_reg_128 <= C_0_0_q0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        tmp_i_0_i_reg_133 <= grp_fu_73_p2;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        C_0_0_address0 = C_0_0_addr_reg_123;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        C_0_0_address0 = sext_ln116_fu_107_p1;
    end else begin
        C_0_0_address0 = 'bx;
    end
end
...
assign C_0_0_d0 = tmp_i_0_i_reg_133;

assign add_ln116_fu_101_p2 = (sub_ln116_fu_92_p2 + zext_ln116_2_fu_98_p1);
...
assign sub_ln116_fu_92_p2 = (zext_ln116_1_fu_88_p1 - zext_ln116_fu_78_p1);

assign tmp_fu_81_p3 = {{ii_0_i_read_reg_112}, {2'd0}};

assign zext_ln116_1_fu_88_p1 = tmp_fu_81_p3;

assign zext_ln116_2_fu_98_p1 = jj_0_i_read_reg_118;

assign zext_ln116_fu_78_p1 = ii_0_i_read_reg_112;

endmodule //Block_entry_proc_pro_911

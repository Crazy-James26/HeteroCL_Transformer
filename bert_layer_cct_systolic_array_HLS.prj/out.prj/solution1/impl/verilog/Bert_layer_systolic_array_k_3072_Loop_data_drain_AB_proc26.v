...
module Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc26 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [11:0] k_fu_78;
wire   [11:0] k_19_fu_240_p2;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_11001;
reg   [11:0] ap_sig_allocacmp_k_18;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_285)) begin
        if ((icmp_ln100_fu_234_p2 == 1'd0)) begin
            k_fu_78 <= k_19_fu_240_p2;
...
always @ (*) begin
    if (((icmp_ln100_fu_234_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_k_18 = 12'd0;
    end else begin
        ap_sig_allocacmp_k_18 = k_fu_78;
    end
end
...
assign icmp_ln100_fu_234_p2 = ((ap_sig_allocacmp_k_18 == 12'd3072) ? 1'b1 : 1'b0);

assign k_19_fu_240_p2 = (ap_sig_allocacmp_k_18 + 12'd1);

endmodule //Bert_layer_systolic_array_k_3072_Loop_data_drain_AB_proc26

...
reg   [31:0] ap_sig_allocacmp_C_out_out_0_load_574;
...
Bert_layer_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_5_full_dsp_1_U310(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        ap_sig_allocacmp_C_out_out_0_load_574 = grp_fu_76_p2;
    end else begin
        ap_sig_allocacmp_C_out_out_0_load_574 = C_out_out_0_fu_44;
    end
end
...
assign k_603_fu_98_p2 = (ap_sig_allocacmp_k + 10'd1);

assign start_out = real_start;

endmodule //Bert_layer_PE_13

...
struct PE386 : public sc_module {
    ...
    // Module declarations
    PE386(sc_module_name name);
    SC_HAS_PROCESS(PE386);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U960;
    ...
    sc_signal< sc_lv<32> > tmp_388_reg_189;

...
// ==============================================================
#ifndef __Bert_layer_mul_mubnm__HH__
#define __Bert_layer_mul_mubnm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_mubnm) {
    ...
    SC_CTOR(Bert_layer_mul_mubnm):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

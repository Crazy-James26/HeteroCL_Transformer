...
#ifndef _Block_entry_proc_pro_875_HH_
#define _Block_entry_proc_pro_875_HH_
...
struct Block_entry_proc_pro_875 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_875(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_875);

    ~Block_entry_proc_pro_875();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U3983;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<8> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > ii_0_i_blk_n;
    sc_signal< sc_logic > jj_0_i_blk_n;
    sc_signal< sc_lv<6> > C_1_0_addr_reg_91;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > C_1_0_load_reg_96;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<32> > grp_fu_73_p2;
    sc_signal< sc_lv<32> > tmp_i_1_i_reg_101;

...
struct PE427 : public sc_module {
    ...
    // Module declarations
    PE427(sc_module_name name);
    SC_HAS_PROCESS(PE427);

    ~PE427();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1246;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1247;
    ...
    sc_signal< sc_lv<32> > tmp_347_reg_189;

...
#ifndef _Block_entry_proc_pro_966_HH_
#define _Block_entry_proc_pro_966_HH_
...
struct Block_entry_proc_pro_966 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_966(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_966);

    ~Block_entry_proc_pro_966();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U2220;

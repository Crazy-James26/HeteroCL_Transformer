...
struct PE400 : public sc_module {
    ...
    // Module declarations
    PE400(sc_module_name name);
    SC_HAS_PROCESS(PE400);

    ~PE400();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1057;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1058;
    ...
    sc_signal< sc_lv<32> > tmp_374_reg_189;

...
struct PE399 : public sc_module {
    ...
    // Module declarations
    PE399(sc_module_name name);
    SC_HAS_PROCESS(PE399);

    ~PE399();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1050;
    ...
    sc_signal< sc_lv<32> > tmp_375_reg_189;

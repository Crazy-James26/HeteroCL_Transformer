...
struct PE316 : public sc_module {
    ...
    // Module declarations
    PE316(sc_module_name name);
    SC_HAS_PROCESS(PE316);

    ~PE316();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U469;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U470;
    ...
    sc_signal< sc_lv<32> > tmp_458_reg_189;

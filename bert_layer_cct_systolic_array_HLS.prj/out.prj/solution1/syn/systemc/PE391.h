...
struct PE391 : public sc_module {
    ...
    // Module declarations
    PE391(sc_module_name name);
    SC_HAS_PROCESS(PE391);

    ~PE391();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U994;
    ...
    sc_signal< sc_lv<32> > tmp_383_reg_189;

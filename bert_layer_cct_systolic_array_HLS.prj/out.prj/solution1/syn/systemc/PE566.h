...
struct PE566 : public sc_module {
    ...
    // Module declarations
    PE566(sc_module_name name);
    SC_HAS_PROCESS(PE566);

    ~PE566();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10014;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10015;
    ...
    sc_signal< sc_lv<32> > tmp_246_reg_189;

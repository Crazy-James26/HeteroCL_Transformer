...
struct PE384 : public sc_module {
    ...
    // Module declarations
    PE384(sc_module_name name);
    SC_HAS_PROCESS(PE384);

    ~PE384();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U945;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U946;
    ...
    sc_signal< sc_lv<32> > tmp_390_reg_189;

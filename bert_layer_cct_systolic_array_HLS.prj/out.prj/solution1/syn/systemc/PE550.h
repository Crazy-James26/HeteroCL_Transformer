...
struct PE550 : public sc_module {
    ...
    // Module declarations
    PE550(sc_module_name name);
    SC_HAS_PROCESS(PE550);

    ~PE550();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9902;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9903;
    ...
    sc_signal< sc_lv<32> > tmp_262_reg_189;

...
#ifndef _Block_entry_proc_pro_981_HH_
#define _Block_entry_proc_pro_981_HH_
...
struct Block_entry_proc_pro_981 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_981(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_981);

    ~Block_entry_proc_pro_981();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U2175;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<8> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > jj_0_i_0_blk_n;
    sc_signal< sc_lv<6> > C_7_6_addr_reg_61;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > C_7_6_load_reg_66;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<32> > grp_fu_51_p2;
    sc_signal< sc_lv<32> > tmp_i_0_7_6_i_reg_71;

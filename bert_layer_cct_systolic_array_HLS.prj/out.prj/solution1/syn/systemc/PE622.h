...
struct PE622 : public sc_module {
    ...
    // Module declarations
    PE622(sc_module_name name);
    SC_HAS_PROCESS(PE622);

    ~PE622();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10406;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10407;

...
#ifndef _Block_entry_proc_pro_389_HH_
#define _Block_entry_proc_pro_389_HH_
...
struct Block_entry_proc_pro_389 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_389(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_389);

    ~Block_entry_proc_pro_389();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U7700;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<8> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > jj_0_i_0_blk_n;
    sc_signal< sc_lv<8> > C_3_6_addr_reg_61;

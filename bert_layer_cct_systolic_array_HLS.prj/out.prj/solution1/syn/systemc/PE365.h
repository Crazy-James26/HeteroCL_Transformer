...
struct PE365 : public sc_module {
    ...
    // Module declarations
    PE365(sc_module_name name);
    SC_HAS_PROCESS(PE365);

    ~PE365();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U812;
    ...
    sc_signal< sc_lv<32> > tmp_409_reg_189;

...
struct PE322 : public sc_module {
    ...
    // Module declarations
    PE322(sc_module_name name);
    SC_HAS_PROCESS(PE322);

    ~PE322();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U511;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U512;
    ...
    sc_signal< sc_lv<32> > tmp_452_reg_189;

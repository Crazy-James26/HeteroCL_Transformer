...
struct PE360 : public sc_module {
    ...
    // Module declarations
    PE360(sc_module_name name);
    SC_HAS_PROCESS(PE360);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U778;
    ...
    sc_signal< sc_lv<32> > tmp_414_reg_189;

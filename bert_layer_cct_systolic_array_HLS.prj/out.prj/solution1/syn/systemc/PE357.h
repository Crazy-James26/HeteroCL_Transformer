...
struct PE357 : public sc_module {
    ...
    // Module declarations
    PE357(sc_module_name name);
    SC_HAS_PROCESS(PE357);

    ~PE357();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U756;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U757;
    ...
    sc_signal< sc_lv<32> > tmp_417_reg_189;

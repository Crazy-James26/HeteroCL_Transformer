...
struct PE361 : public sc_module {
    ...
    // Module declarations
    PE361(sc_module_name name);
    SC_HAS_PROCESS(PE361);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U785;
    ...
    sc_signal< sc_lv<32> > tmp_413_reg_189;

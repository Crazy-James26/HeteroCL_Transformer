...
struct PE359 : public sc_module {
    ...
    // Module declarations
    PE359(sc_module_name name);
    SC_HAS_PROCESS(PE359);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U771;
    ...
    sc_signal< sc_lv<32> > tmp_415_reg_189;

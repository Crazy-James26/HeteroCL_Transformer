...
void dataflow_in_loop6387_1_1::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ap_sync_reg_dataflow_in_loop6387_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_dataflow_in_loop6387_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_dataflow_in_loop6387_U0_ap_ready = ap_sync_dataflow_in_loop6387_U0_ap_ready.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ap_sync_reg_init_block_A_proc638_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_init_block_A_proc638_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_init_block_A_proc638_U0_ap_ready = ap_sync_init_block_A_proc638_U0_ap_ready.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ap_sync_reg_init_block_B_proc638_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_init_block_B_proc638_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_init_block_B_proc638_U0_ap_ready = ap_sync_init_block_B_proc638_U0_ap_ready.read();
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_0, dataflow_in_loop6387_U0_ap_ready.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()))) {
        dataflow_in_loop6387_U0_ap_ready_count = (!dataflow_in_loop6387_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(dataflow_in_loop6387_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(dataflow_in_loop6387_U0_ap_ready.read(), ap_const_logic_1) && 
                esl_seteq<1,1,1>(ap_const_logic_0, ap_sync_ready.read()))) {
        dataflow_in_loop6387_U0_ap_ready_count = (!dataflow_in_loop6387_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(dataflow_in_loop6387_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_0, init_block_A_proc638_U0_ap_ready.read()))) {
        init_block_A_proc638_U0_ap_ready_count = (!init_block_A_proc638_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(init_block_A_proc638_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_sync_ready.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, init_block_A_proc638_U0_ap_ready.read()))) {
        init_block_A_proc638_U0_ap_ready_count = (!init_block_A_proc638_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(init_block_A_proc638_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_0, init_block_B_proc638_U0_ap_ready.read()))) {
        init_block_B_proc638_U0_ap_ready_count = (!init_block_B_proc638_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(init_block_B_proc638_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_sync_ready.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, init_block_B_proc638_U0_ap_ready.read()))) {
        init_block_B_proc638_U0_ap_ready_count = (!init_block_B_proc638_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(init_block_B_proc638_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
}

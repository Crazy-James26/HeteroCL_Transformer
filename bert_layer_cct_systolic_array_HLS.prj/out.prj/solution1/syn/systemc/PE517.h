...
struct PE517 : public sc_module {
    ...
    // Module declarations
    PE517(sc_module_name name);
    SC_HAS_PROCESS(PE517);

    ~PE517();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9671;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9672;
    ...
    sc_signal< sc_lv<32> > tmp_295_reg_189;

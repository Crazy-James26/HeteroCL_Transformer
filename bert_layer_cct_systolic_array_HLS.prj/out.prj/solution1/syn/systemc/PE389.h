...
struct PE389 : public sc_module {
    ...
    // Module declarations
    PE389(sc_module_name name);
    SC_HAS_PROCESS(PE389);

    ~PE389();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U980;
    ...
    sc_signal< sc_lv<32> > tmp_385_reg_189;

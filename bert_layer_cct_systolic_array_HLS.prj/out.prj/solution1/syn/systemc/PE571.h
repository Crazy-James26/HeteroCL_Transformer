...
struct PE571 : public sc_module {
    ...
    // Module declarations
    PE571(sc_module_name name);
    SC_HAS_PROCESS(PE571);

    ~PE571();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10049;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10050;
    ...
    sc_signal< sc_lv<32> > tmp_241_reg_189;

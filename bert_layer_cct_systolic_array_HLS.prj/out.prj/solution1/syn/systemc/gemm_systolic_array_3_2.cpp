...
void gemm_systolic_array_3::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(dataflow_in_loop6381_1_1_U0_ap_done.read(), ap_const_logic_1) && 
             esl_seteq<1,1,1>(dataflow_in_loop6381_1_1_U0_ap_continue.read(), ap_const_logic_1) && 
        ...
        } else if ((esl_seteq<1,1,1>(dataflow_in_loop6381_1_1_U0_ap_done.read(), ap_const_logic_1) && 
                    esl_seteq<1,1,1>(dataflow_in_loop6381_1_1_U0_ap_continue.read(), ap_const_logic_1) && 
                    esl_seteq<1,7,7>(loop_dataflow_output_count.read(), bound_minus_1.read()))) {
            loop_dataflow_output_count = ap_const_lv7_0;
        }

...
struct PE396 : public sc_module {
    ...
    // Module declarations
    PE396(sc_module_name name);
    SC_HAS_PROCESS(PE396);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1030;
    ...
    sc_signal< sc_lv<32> > tmp_378_reg_189;

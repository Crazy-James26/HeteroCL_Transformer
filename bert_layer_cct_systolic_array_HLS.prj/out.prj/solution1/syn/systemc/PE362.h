...
struct PE362 : public sc_module {
    ...
    // Module declarations
    PE362(sc_module_name name);
    SC_HAS_PROCESS(PE362);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U792;
    ...
    sc_signal< sc_lv<32> > tmp_412_reg_189;

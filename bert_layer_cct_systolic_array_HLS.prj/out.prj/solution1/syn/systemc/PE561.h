...
struct PE561 : public sc_module {
    ...
    // Module declarations
    PE561(sc_module_name name);
    SC_HAS_PROCESS(PE561);

    ~PE561();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9979;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9980;
    ...
    sc_signal< sc_lv<32> > tmp_251_reg_189;

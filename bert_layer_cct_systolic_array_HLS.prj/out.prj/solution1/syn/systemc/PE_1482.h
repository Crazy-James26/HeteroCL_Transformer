...
struct PE_1482 : public sc_module {
    ...
    // Module declarations
    PE_1482(sc_module_name name);
    SC_HAS_PROCESS(PE_1482);

    ~PE_1482();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U3873;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U3874;
    ...
    sc_signal< sc_lv<32> > tmp_472_reg_189;

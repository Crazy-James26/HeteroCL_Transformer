...
#ifndef _dataflow_in_loop6375_HH_
#define _dataflow_in_loop6375_HH_
...
struct dataflow_in_loop6375 : public sc_module {
    ...
    // Module declarations
    dataflow_in_loop6375(sc_module_name name);
    SC_HAS_PROCESS(dataflow_in_loop6375);

    ~dataflow_in_loop6375();

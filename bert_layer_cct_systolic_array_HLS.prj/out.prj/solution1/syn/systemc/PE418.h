...
struct PE418 : public sc_module {
    ...
    // Module declarations
    PE418(sc_module_name name);
    SC_HAS_PROCESS(PE418);

    ~PE418();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1183;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1184;
    ...
    sc_signal< sc_lv<32> > tmp_356_reg_189;

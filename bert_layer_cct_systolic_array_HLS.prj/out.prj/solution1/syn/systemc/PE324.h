...
struct PE324 : public sc_module {
    ...
    // Module declarations
    PE324(sc_module_name name);
    SC_HAS_PROCESS(PE324);

    ~PE324();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U525;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U526;
    ...
    sc_signal< sc_lv<32> > tmp_450_reg_189;

...
// ==============================================================
#ifndef __Bert_layer_fpext_bhl__HH__
#define __Bert_layer_fpext_bhl__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_fpext_bhl) {
    ...
    SC_CTOR(Bert_layer_fpext_bhl):  ACMP_fpext_U ("ACMP_fpext_U") {

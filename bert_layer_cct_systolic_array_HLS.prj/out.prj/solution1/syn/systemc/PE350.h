...
struct PE350 : public sc_module {
    ...
    // Module declarations
    PE350(sc_module_name name);
    SC_HAS_PROCESS(PE350);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U708;
    ...
    sc_signal< sc_lv<32> > tmp_424_reg_189;

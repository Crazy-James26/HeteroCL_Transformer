...
struct PE501 : public sc_module {
    ...
    // Module declarations
    PE501(sc_module_name name);
    SC_HAS_PROCESS(PE501);

    ~PE501();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9559;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9560;
    ...
    sc_signal< sc_lv<32> > tmp_311_reg_189;

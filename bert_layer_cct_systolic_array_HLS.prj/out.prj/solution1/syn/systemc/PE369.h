...
struct PE369 : public sc_module {
    ...
    // Module declarations
    PE369(sc_module_name name);
    SC_HAS_PROCESS(PE369);

    ~PE369();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U840;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U841;
    ...
    sc_signal< sc_lv<32> > tmp_405_reg_189;

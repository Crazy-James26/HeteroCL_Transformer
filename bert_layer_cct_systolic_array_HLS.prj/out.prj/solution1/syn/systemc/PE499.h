...
struct PE499 : public sc_module {
    ...
    // Module declarations
    PE499(sc_module_name name);
    SC_HAS_PROCESS(PE499);

    ~PE499();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9545;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9546;
    ...
    sc_signal< sc_lv<32> > tmp_313_reg_189;

...
struct PE368 : public sc_module {
    ...
    // Module declarations
    PE368(sc_module_name name);
    SC_HAS_PROCESS(PE368);

    ~PE368();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U833;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U834;
    ...
    sc_signal< sc_lv<32> > tmp_406_reg_189;

...
struct PE390 : public sc_module {
    ...
    // Module declarations
    PE390(sc_module_name name);
    SC_HAS_PROCESS(PE390);

    ~PE390();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U987;
    ...
    sc_signal< sc_lv<32> > tmp_384_reg_189;

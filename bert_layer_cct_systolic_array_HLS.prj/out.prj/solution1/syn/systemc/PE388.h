...
struct PE388 : public sc_module {
    ...
    // Module declarations
    PE388(sc_module_name name);
    SC_HAS_PROCESS(PE388);

    ~PE388();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U973;
    ...
    sc_signal< sc_lv<32> > tmp_386_reg_189;

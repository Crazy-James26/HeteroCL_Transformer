...
struct PE409 : public sc_module {
    ...
    // Module declarations
    PE409(sc_module_name name);
    SC_HAS_PROCESS(PE409);

    ~PE409();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1120;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1121;
    ...
    sc_signal< sc_lv<32> > tmp_365_reg_189;

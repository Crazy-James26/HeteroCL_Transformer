...
struct PE_1466 : public sc_module {
    ...
    // Module declarations
    PE_1466(sc_module_name name);
    SC_HAS_PROCESS(PE_1466);

    ~PE_1466();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U3357;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U3358;
    ...
    sc_signal< sc_lv<32> > tmp_486_reg_189;

...
struct PE385 : public sc_module {
    ...
    // Module declarations
    PE385(sc_module_name name);
    SC_HAS_PROCESS(PE385);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U953;
    ...
    sc_signal< sc_lv<32> > tmp_389_reg_189;

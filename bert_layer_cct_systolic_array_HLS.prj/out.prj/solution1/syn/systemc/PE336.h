...
struct PE336 : public sc_module {
    ...
    // Module declarations
    PE336(sc_module_name name);
    SC_HAS_PROCESS(PE336);

    ~PE336();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U609;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U610;
    ...
    sc_signal< sc_lv<32> > tmp_438_reg_189;

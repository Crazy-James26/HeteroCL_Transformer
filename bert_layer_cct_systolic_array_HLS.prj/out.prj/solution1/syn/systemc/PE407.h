...
struct PE407 : public sc_module {
    ...
    // Module declarations
    PE407(sc_module_name name);
    SC_HAS_PROCESS(PE407);

    ~PE407();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1106;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1107;
    ...
    sc_signal< sc_lv<32> > tmp_367_reg_189;

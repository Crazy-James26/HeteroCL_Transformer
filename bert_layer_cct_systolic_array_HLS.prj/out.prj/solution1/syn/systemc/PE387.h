...
struct PE387 : public sc_module {
    ...
    // Module declarations
    PE387(sc_module_name name);
    SC_HAS_PROCESS(PE387);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U967;
    ...
    sc_signal< sc_lv<32> > tmp_387_reg_189;

...
struct PE403 : public sc_module {
    ...
    // Module declarations
    PE403(sc_module_name name);
    SC_HAS_PROCESS(PE403);

    ~PE403();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1078;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1079;
    ...
    sc_signal< sc_lv<32> > tmp_371_reg_189;

...
struct PE364 : public sc_module {
    ...
    // Module declarations
    PE364(sc_module_name name);
    SC_HAS_PROCESS(PE364);

    ~PE364();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U805;
    ...
    sc_signal< sc_lv<32> > tmp_410_reg_189;

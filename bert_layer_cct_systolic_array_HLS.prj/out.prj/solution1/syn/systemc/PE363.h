...
struct PE363 : public sc_module {
    ...
    // Module declarations
    PE363(sc_module_name name);
    SC_HAS_PROCESS(PE363);

    ~PE363();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U798;
    ...
    sc_signal< sc_lv<32> > tmp_411_reg_189;

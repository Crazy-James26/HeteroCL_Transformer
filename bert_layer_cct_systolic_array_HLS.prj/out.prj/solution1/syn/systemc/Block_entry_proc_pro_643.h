...
#ifndef _Block_entry_proc_pro_643_HH_
#define _Block_entry_proc_pro_643_HH_
...
struct Block_entry_proc_pro_643 : public sc_module {
    ...
    // Module declarations
    Block_entry_proc_pro_643(sc_module_name name);
    SC_HAS_PROCESS(Block_entry_proc_pro_643);

    ~Block_entry_proc_pro_643();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U5697;
    sc_signal< sc_logic > ap_done_reg;
    sc_signal< sc_lv<8> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > jj_0_i_0_blk_n;
    sc_signal< sc_lv<6> > C_6_4_addr_reg_61;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > C_6_4_load_reg_66;

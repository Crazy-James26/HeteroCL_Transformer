...
struct PE_1462 : public sc_module {
    ...
    // Module declarations
    PE_1462(sc_module_name name);
    SC_HAS_PROCESS(PE_1462);

    ~PE_1462();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U3329;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U3330;
    ...
    sc_signal< sc_lv<32> > tmp_490_reg_189;

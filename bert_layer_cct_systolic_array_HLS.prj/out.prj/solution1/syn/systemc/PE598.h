...
struct PE598 : public sc_module {
    ...
    // Module declarations
    PE598(sc_module_name name);
    SC_HAS_PROCESS(PE598);

    ~PE598();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10238;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10239;
    ...
    sc_signal< sc_lv<32> > tmp_214_reg_189;

...
struct PE349 : public sc_module {
    ...
    // Module declarations
    PE349(sc_module_name name);
    SC_HAS_PROCESS(PE349);

    ~PE349();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U700;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U701;
    ...
    sc_signal< sc_lv<32> > tmp_425_reg_189;

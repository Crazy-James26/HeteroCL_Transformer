...
struct PE502 : public sc_module {
    ...
    // Module declarations
    PE502(sc_module_name name);
    SC_HAS_PROCESS(PE502);

    ~PE502();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9566;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9567;
    ...
    sc_signal< sc_lv<32> > tmp_310_reg_189;

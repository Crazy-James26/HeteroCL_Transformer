...
struct PE417 : public sc_module {
    ...
    // Module declarations
    PE417(sc_module_name name);
    SC_HAS_PROCESS(PE417);

    ~PE417();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1176;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1177;
    ...
    sc_signal< sc_lv<32> > tmp_357_reg_189;

...
// ==============================================================
#ifndef __Bert_layer_mac_mubPq__HH__
#define __Bert_layer_mac_mubPq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mac_mubPq) {
    ...
    SC_CTOR(Bert_layer_mac_mubPq):  simcore_mac_0_U ("simcore_mac_0_U") {

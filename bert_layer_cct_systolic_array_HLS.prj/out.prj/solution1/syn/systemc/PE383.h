...
struct PE383 : public sc_module {
    ...
    // Module declarations
    PE383(sc_module_name name);
    SC_HAS_PROCESS(PE383);

    ~PE383();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U938;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U939;
    ...
    sc_signal< sc_lv<32> > tmp_391_reg_189;

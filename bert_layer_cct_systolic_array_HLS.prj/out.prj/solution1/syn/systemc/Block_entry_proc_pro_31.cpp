...
Block_entry_proc_pro_31::Block_entry_proc_pro_31(sc_module_name name) : sc_module(name), mVcdFile(0) {
    Bert_layer_fadd_3bkb_U11310 = new Bert_layer_fadd_3bkb<1,5,32,32,32>("Bert_layer_fadd_3bkb_U11310");
    Bert_layer_fadd_3bkb_U11310->clk(ap_clk);
    Bert_layer_fadd_3bkb_U11310->reset(ap_rst);
    Bert_layer_fadd_3bkb_U11310->din0(C_9_4_load_reg_66);
    Bert_layer_fadd_3bkb_U11310->din1(ap_var_for_const0);
    Bert_layer_fadd_3bkb_U11310->ce(ap_var_for_const1);
    Bert_layer_fadd_3bkb_U11310->dout(grp_fu_51_p2);
...
Block_entry_proc_pro_31::~Block_entry_proc_pro_31() {
    ...
    delete Bert_layer_fadd_3bkb_U11310;
}
...
void Block_entry_proc_pro_31::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, jj_0_i_0_empty_n.read())))) {
        C_9_4_addr_reg_61 =  (sc_lv<6>) (zext_ln356_fu_56_p1.read());
    }
...
void Block_entry_proc_pro_31::thread_C_9_4_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        ...
        C_9_4_address0 =  (sc_lv<6>) (zext_ln356_fu_56_p1.read());
    } else {
...
void Block_entry_proc_pro_31::thread_zext_ln356_fu_56_p1() {

...
struct PE500 : public sc_module {
    ...
    // Module declarations
    PE500(sc_module_name name);
    SC_HAS_PROCESS(PE500);

    ~PE500();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9552;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9553;
    ...
    sc_signal< sc_lv<32> > tmp_312_reg_189;

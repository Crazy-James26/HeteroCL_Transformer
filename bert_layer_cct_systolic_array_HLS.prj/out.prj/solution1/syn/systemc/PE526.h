...
struct PE526 : public sc_module {
    ...
    // Module declarations
    PE526(sc_module_name name);
    SC_HAS_PROCESS(PE526);

    ~PE526();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9734;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9735;
    ...
    sc_signal< sc_lv<32> > tmp_286_reg_189;

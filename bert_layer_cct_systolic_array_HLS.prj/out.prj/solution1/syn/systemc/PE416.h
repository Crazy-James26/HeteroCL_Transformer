...
struct PE416 : public sc_module {
    ...
    // Module declarations
    PE416(sc_module_name name);
    SC_HAS_PROCESS(PE416);

    ~PE416();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1169;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1170;
    ...
    sc_signal< sc_lv<32> > tmp_358_reg_189;

...
struct PE592 : public sc_module {
    ...
    // Module declarations
    PE592(sc_module_name name);
    SC_HAS_PROCESS(PE592);

    ~PE592();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10196;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10197;
    ...
    sc_signal< sc_lv<32> > tmp_220_reg_189;

...
struct PE343 : public sc_module {
    ...
    // Module declarations
    PE343(sc_module_name name);
    SC_HAS_PROCESS(PE343);

    ~PE343();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U658;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U659;
    ...
    sc_signal< sc_lv<32> > tmp_431_reg_189;

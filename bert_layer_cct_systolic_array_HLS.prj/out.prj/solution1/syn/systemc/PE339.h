...
struct PE339 : public sc_module {
    ...
    // Module declarations
    PE339(sc_module_name name);
    SC_HAS_PROCESS(PE339);

    ~PE339();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U630;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U631;
    ...
    sc_signal< sc_lv<32> > tmp_435_reg_189;

...
#ifndef _dataflow_in_loop6378_HH_
#define _dataflow_in_loop6378_HH_
...
struct dataflow_in_loop6378 : public sc_module {
    ...
    sc_out< sc_lv<5> > jj_0_i_out_din;
    sc_in< sc_logic > jj_0_i_out_full_n;
    sc_out< sc_logic > jj_0_i_out_write;


    // Module declarations
    dataflow_in_loop6378(sc_module_name name);
    SC_HAS_PROCESS(dataflow_in_loop6378);

    ~dataflow_in_loop6378();

...
struct PE574 : public sc_module {
    ...
    // Module declarations
    PE574(sc_module_name name);
    SC_HAS_PROCESS(PE574);

    ~PE574();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10070;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10071;
    ...
    sc_signal< sc_lv<32> > tmp_238_reg_189;

...
struct PE_1471 : public sc_module {
    ...
    // Module declarations
    PE_1471(sc_module_name name);
    SC_HAS_PROCESS(PE_1471);

    ~PE_1471();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U3796;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U3797;
    ...
    sc_signal< sc_lv<4> > ap_phi_mux_k_0_phi_fu_143_p4;

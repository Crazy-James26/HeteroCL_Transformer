...
struct PE338 : public sc_module {
    ...
    // Module declarations
    PE338(sc_module_name name);
    SC_HAS_PROCESS(PE338);

    ~PE338();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U623;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U624;
    ...
    sc_signal< sc_lv<32> > tmp_436_reg_189;

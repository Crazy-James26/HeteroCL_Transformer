...
struct PE614 : public sc_module {
    ...
    // Module declarations
    PE614(sc_module_name name);
    SC_HAS_PROCESS(PE614);

    ~PE614();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10350;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10351;
    ...
    sc_signal< sc_lv<32> > tmp_198_reg_189;

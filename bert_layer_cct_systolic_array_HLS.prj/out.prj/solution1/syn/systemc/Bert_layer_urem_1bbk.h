...
// ==============================================================
#ifndef __Bert_layer_urem_1bbk__HH__
#define __Bert_layer_urem_1bbk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_urem_1bbk) {
    ...
    SC_CTOR(Bert_layer_urem_1bbk):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {

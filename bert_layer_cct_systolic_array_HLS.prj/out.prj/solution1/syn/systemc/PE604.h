...
struct PE604 : public sc_module {
    ...
    // Module declarations
    PE604(sc_module_name name);
    SC_HAS_PROCESS(PE604);

    ~PE604();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U10280;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U10281;
    ...
    sc_signal< sc_lv<32> > tmp_208_reg_189;

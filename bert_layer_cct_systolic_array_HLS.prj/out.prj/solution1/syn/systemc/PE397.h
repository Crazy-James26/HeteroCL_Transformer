...
struct PE397 : public sc_module {
    ...
    // Module declarations
    PE397(sc_module_name name);
    SC_HAS_PROCESS(PE397);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1037;
    ...
    sc_signal< sc_lv<32> > tmp_377_reg_189;

...
struct PE425 : public sc_module {
    ...
    // Module declarations
    PE425(sc_module_name name);
    SC_HAS_PROCESS(PE425);

    ~PE425();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1232;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1233;
    ...
    sc_signal< sc_lv<32> > tmp_349_reg_189;

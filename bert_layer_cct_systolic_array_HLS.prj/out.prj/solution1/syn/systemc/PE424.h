...
struct PE424 : public sc_module {
    ...
    // Module declarations
    PE424(sc_module_name name);
    SC_HAS_PROCESS(PE424);
    ...
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1226;
    ...
    sc_signal< sc_lv<32> > tmp_350_reg_189;

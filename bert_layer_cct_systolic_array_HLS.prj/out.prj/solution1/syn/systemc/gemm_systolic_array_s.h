...
#ifndef _gemm_systolic_array_s_HH_
#define _gemm_systolic_array_s_HH_
...
struct gemm_systolic_array_s : public sc_module {
    ...
    // Module declarations
    gemm_systolic_array_s(sc_module_name name);
    SC_HAS_PROCESS(gemm_systolic_array_s);

    ~gemm_systolic_array_s();

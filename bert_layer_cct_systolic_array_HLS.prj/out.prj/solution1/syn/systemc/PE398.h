...
struct PE398 : public sc_module {
    ...
    // Module declarations
    PE398(sc_module_name name);
    SC_HAS_PROCESS(PE398);

    ~PE398();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1043;
    ...
    sc_signal< sc_lv<32> > tmp_376_reg_189;

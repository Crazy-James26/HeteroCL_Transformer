...
struct PE437 : public sc_module {
    ...
    // Module declarations
    PE437(sc_module_name name);
    SC_HAS_PROCESS(PE437);

    ~PE437();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U1316;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U1317;
    ...
    sc_signal< sc_lv<32> > tmp_337_reg_189;

...
struct PE548 : public sc_module {
    ...
    // Module declarations
    PE548(sc_module_name name);
    SC_HAS_PROCESS(PE548);

    ~PE548();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9888;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9889;
    ...
    sc_signal< sc_lv<32> > tmp_264_reg_189;

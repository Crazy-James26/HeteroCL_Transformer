...
// ==============================================================
#ifndef __pow_generic_doublbqm_H__
#define __pow_generic_doublbqm_H__
...
struct pow_generic_doublbqm_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(pow_generic_doublbqm_ram) {
...
SC_MODULE(pow_generic_doublbqm) {
...
pow_generic_doublbqm_ram* meminst;


SC_CTOR(pow_generic_doublbqm) {
meminst = new pow_generic_doublbqm_ram("pow_generic_doublbqm_ram");

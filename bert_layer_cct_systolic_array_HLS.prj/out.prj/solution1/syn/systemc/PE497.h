...
struct PE497 : public sc_module {
    ...
    // Module declarations
    PE497(sc_module_name name);
    SC_HAS_PROCESS(PE497);

    ~PE497();

    sc_trace_file* mVcdFile;

    Bert_layer_fadd_3bkb<1,5,32,32,32>* Bert_layer_fadd_3bkb_U9531;
    Bert_layer_fmul_3cud<1,4,32,32,32>* Bert_layer_fmul_3cud_U9532;
    ...
    sc_signal< sc_lv<32> > tmp_315_reg_189;

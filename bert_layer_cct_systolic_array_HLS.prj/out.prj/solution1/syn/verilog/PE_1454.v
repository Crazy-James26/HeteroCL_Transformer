...
wire   [6:0] k_fu_168_p2;
reg   [6:0] k_reg_178;
reg   [31:0] tmp_reg_183;
reg   [31:0] tmp_498_reg_189;
...
reg   [6:0] ap_phi_mux_k_0_phi_fu_143_p4;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln7_reg_174 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln7_fu_162_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln7_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        A_in_V_read = 1'b1;
    end else begin
        A_in_V_read = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln7_reg_174_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage3_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
assign B_out_V_din = tmp_498_reg_189;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == A_in_V_empty_n)) | ((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == B_in_V_empty_n))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == A_in_V_empty_n)) | ((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == B_in_V_empty_n))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = (((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == A_in_V_empty_n)) | ((icmp_ln7_fu_162_p2 == 1'd0) & (1'b0 == B_in_V_empty_n)));
end
...
assign icmp_ln7_fu_162_p2 = ((ap_phi_mux_k_0_phi_fu_143_p4 == 7'd64) ? 1'b1 : 1'b0);

assign k_fu_168_p2 = (ap_phi_mux_k_0_phi_fu_143_p4 + 7'd1);

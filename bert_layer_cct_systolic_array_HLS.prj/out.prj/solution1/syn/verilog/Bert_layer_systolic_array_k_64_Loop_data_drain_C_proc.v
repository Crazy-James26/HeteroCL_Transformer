...
reg   [31:0] tmp_32_i_reg_324;
reg   [2:0] n_fu_74;
wire   [2:0] add_ln161_fu_216_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_133)) begin
        if ((icmp_ln161_fu_210_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln161_fu_210_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln161_fu_216_p2 = (ap_sig_allocacmp_n_4 + 3'd1);
...
assign block_C_drainer_3_din = tmp_32_i_reg_324;

assign icmp_ln161_fu_210_p2 = ((ap_sig_allocacmp_n_4 == 3'd4) ? 1'b1 : 1'b0);

...
wire   [16:0] sub_ln225_fu_535_p2;
reg   [16:0] sub_ln225_reg_578;
reg    ap_block_state1;
wire   [9:0] add_ln222_fu_547_p2;
reg   [9:0] add_ln222_reg_586;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln222_fu_541_p2;
reg   [9:0] k3_0_i_0_i_reg_500;
reg    ap_block_state3;
wire  signed [63:0] sext_ln225_fu_562_p1;
wire   [15:0] tmp_s_fu_511_p3;
wire   [13:0] tmp_11_fu_523_p3;
wire   [16:0] zext_ln225_fu_519_p1;
wire   [16:0] zext_ln225_1_fu_531_p1;
wire   [16:0] zext_ln225_2_fu_553_p1;
wire   [16:0] add_ln225_fu_557_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln222_fu_541_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (jj_0_i_0_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        sub_ln225_reg_578[16 : 8] <= sub_ln225_fu_535_p2[16 : 8];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln222_fu_541_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign B_0_address0 = sext_ln225_fu_562_p1;

assign B_10_address0 = sext_ln225_fu_562_p1;

assign B_11_address0 = sext_ln225_fu_562_p1;

assign B_1_address0 = sext_ln225_fu_562_p1;

assign B_2_address0 = sext_ln225_fu_562_p1;

assign B_3_address0 = sext_ln225_fu_562_p1;

assign B_4_address0 = sext_ln225_fu_562_p1;

assign B_5_address0 = sext_ln225_fu_562_p1;

assign B_6_address0 = sext_ln225_fu_562_p1;

assign B_7_address0 = sext_ln225_fu_562_p1;

assign B_8_address0 = sext_ln225_fu_562_p1;

assign B_9_address0 = sext_ln225_fu_562_p1;

assign add_ln222_fu_547_p2 = (k3_0_i_0_i_reg_500 + 10'd1);

assign add_ln225_fu_557_p2 = (sub_ln225_reg_578 + zext_ln225_2_fu_553_p1);
...
assign icmp_ln222_fu_541_p2 = ((k3_0_i_0_i_reg_500 == 10'd768) ? 1'b1 : 1'b0);

assign sext_ln225_fu_562_p1 = $signed(add_ln225_fu_557_p2);

assign sub_ln225_fu_535_p2 = (zext_ln225_fu_519_p1 - zext_ln225_1_fu_531_p1);

assign tmp_11_fu_523_p3 = {{jj_0_i_0_dout}, {8'd0}};

assign tmp_s_fu_511_p3 = {{jj_0_i_0_dout}, {10'd0}};

assign zext_ln225_1_fu_531_p1 = tmp_11_fu_523_p3;

assign zext_ln225_2_fu_553_p1 = k3_0_i_0_i_reg_500;

assign zext_ln225_fu_519_p1 = tmp_s_fu_511_p3;

always @ (posedge ap_clk) begin
    sub_ln225_reg_578[7:0] <= 8'b00000000;
end

endmodule //init_block_B_proc638_2

...
entity Bert_layer_Layer_norm_Pipeline_VITIS_LOOP_214_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_Layer_norm_Pipeline_VITIS_LOOP_214_2 is 
...
attribute shreg_extract : string;
    ...
    signal add_ln214_fu_62_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln214_fu_56_p2 = ap_const_lv1_0)) then 
                    v122_fu_30 <= add_ln214_fu_62_p2;
    ...
    add_ln214_fu_62_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_v122_1) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, icmp_ln214_fu_56_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (icmp_ln214_fu_56_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    icmp_ln214_fu_56_p2 <= "1" when (ap_sig_allocacmp_v122_1 = ap_const_lv4_C) else "0";
    ...
    mean2_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln214_fu_56_p2, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (icmp_ln214_fu_56_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 

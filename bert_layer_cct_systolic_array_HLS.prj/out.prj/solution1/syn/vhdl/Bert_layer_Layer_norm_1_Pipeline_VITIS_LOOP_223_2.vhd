...
entity Bert_layer_Layer_norm_1_Pipeline_VITIS_LOOP_223_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_Layer_norm_1_Pipeline_VITIS_LOOP_223_2 is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_v122_2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    add_ln223_fu_62_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_v122_2) + unsigned(ap_const_lv4_1));
    ...
    ap_sig_allocacmp_v122_2_assign_proc : process(ap_CS_fsm_state1, v122_fu_30, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_v122_2 <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_v122_2 <= v122_fu_30;
        end if; 
    end process;

    icmp_ln223_fu_56_p2 <= "1" when (ap_sig_allocacmp_v122_2 = ap_const_lv4_C) else "0";
    ...
    v122_cast_fu_68_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_v122_2),64));
end behav;

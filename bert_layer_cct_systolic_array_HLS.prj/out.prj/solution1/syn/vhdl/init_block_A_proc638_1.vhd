...
entity init_block_A_proc638_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of init_block_A_proc638_1 is 
    ...
    signal add_ln274_fu_489_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln274_reg_514 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln274_fu_483_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal k_0_i_0_reg_472 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal ap_block_state1 : BOOLEAN;
    signal zext_ln277_fu_495_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln274_fu_483_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                ...
                k_0_i_0_reg_472 <= add_ln274_reg_514;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln274_reg_514 <= add_ln274_fu_489_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, block_A_loader_0_V_full_n, block_A_loader_1_V_full_n, block_A_loader_2_V_full_n, block_A_loader_3_V_full_n, block_A_loader_4_V_full_n, block_A_loader_5_V_full_n, block_A_loader_6_V_full_n, block_A_loader_7_V_full_n, block_A_loader_8_V_full_n, block_A_loader_9_V_full_n, block_A_loader_10_V_full_n, block_A_loader_11_V_full_n, ap_CS_fsm_state3, ap_CS_fsm_state2, icmp_ln274_fu_483_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln274_fu_483_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    A_0_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_10_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_11_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_1_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_2_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_3_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_4_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_5_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_6_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_7_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_8_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    A_9_address0 <= zext_ln277_fu_495_p1(10 - 1 downto 0);
    ...
    add_ln274_fu_489_p2 <= std_logic_vector(unsigned(k_0_i_0_reg_472) + unsigned(ap_const_lv10_1));
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln274_fu_483_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln274_fu_483_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln274_fu_483_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln274_fu_483_p2 = ap_const_lv1_1))) then 
    ...
    icmp_ln274_fu_483_p2 <= "1" when (k_0_i_0_reg_472 = ap_const_lv10_300) else "0";
    zext_ln277_fu_495_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_0_i_0_reg_472),64));
end behav;

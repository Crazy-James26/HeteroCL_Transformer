set moduleName VITIS_LOOP_132_4_proc31_Pipeline_VITIS_LOOP_132_4
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "C_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "tmp_66", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_66", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tmp_66", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U3196", "Parent" : "0"},
...
set Spec2ImplPortList { 
	C_1 { ap_memory {  { C_1_address0 mem_address 1 8 }  { C_1_ce0 mem_ce 1 1 }  { C_1_we0 mem_we 1 1 }  { C_1_d0 mem_din 1 32 }  { C_1_address1 MemPortADDR2 1 8 }  { C_1_ce1 MemPortCE2 1 1 }  { C_1_q1 MemPortDOUT2 0 32 } } }
	...
	tmp_66 { ap_none {  { tmp_66 in_data 0 6 } } }

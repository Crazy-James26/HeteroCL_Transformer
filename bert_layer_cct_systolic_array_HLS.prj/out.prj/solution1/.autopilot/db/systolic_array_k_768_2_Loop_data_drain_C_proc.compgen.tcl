...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_0_din { O 32 vector } block_C_drainer_0_num_data_valid { I 2 vector } block_C_drainer_0_fifo_cap { I 2 vector } block_C_drainer_0_full_n { I 1 bit } block_C_drainer_0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_1_din { O 32 vector } block_C_drainer_1_num_data_valid { I 2 vector } block_C_drainer_1_fifo_cap { I 2 vector } block_C_drainer_1_full_n { I 1 bit } block_C_drainer_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_2_din { O 32 vector } block_C_drainer_2_num_data_valid { I 2 vector } block_C_drainer_2_fifo_cap { I 2 vector } block_C_drainer_2_full_n { I 1 bit } block_C_drainer_2_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_3_din { O 32 vector } block_C_drainer_3_num_data_valid { I 2 vector } block_C_drainer_3_fifo_cap { I 2 vector } block_C_drainer_3_full_n { I 1 bit } block_C_drainer_3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_5_din { O 32 vector } block_C_drainer_5_num_data_valid { I 2 vector } block_C_drainer_5_fifo_cap { I 2 vector } block_C_drainer_5_full_n { I 1 bit } block_C_drainer_5_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_6_din { O 32 vector } block_C_drainer_6_num_data_valid { I 2 vector } block_C_drainer_6_fifo_cap { I 2 vector } block_C_drainer_6_full_n { I 1 bit } block_C_drainer_6_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_7_din { O 32 vector } block_C_drainer_7_num_data_valid { I 2 vector } block_C_drainer_7_fifo_cap { I 2 vector } block_C_drainer_7_full_n { I 1 bit } block_C_drainer_7_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_8_din { O 32 vector } block_C_drainer_8_num_data_valid { I 2 vector } block_C_drainer_8_fifo_cap { I 2 vector } block_C_drainer_8_full_n { I 1 bit } block_C_drainer_8_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_9_din { O 32 vector } block_C_drainer_9_num_data_valid { I 2 vector } block_C_drainer_9_fifo_cap { I 2 vector } block_C_drainer_9_full_n { I 1 bit } block_C_drainer_9_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_10_din { O 32 vector } block_C_drainer_10_num_data_valid { I 2 vector } block_C_drainer_10_fifo_cap { I 2 vector } block_C_drainer_10_full_n { I 1 bit } block_C_drainer_10_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { block_C_drainer_11_din { O 32 vector } block_C_drainer_11_num_data_valid { I 2 vector } block_C_drainer_11_fifo_cap { I 2 vector } block_C_drainer_11_full_n { I 1 bit } block_C_drainer_11_write { O 1 bit } } \
} "
}

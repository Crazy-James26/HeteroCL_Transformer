set moduleName VITIS_LOOP_132_4_proc32_Pipeline_VITIS_LOOP_132_4
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "C_2", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "tmp_64", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_64", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tmp_64", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U3205", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_64 { ap_none {  { tmp_64 in_data 0 6 } } }

...
set C_modelArgList {
	{ v224_load float 32 regular  }
	{ v224 float 32 regular {array 9216 { 0 3 } 0 1 }  }
	{ empty int 14 regular  }
	{ sub_ln183 int 20 regular  }
	{ v209 int 32 regular {array 589824 { 1 3 } 1 1 }  }
	{ sub_ln182 int 14 regular  }
	{ v223 float 32 regular {array 9216 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v224_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v224", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln183", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
 	{ "Name" : "v209", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln182", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v224_load sc_in sc_lv 32 signal 0 } 
	{ v224_address0 sc_out sc_lv 14 signal 1 } 
	{ v224_ce0 sc_out sc_logic 1 signal 1 } 
	{ v224_we0 sc_out sc_logic 1 signal 1 } 
	{ v224_d0 sc_out sc_lv 32 signal 1 } 
	{ empty sc_in sc_lv 14 signal 2 } 
	{ sub_ln183 sc_in sc_lv 20 signal 3 } 
	{ v209_address0 sc_out sc_lv 20 signal 4 } 
	{ v209_ce0 sc_out sc_logic 1 signal 4 } 
	{ v209_q0 sc_in sc_lv 32 signal 4 } 
	{ sub_ln182 sc_in sc_lv 14 signal 5 } 
	{ v223_address0 sc_out sc_lv 14 signal 6 } 
	{ v223_ce0 sc_out sc_logic 1 signal 6 } 
	{ v223_q0 sc_in sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v224_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v224_load", "role": "default" }} , 
 	...
 	{ "name": "sub_ln183", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "sub_ln183", "role": "default" }} , 
 	...
 	{ "name": "sub_ln182", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln182", "role": "default" }} , 
 	{ "name": "v223_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v223", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	v224_load { ap_none {  { v224_load in_data 0 32 } } }
	v224 { ap_memory {  { v224_address0 mem_address 1 14 }  { v224_ce0 mem_ce 1 1 }  { v224_we0 mem_we 1 1 }  { v224_d0 mem_din 1 32 } } }
	empty { ap_none {  { empty in_data 0 14 } } }
	sub_ln183 { ap_none {  { sub_ln183 in_data 0 20 } } }
	v209 { ap_memory {  { v209_address0 mem_address 1 20 }  { v209_ce0 mem_ce 1 1 }  { v209_q0 mem_dout 0 32 } } }
	sub_ln182 { ap_none {  { sub_ln182 in_data 0 14 } } }
	v223 { ap_memory {  { v223_address0 mem_address 1 14 }  { v223_ce0 mem_ce 1 1 }  { v223_q0 mem_dout 0 32 } } }
}

set moduleName Bert_layer_Pipeline_l_S_i_j_0_i11_l_j117
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Bert_layer_Pipeline_l_S_i_j_0_i11_l_j117}
set C_modelType { void 0 }
set C_modelArgList {
	{ v226 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v229 float 32 regular {array 9216 { 1 3 } 1 1 }  }
	{ v230 float 32 regular {array 9216 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v226", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v229", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "v230", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ v226_address0 sc_out sc_lv 14 signal 0 } 
	{ v226_ce0 sc_out sc_logic 1 signal 0 } 
	{ v226_q0 sc_in sc_lv 32 signal 0 } 
	{ v229_address0 sc_out sc_lv 14 signal 1 } 
	{ v229_ce0 sc_out sc_logic 1 signal 1 } 
	{ v229_q0 sc_in sc_lv 32 signal 1 } 
	{ v230_address0 sc_out sc_lv 14 signal 2 } 
	{ v230_ce0 sc_out sc_logic 1 signal 2 } 
	{ v230_we0 sc_out sc_logic 1 signal 2 } 
	{ v230_d0 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v230_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "v230", "role": "address0" }} , 
 	{ "name": "v230_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v230", "role": "ce0" }} , 
 	{ "name": "v230_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v230", "role": "we0" }} , 
 	{ "name": "v230_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v230", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	v229 { ap_memory {  { v229_address0 mem_address 1 14 }  { v229_ce0 mem_ce 1 1 }  { v229_q0 mem_dout 0 32 } } }
	v230 { ap_memory {  { v230_address0 mem_address 1 14 }  { v230_ce0 mem_ce 1 1 }  { v230_we0 mem_we 1 1 }  { v230_d0 mem_din 1 32 } } }
}

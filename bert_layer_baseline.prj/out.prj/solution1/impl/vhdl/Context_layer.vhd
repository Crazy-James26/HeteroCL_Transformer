...
architecture behav of Context_layer is 
    ...
    signal tmp_68_fu_316_p3 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    tmp_64_fu_172_p3 <= (v55_0_reg_97 & ap_const_lv6_0);
    tmp_65_fu_222_p3 <= (i6_0_reg_119 & ap_const_lv4_0);
    tmp_66_fu_234_p3 <= (i6_0_reg_119 & ap_const_lv2_0);
    tmp_67_fu_252_p3 <= (i6_0_reg_119 & ap_const_lv6_0);
    tmp_68_fu_316_p3 <= (k2_0_reg_141 & ap_const_lv6_0);
    ...
    zext_ln115_fu_180_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_64_fu_172_p3),11));
    ...
    zext_ln120_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_67_fu_252_p3),11));
    zext_ln122_1_fu_242_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_66_fu_234_p3),9));
    zext_ln122_2_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k2_0_reg_141),9));
    zext_ln122_fu_230_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_65_fu_222_p3),9));
    zext_ln123_1_fu_333_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln123_fu_328_p2),64));
    zext_ln123_fu_324_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_68_fu_316_p3),11));

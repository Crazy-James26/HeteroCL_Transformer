...
// ==============================================================
#ifndef __Bert_layer_faddfsg8j__HH__
#define __Bert_layer_faddfsg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_faddfsg8j) {
    ...
    SC_CTOR(Bert_layer_faddfsg8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {

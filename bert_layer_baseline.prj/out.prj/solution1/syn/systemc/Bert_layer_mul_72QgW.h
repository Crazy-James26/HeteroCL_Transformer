...
// ==============================================================
#ifndef __Bert_layer_mul_72QgW__HH__
#define __Bert_layer_mul_72QgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Bert_layer_mul_72QgW) {
    ...
    SC_CTOR(Bert_layer_mul_72QgW):  ACMP_mul_us_U ("ACMP_mul_us_U") {

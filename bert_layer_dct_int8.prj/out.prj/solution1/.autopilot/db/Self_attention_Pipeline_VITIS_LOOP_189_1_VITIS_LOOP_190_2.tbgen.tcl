set moduleName Self_attention_Pipeline_VITIS_LOOP_189_1_VITIS_LOOP_190_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Self_attention_Pipeline_VITIS_LOOP_189_1_VITIS_LOOP_190_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ acc_outp2_V int 22 regular {array 192 { 0 3 } 0 1 }  }
	{ acc_outp2_V_1 int 22 regular {array 192 { 0 3 } 0 1 }  }
	{ acc_outp2_V_2 int 22 regular {array 192 { 0 3 } 0 1 }  }
	{ acc_outp2_V_3 int 22 regular {array 192 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "acc_outp2_V", "interface" : "memory", "bitwidth" : 22, "direction" : "WRITEONLY"} , 
 	{ "Name" : "acc_outp2_V_1", "interface" : "memory", "bitwidth" : 22, "direction" : "WRITEONLY"} , 
 	{ "Name" : "acc_outp2_V_2", "interface" : "memory", "bitwidth" : 22, "direction" : "WRITEONLY"} , 
 	{ "Name" : "acc_outp2_V_3", "interface" : "memory", "bitwidth" : 22, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ acc_outp2_V_d0 sc_out sc_lv 22 signal 0 } 
	...
	{ acc_outp2_V_1_d0 sc_out sc_lv 22 signal 1 } 
	...
	{ acc_outp2_V_2_d0 sc_out sc_lv 22 signal 2 } 
	...
	{ acc_outp2_V_3_d0 sc_out sc_lv 22 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	acc_outp2_V { ap_memory {  { acc_outp2_V_address0 mem_address 1 8 }  { acc_outp2_V_ce0 mem_ce 1 1 }  { acc_outp2_V_we0 mem_we 1 1 }  { acc_outp2_V_d0 mem_din 1 22 } } }
	acc_outp2_V_1 { ap_memory {  { acc_outp2_V_1_address0 mem_address 1 8 }  { acc_outp2_V_1_ce0 mem_ce 1 1 }  { acc_outp2_V_1_we0 mem_we 1 1 }  { acc_outp2_V_1_d0 mem_din 1 22 } } }
	acc_outp2_V_2 { ap_memory {  { acc_outp2_V_2_address0 mem_address 1 8 }  { acc_outp2_V_2_ce0 mem_ce 1 1 }  { acc_outp2_V_2_we0 mem_we 1 1 }  { acc_outp2_V_2_d0 mem_din 1 22 } } }
	acc_outp2_V_3 { ap_memory {  { acc_outp2_V_3_address0 mem_address 1 8 }  { acc_outp2_V_3_ce0 mem_ce 1 1 }  { acc_outp2_V_3_we0 mem_we 1 1 }  { acc_outp2_V_3_d0 mem_din 1 22 } } }
}

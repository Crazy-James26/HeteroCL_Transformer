...
set C_modelArgList {
	...
	{ zext_ln148 int 4 regular  }
	{ sub_ln151 int 6 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inp_sumRow_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln148", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln151", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln148 sc_in sc_lv 4 signal 2 } 
	{ sub_ln151 sc_in sc_lv 6 signal 3 } 
	...
	{ trunc_ln9 sc_in sc_lv 2 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln148", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln148", "role": "default" }} , 
 	{ "name": "sub_ln151", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "sub_ln151", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_10_full_dsp_1_U350", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_32_1_1_U351", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	zext_ln148 { ap_none {  { zext_ln148 in_data 0 4 } } }
	sub_ln151 { ap_none {  { sub_ln151 in_data 0 6 } } }

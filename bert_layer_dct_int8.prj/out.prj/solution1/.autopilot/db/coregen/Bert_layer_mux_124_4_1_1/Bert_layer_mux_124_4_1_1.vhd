...
entity Bert_layer_mux_124_4_1_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of Bert_layer_mux_124_4_1_1 is
    -- puts internal signals
    signal sel    : std_logic_vector(3 downto 0);
    -- level 1 signals
    signal mux_1_0    : std_logic_vector(3 downto 0);
    signal mux_1_1    : std_logic_vector(3 downto 0);
    signal mux_1_2    : std_logic_vector(3 downto 0);
    signal mux_1_3    : std_logic_vector(3 downto 0);
    signal mux_1_4    : std_logic_vector(3 downto 0);
    signal mux_1_5    : std_logic_vector(3 downto 0);
    -- level 2 signals
    signal mux_2_0    : std_logic_vector(3 downto 0);
    signal mux_2_1    : std_logic_vector(3 downto 0);
    signal mux_2_2    : std_logic_vector(3 downto 0);
    -- level 3 signals
    signal mux_3_0    : std_logic_vector(3 downto 0);
    signal mux_3_1    : std_logic_vector(3 downto 0);
    -- level 4 signals
    signal mux_4_0    : std_logic_vector(3 downto 0);
begin

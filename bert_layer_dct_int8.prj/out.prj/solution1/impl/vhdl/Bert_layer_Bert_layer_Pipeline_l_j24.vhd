...
entity Bert_layer_Bert_layer_Pipeline_l_j24 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Bert_layer_Bert_layer_Pipeline_l_j24 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln587_reg_442 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal mean21_addr_reg_432 : STD_LOGIC_VECTOR (3 downto 0);
    signal mean21_addr_reg_432_pp0_iter1_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal mean21_addr_reg_432_pp0_iter2_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal mean1_addr_reg_437 : STD_LOGIC_VECTOR (3 downto 0);
    signal mean1_addr_reg_437_pp0_iter1_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln587_fu_320_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln587_reg_442_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln587_1_fu_348_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln587_1_reg_506 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln587_1_reg_506_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln587_1_reg_506_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal v294_fu_359_p14 : STD_LOGIC_VECTOR (31 downto 0);
    signal v294_reg_510 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal v298_reg_522 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln586_cast_fu_296_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln587_fu_332_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal v295_fu_66 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_v295_load : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal v299_fu_70 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_allocacmp_v299_load : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage3 : BOOLEAN;
    signal j24_fu_74 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln587_fu_326_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_sig_allocacmp_j24_1 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    mux_124_32_1_1_U1043 : component Bert_layer_mux_124_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    j24_fu_74_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln587_fu_320_p2 = ap_const_lv1_0))) then 
                    j24_fu_74 <= add_ln587_fu_326_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j24_fu_74 <= ap_const_lv10_0;
                end if;
            end if; 
        end if;
    end process;

    v295_fu_66_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                ...
                v295_fu_66 <= grp_fu_4370_p_dout0;
            end if; 
        end if;
    end process;

    v299_fu_70_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                ...
                v299_fu_70 <= grp_fu_4370_p_dout0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln587_fu_320_p2 = ap_const_lv1_0))) then
                icmp_ln587_1_reg_506 <= icmp_ln587_1_fu_348_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln587_1_reg_506_pp0_iter1_reg <= icmp_ln587_1_reg_506;
                icmp_ln587_1_reg_506_pp0_iter2_reg <= icmp_ln587_1_reg_506_pp0_iter1_reg;
                icmp_ln587_reg_442 <= icmp_ln587_fu_320_p2;
                icmp_ln587_reg_442_pp0_iter1_reg <= icmp_ln587_reg_442;
                mean1_addr_reg_437 <= zext_ln586_cast_fu_296_p1(4 - 1 downto 0);
                mean1_addr_reg_437_pp0_iter1_reg <= mean1_addr_reg_437;
                mean21_addr_reg_432 <= zext_ln586_cast_fu_296_p1(4 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln587_reg_442 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
                v298_reg_522 <= grp_fu_4359_p_dout0;
            end if;
        end if;
    end process;
    ...
    add_ln587_fu_326_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j24_1) + unsigned(ap_const_lv10_1));
    ...
    ap_condition_exit_pp0_iter0_stage3_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_subdone, icmp_ln587_reg_442)
    begin
        if (((icmp_ln587_reg_442 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    ap_condition_exit_pp0_iter2_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln587_reg_442_pp0_iter1_reg, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln587_reg_442_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_j24_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j24_fu_74)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_j24_1 <= ap_const_lv10_0;
        else 
    ...
    ap_sig_allocacmp_v295_load_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage2, v295_fu_66, ap_block_pp0_stage2, grp_fu_4370_p_dout0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
            ap_sig_allocacmp_v295_load <= grp_fu_4370_p_dout0;
        else 
    ...
    ap_sig_allocacmp_v299_load_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage3, v299_fu_70, ap_block_pp0_stage3, grp_fu_4370_p_dout0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage3) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
            ap_sig_allocacmp_v299_load <= grp_fu_4370_p_dout0;
        else 
    ...
    grp_fu_282_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage2, ap_sig_allocacmp_v295_load, ap_block_pp0_stage2, ap_sig_allocacmp_v299_load, ap_block_pp0_stage3)
    begin
    ...
    grp_fu_282_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage2, v294_reg_510, v298_reg_522, ap_block_pp0_stage2, ap_block_pp0_stage3)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage3) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    grp_fu_4359_p_din0 <= v294_reg_510;
    grp_fu_4359_p_din1 <= v294_reg_510;
    ...
    icmp_ln587_1_fu_348_p2 <= "1" when (add_ln587_fu_326_p2 = ap_const_lv10_300) else "0";
    icmp_ln587_fu_320_p2 <= "1" when (ap_sig_allocacmp_j24_1 = ap_const_lv10_300) else "0";
    mean1_address0 <= mean1_addr_reg_437_pp0_iter1_reg;

    mean1_ce0_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_11001)
    begin
    ...
    mean1_we0_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage3, ap_block_pp0_stage3_11001, icmp_ln587_1_reg_506_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln587_1_reg_506_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    mean21_address0 <= mean21_addr_reg_432_pp0_iter2_reg;

    mean21_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_block_pp0_stage0_11001)
    begin
    ...
    mean21_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_block_pp0_stage0_11001, icmp_ln587_1_reg_506_pp0_iter2_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (icmp_ln587_1_reg_506_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    v365_10_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_11_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_1_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_2_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_3_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_4_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_5_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_6_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_7_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_8_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_9_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    v365_address0 <= zext_ln587_fu_332_p1(10 - 1 downto 0);
    ...
    zext_ln586_cast_fu_296_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln586),64));
    zext_ln587_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j24_1),64));
end behav;
